...
<div class="customer_form">
    ...
    <div class="tab-pane fade show active" id="branches" role="tabpanel" aria-labelledby="home-tab">
        ...
        <ul class="nav nav-tabs mb-3" id="campaignTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="noticeLogSheet-tab" data-bs-toggle="tab"
                    data-bs-target="#noticeLogSheet" type="button" role="tab" aria-controls="noticeLogSheet"
                    aria-selected="false">
                    Notice Log Sheet
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="weekly-sales-report-tab" data-bs-toggle="tab"
                    data-bs-target="#weekly-sales-report" type="button" role="tab"
                    aria-controls="weekly-sales-report" aria-selected="false">
                    weekly sales report
                </button>
            </li>
        ...
        <div class="tab-content" id="campaignTabContent">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table border="1" cellpadding="10">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="live-input" name="linkedin_morning_post" value="{{ $analytics->linkedin_morning_post }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="linkedin_why_pifra" value="{{ $analytics->linkedin_why_pifra }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="linkedin_what_we_do" value="{{ $analytics->linkedin_what_we_do }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="linkedin_what_we_do_vedio" value="{{ $analytics->linkedin_what_we_do_vedio }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="linkedin_subscribers" value="{{ $analytics->linkedin_subscribers }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="linkedin_comments" value="{{ $analytics->linkedin_comments }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Facebook</strong></td>
                                                <td>
                                                    <input type="text" class="live-input" name="facebook_morning_post" value="{{ $analytics->facebook_morning_post }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="facebook_why_pifra" value="{{ $analytics->facebook_why_pifra }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="facebook_what_we_do" value="{{ $analytics->facebook_what_we_do }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="facebook_what_we_do_vedio" value="{{ $analytics->facebook_what_we_do_vedio }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="facebook_subscribers" value="{{ $analytics->facebook_subscribers }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="facebook_comments" value="{{ $analytics->facebook_comments }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Instagram</strong></td>
                                                <td>
                                                    <input type="text" class="live-input" name="instagram_morning_post" value="{{ $analytics->instagram_morning_post }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="instagram_why_pifra" value="{{ $analytics->instagram_why_pifra }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="instagram_what_we_do" value="{{ $analytics->instagram_what_we_do }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="instagram_what_we_do_vedio" value="{{ $analytics->instagram_what_we_do_vedio }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="instagram_subscribers" value="{{ $analytics->instagram_subscribers }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="live-input" name="instagram_comments" value="{{ $analytics->instagram_comments }}">
                                                </td>
                                            </tr>
                                        </table>
            ...
            <div class="tab-pane fade " id="weekly-sales-report" role="tabpanel"
                aria-labelledby="weekly-sales-report-tab">
