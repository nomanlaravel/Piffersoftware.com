...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDJW5_mifeg4pTLOW_Hgx70vDhU4osTceg&libraries=places"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.3.0/papaparse.min.js"></script>
  ...
  <style>
    ...
    .new_branches button {
      ...
      border: 0ch;
      border-radius: 12px;
      width: 20%; /* Set a fixed width, so the buttons don't extend beyond the container */
      height: 2rem;
      font-weight: bold;
    }
    ...
    <div class="form_full">
      <nav class="navbar navbar-expand-lg navbar-dark" style=" background-color: rgb(60, 60, 60);">
        <div class="container-fluid">
          <img src="{{ asset('logo.png') }}" style="width: 55%; height: 46%; margin: 0%; margin-left: 28%; margin-top:20px;">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                {{-- Dashboard --}}
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="{{ url('/home') }}" style="color: gold; background-color: transparent;">Dashboard</a>
                </li>
                ...
                @canany(['view_regulator', 'add_regulator', 'update_regulator', 'delete_regulator', 'view_corporate', 'add_corporate', 'update_corporate', 'delete_corporate', 'view_chamber', 'add_chamber', 'update_chamber', 'delete_chamber'])
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#regulatorySubMenu" aria-expanded="false" aria-controls="regulatorySubMenu">
                ...
                {{-- Customers --}}
                @can('view_customer')
                  <li class="nav-item"><a class="nav-link" href="{{ route('customer') }}" style="background-color: transparent;">Customers</a></li>
                @endcan

                {{-- HRM --}}
                @canany(['view_staff', 'add_staff', 'update_staff', 'delete_staff'])
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#hrmSubMenu" aria-expanded="false" aria-controls="hrmSubMenu">
                ...
                @canany(['view_payroll', 'add_payroll', 'update_payroll', 'delete_payroll', 'view_training', 'add_training', 'update_training', 'delete_training'])
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#operSubMenu" aria-expanded="false" aria-controls="operSubMenu">
                ...
                @can('view_piffersinventory')
                  <li class="nav-item"><a class="nav-link" href="{{ route('purchase.dashboard') }}" style="background-color: transparent;">Procure, 3-Way Match & Pay</a></li>
                @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{route('access')}}" style="background-color: transparent;">System Access Rights</a>
                </li>
                    <li class="nav-item">
