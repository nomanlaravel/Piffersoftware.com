...
<div class="customer_form">
        ...
        <form id="sales_form" action="{{ route('requirements.update', $requirements->id) }}"
            ...
            <div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-3 mt-1">
                        Lead Type: <br> <input class="form-control" name="typeLead"
    ...
    value="{{ $guard->guard_category }}" placeholder="..." style="width: 100%;">
                                            ...
                                            <div class="col-lg-6 spacing-right">
                                                Quantity :<br>
                                                <input name="guard_quantity[{{ $index }}]" value="{{ $guard->guard_quantity }}">

                                            </div>
                                            <div class="col-lg-6 spacing-left">
                                                Shift Timing :<br>
                                                <input name="guard_shift_timing[{{ $index }}]" value="{{ $guard->guard_shift_timing }}">

                                            </div>
                                            <div class="col-lg-6 spacing-right">
                                                Food by Client :<br>
                                                <input name="guard_food[{{ $index }}]" value="{{ $guard->guard_food }}">

                                            </div>
                                            <div class="col-lg-6 spacing-left">
                                                Accommodation by Client :<br>
                                                <input name="guard_accomodation[{{ $index }}]" value="{{ $guard->guard_accomodation }}">

                                            </div>
                                            <div class="col-lg-6 spacing-right">
                                                Transportation by Client :<br>
                                                <input name="guard_transportation[{{ $index }}]" value="{{ $guard->guard_transportation }}">

                                            </div>
                                            <div class="col-lg-6 spacing-left">
                                                Required on Monthly Basis :<br>
                                               <input name="guard_required_monthly[{{ $index }}]" value="{{ $guard->guard_required_monthly }}">

                                            </div>
                                            <div class="col-lg-6 spacing-right" id="dailyRequirementSection">
                                                Required on Daily Basis :<br>
                                               <input name="guard_required_dialy[{{ $index }}]" value="{{ $guard->guard_required_dialy }}">

                                            </div>
                                            <div class="col-lg-6 mt-1" id="noOfDays">
                                                No. of Days Security Staff Required :<br>
                                               <input name="no_of_days_guard_required[{{ $index }}]" value="{{ $guard->no_of_days_guard_required }}">
                                            ...
                                            <div class="col-lg-6">
                                                Notes :<br>
                                               <textarea name="guard_notes[{{ $index }}]">{{ $guard->guard_notes }}</textarea>
                                    ...
                                    <div id="signatoryCollapse2{{ $index + 1 }}" class="collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row mb-2" id="signatoryDetailsContainer">
                                                ...
                                                <div class="col-lg-6 form-group spacing-left">
                                                    Types:<br> <input class="form-control" name="vehicle_type[{{ $index }}]"
                                                        value="{{ $vehicle->vehicle_type }}" type="text" placeholder="..."
                                                        style="width: 100%;">
                                                </div>
                                                <div class="col-lg-6 form-group spacing-left">
                                                    Category:<br> <input class="form-control" name="vehicle_category[{{ $index }}]"
                        ...
                        <div class="col-lg-12 spacing-right">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-4 spacing-right">
                                    ...
                                    <input class="form-control" name="tec_pro_attach" type="file" placeholder="..." style="width: 100%;">
