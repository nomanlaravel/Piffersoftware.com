...
@yield('main')
{{-- <option value="{{ $compliance->compliance_name }}" @if($compliance->compliance_name == $customers->applicable_compliances) selected
    ...
    <form action="{{ route('update_customer', ['id' => $customers->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col d-flex flex-column align-items-end" style="margin-right: 53px;">
          <div>
            ...
            <div class="form-check form-check-inline" style="margin-right: 90px;">
              <input class="form-check-input mr-2" type="radio" name="customers_activation_check"
                {{ $customers->customers_activation_check == '1' ? 'checked' : '' }} value="1" id="activeRadio">
              <label class="form-check-label" for="activeRadio">Active</label>
              <input class="form-check-input ml-3 mr-2" type="radio" name="customers_activation_check"
                {{ $customers->customers_activation_check == '0' ? 'checked' : '' }} value="0" id="inactiveRadio">
              <label class="form-check-label" for="inactiveRadio">Inactive</label>
            </div>
            <div class="col-12">
              <div>
                <label class="form-label" for="entryofdate">Date Of Entry</label>
                <input class="form-control" type="date" name="date_of_entry" value="{{ $customers->date_of_entry }}" id="entryofdate">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="row" style="font-weight:600;">
            ...
            <div class="col-lg-6 spacing-right">
              <div class="row mb-2 mt-3">
                <div class="col-lg-5 spacing-right">
                  Customer ID <br> <input class="form-control" id="c_id" name="customers_id" value="{{ $customers->customers_id }}" type="text"
                    placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-6 spacing-left">
                  Customer Legal Name (As per NTN) <br> <input class="form-control" id="customers_name" type="text" name="customers_name"
                    value="{{ $customers->customers_name }}" placeholder="" style="width: 100%;">
                </div>
              </div>
              <div class="row mb-2 mt-3">
                <div class="col-lg-5 spacing-right">
                  Suffix <br> <input class="form-control" id="customers_suffix" name="customers_suffix" value="{{ $customers->customers_suffix}}" type="text"
                    placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-6 spacing-left input-group">
                  City of Deployment <br> <input class="form-control" id="city_of_deployment" type="text" name="city_of_deployment"
                    value="{{ $customers->city_of_deployment }}" placeholder="..." style="width: 100%;">
                </div>
              </div>
              <div class="row mb-2 mt-3">
                <div class="col-lg-5 spacing-right">
                  Region <br> <input class="form-control" id="customers_region" type="text" value="{{ $customers->customers_region }}" name="customers_region"
                    placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-5 spacing-right">
                  Belongs to Branch <br> <input class="form-control" id="customers_branch" type="text" value="{{ $customers->branch_name }}" name="branch_name"
                    placeholder="..." style="width: 100%;">
                </div>
              </div>
              <div class="row mb-2 mt-3 mb-2">
                <div class="col-10 spacing-right">
                  Display Name as <br> <input class="form-control" id="d_name" name="display_name_as" value="{{ $customers->display_name_as }}" type="text"
                    placeholder="..." style="width: 100%;">
                </div>
              </div>
            </div>
            <div class="col-lg-6 spacing-left">
              <div class="row mb-2 mt-3">
                <div class="col-lg-5 spacing-right">
                  Nature of Business <br> <input class="form-control" id="nature" value="{{ $customers->nature_of_business }}" name="nature_of_business"
                    type="text" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-6 spacing-left">
                  Website <br> <input class="form-control vldwebsite" type="text" id="web" value="{{ $customers->website }}" name="website" placeholder=""
                    style="width: 100%;">
              ...
              <div class="row mb-2 mt-3">
                <div class="col-lg-5 spacing-right">
                  Phone/Cell No <br> <input class="form-control vldphone" type="text" id="phone" value="{{ $customers->phone }}" name="phone" placeholder="..."
                    style="width: 100%;">
                  <div id="phoneError" class="phoneError" style="color: red"></div>
                </div>
                <div class="col-lg-6 spacing-left input-group">
                  Email <br> <input class="form-control vldemail" name="email" id="email" type="email" value="{{ $customers->email }}" placeholder="..."
                    style="width: 100%;">
                  ...
                  <div class="row" style="margin-left: 3px; margin-top: 10px;">
                     <div class="col-lg-11 spacing-right">
                        <div class="form-group form-check">
                           ...
                           <input class="form-controld form-control" id="sub_customer" name="sub_customer" value="{{ $customers->sub_customer }}" type="text"
                placeholder="..." style="width: 100%;">
              </div>
            </div>
          </div>
          ...
          <div class="row" style="margin-left: 3px; margin-top: 10px;">
            <div class="col-lg-11 spacing-right">
              <div class="form-group form-check">
                Sub Customer <br> <input class="form-control vldemail" name="sub_customer" id="" type="text" value="{{ $customers->sub_customer }}"
                  placeholder="..." style="width: 100%;">
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-6">
        ...
        <div class="row mb-2 mt-5" style="margin-left:20px;">
          <div class="form-check form-check-inline spacing-left">
            <input class="form-check-input" type="checkbox" {{ $customers->quick_box ? 'checked' : '' }} name="quick_box" id="quick_box">
        ...
        <div class="row mb-2 mt-5 d-flex flex-row align-items-end">
          <div class="col-4">
            <div class="form-check form-check-inline spacing-right" style="margin-left:22px;">
              <input class="form-check-input" type="checkbox" {{ $customers->eobi ? 'checked' : '' }} name="eobi" id="eobi">
              <label class="form-check-label" for="inlineCheckbox1">EOBI</label>
            </div>
          </div>
          <div class="col-4">
            <div class="form-check form-check-inline spacing-left">
              <input class="form-check-input" type="checkbox" {{ $customers->social_security ? 'checked' : '' }} name="social_security" id="social_security">
              <label class="form-check-label" for="inlineCheckbox1">Social Security</label>
            </div>
          </div>
          <div class="col-4">
            <div class="form-check form-check-inline spacing-left">
              <input class="form-check-input" type="checkbox" {{ $customers->grp_life_ins ? 'checked' : '' }} name="grp_life_ins" id="grp_life_ins">
              <label class="form-check-label" for="inlineCheckbox1">EOBI</label>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="row mb-2 mt-3">
          <div class="col-lg-6 spacing-left">
            ...
            <input class="form-control" id="approvedAttachInput" name="approved_attach" type="file" placeholder="..." style="width: 100%;">
            <div class="col-lg-5 spacing-right">
              ...
              <div class="image-preview42 mt-2 preview-container" style="position: relative;">
                ...
                <img src="{{ asset($customers->approved_attach) }}" alt="Approved Attachment" class="image-preview__image42 preview-image"
                  style="height: 100%; width: 100%; margin-left: -13px;" data-image="{{ asset($customers->approved_attach) }}" data-bs-toggle="modal"
        ...
        <div class="row mb-2 mt-3">
          <div class="col-lg-6 spacing-left">
            QuickBooks Screenshot <br> <input class="form-control" value="{{ $customers->quickbooks_attach }}" name="quickbooks_attach" type="file"
              placeholder="..." style="width: 100%;">
            <div class="col-lg-5 spacing-right">
              <!-- Image Preview Biometric -->
              <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                @if($customers->quickbooks_attach)
                <img src="{{ asset($customers->quickbooks_attach) }}" alt="QuickBooks Attachment" class="image-preview__image42 preview-image"
                  style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->quickbooks_attach) }}" data-bs-toggle="modal"
                  data-bs-target="#imagePreviewModal">

                <!-- Delete Button -->
                {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                    data-customer-id="{{ $customers->id }}"
                data-type="quickbooks_attach"
                style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                &times;
                </button> --}}
                @else
          ...
          <div class="col-lg-7 mt-3 spacing-right form-group">
            ...
            <div class="input-group" style="width: 100%;">
              <select id="dropdown" class="form-control mt-1" name="applicable_compliances" value="{{ $customers->applicable_compliances }}"
      ...
      {{--
            <div class="col-lg-4 spacing-right form-group">
               Applicable Compliances <br> <input class="form-control" id="c_id" name="applicable_compliances" value="{{ $customers->applicable_compliances }}"
      type="text" placeholder="..." style="width: 100%;">
</div>
--}}
</div>
  ...
  <div class="card-body">
    <nav>
      <div class="nav nav-tabs mt-3" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="nav-contact-tab" data-toggle="tab" href="#work-experience" role="tab" aria-controls="nav-experience"
          aria-selected="false">Contract Management
        </a>
        <a class="nav-item nav-link " id="nav-deployment-tab" data-toggle="tab" href="#education" role="tab" aria-controls="nav-deployment"
          aria-selected="false">Deployment Plan
        </a>
        <a class="nav-item nav-link " id="nav-contact-tab" data-toggle="tab" href="#guaranter-details" role="tab" aria-controls="nav-contact"
          aria-selected="false">Point of Contacts (POC)
        </a>
        <a class="nav-item nav-link" id="nav-operation-tab" data-toggle="tab" href="#patrolling" role="tab" aria-controls="nav-operations"
          aria-selected="false">Patrolling Supervisor Log
        </a>
        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#site" role="tab" aria-controls="nav-biometric" aria-selected="false"> Site
          Inspection
        </a>
        ...
        <a class="nav-item nav-link" id="nav-incident-tab" data-toggle="tab" href="#incident_report" role="tab" aria-controls="nav-incident"
          aria-selected="false">Incident Report & Assignment Instruction Form
        </a>
        ...
        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#address-details" role="tab" aria-controls="nav-address"
          aria-selected="false">Monthly
          Performance Review Report
        </a>
        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#intelligence" role="tab" aria-controls="nav-biometric"
          aria-selected="false">BI & Promotional Activities
        </a>
        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#verifications" role="tab" aria-controls="nav-verifications"
          aria-selected="false">Feedback Management
        </a>
      </div>
    </nav>
    ...
    <div class="tab-content" style="font-size: small; font-weight: 600;" id="nav-tabContent">
        ...
        <div class="row">
          ...
          <div class="row col-lg-12">
            <div class="col-lg-3 spacing-right">
              Summary of approved Strength: <br> <input class="form-control" value="{{ $customers->sum_apr }}" name="sum_apr" type="file" placeholder="..."
                style="width: 100%;">
              <div class="col-lg-5 spacing-right">
                <div class="image-preview42 mt-2 preview-container" style="position: relative;" id="imagePreview42">
                  @if($customers->sum_apr)
                  <img src="{{ asset($customers->sum_apr) }}" alt="Summary of Approved Strength" class="image-preview__image42 preview-image"
                    style="height: 100%; width: 100%; margin-left: -13px;" data-image="{{ asset($customers->sum_apr)}}" data-bs-toggle="modal"
                    data-bs-target="#imagePreviewModal">
            ...
            <div class="col-lg-3 spacing-right">
              Accomodation Status: <br> <input class="form-control" value="{{ $customers->acm_status }}" name="acm_status" type="text" placeholder="..."
                style="width: 100%;">
            </div>
            <div class="col-lg-3 spacing-right">
              Meal Details: <br> <input class="form-control" name="meal_detail" value="{{ $customers->meal_detail }}" type="text" placeholder="..."
                style="width: 100%;">
            </div>
            <div class="col-lg-3 spacing-right MT-2">
              Any approved KPIs or SOW: <br> <input class="form-control" value="{{ $customers->apr_kpi }}" name="apr_kpi" type="file" placeholder="..."
                style="width: 100%;">
              <div class="col-lg-5 spacing-right">
                <!-- Image Preview Biometric -->
                <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                  @if($customers->apr_kpi)
                  <img src="{{ asset($customers->apr_kpi) }}" alt="APR KPI Attachment" class="image-preview__image42 preview-image"
                    style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->apr_kpi) }}" data-bs-toggle="modal"
                    data-bs-target="#imagePreviewModal">
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" name="approv_q_s" {{ $customers->approv_q_s ? 'checked' : '' }} type="checkbox" id="inlineCheckbox1"
                      value="">
              ...
              <div class="col-lg-5 spacing-left spacing-right">
                ...
                <div class="col-lg-5 spacing-right">
                  ...
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    ...
                    <img src="{{ asset($customers->approv_q_s_attach) }}" alt="Approved QS Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->approv_q_s_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                                    data-customer-id="{{ $customers->id }}"
                    data-type="approv_q_s_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" type="checkbox" {{ $customers->approv_q_c ? 'checked' : '' }} name="approv_q_c" id="inlineCheckbox1"
                      value="">
                    <label class="form-check-label" for="inlineCheckbox1"></label>
                  </div>
                </div>
              ...
              <div class="col-lg-5 spacing-left spacing-right">
                Attachments <br>
                <input class="form-control" id="printing_date" name="approv_q_c_attach" type="file" placeholder="..." style="width: 100%;">
                <div class="col-lg-5 spacing-right">
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    @if($customers->approv_q_c_attach)
                    <img src="{{ asset($customers->approv_q_c_attach) }}" alt="Approved QC Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->approv_q_c_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                            data-customer-id="{{ $customers->id }}"
                    data-type="approv_q_c_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" type="checkbox" {{ $customers->approv_q_cfo ? 'checked' : '' }} name="approv_q_cfo" id="inlineCheckbox1"
                      value="">
                    <label class="form-check-label" for="inlineCheckbox1"></label>
                  </div>
                </div>
              ...
              <div class="col-lg-5 spacing-left spacing-right">
                ...
                <div class="col-lg-5 spacing-right">
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    ...
                    <img src="{{ asset($customers->approv_q_cfo_attach) }}" alt="Approved CFO Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->approv_q_cfo_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                        data-customer-id="{{ $customers->id }}"
                    data-type="approv_q_cfo_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
              ...
              <div class="row mb-2 mt-4">
                <div class="col-lg-5 spacing-right">
                  Contract Execution Date: <br> <input class="form-control" name="c_e_date" value="{{ $customers->c_e_date }}" type="date" placeholder="..."
                    style="width: 100%;">
                </div>
                <div class="col-lg-5 spacing-right">
                  Contract end Date: <br> <input class="form-control" name="c_end_date" value="{{ $customers->c_end_date }}" type="date" placeholder="..."
                    style="width: 100%;">
                </div>
                <div class="col-lg-5 spacing-right">
                  Contract Renewal Date <br> <input class="form-control" name="c_r_date" value="{{ $customers->c_r_date }}" type="date" placeholder="..."
                    style="width: 100%;">
                </div>
                <div class="col-lg-5 spacing-right">
                  Renewal Reminder <br> <input class="form-control" name="c_r_rem" value="{{ $customers->c_r_rem }}" type="text" placeholder="..."
                    style="width: 100%;">
                </div>
              </div>
                ...
                <div class="accordion" id="signatoryAccordion">
                  ...
                  <div class="accordion-item" id="signatoryEntry{{ $index + 1 }}">
                    <h2 class="accordion-header" id="signatoryHeading{{ $index + 1 }}">
                      <button class="accordion-button" type="button" data-toggle="collapse" data-target="#signatoryCollapse{{ $index + 1 }}"
                        ...
                        <div class="row">
                          <div class=col-lg-6>
                            <div class="form-group">
                              ...
                              <input class="form-control" name="customersignatories[{{ $index }}][sign_name]" value="{{ $signatories->sign_name }}" type="text"
                                placeholder="...">
                            </div>
                          </div>
                          <div class="col-lg-6 spacing-right">
                            Designation <br> <input class="form-control" name="customersignatories[{{ $index }}][sign_desig]"
                              value="{{ $signatories->sign_desig }}" type="text" placeholder="..." style="width: 100%;">
                          </div>

                          <div class="col-lg-6 spacing-right">
                            Cell No <br> <input class="form-control vldphone" type="text" name="customersignatories[{{ $index }}][sign_cell]"
                              value="{{ $signatories->sign_cell }}" placeholder="..." style="width: 100%;">
                            <div id="phoneError" class="phoneError" style="color: red"></div>
                          </div>
                          <div class="col-lg-6 spacing-right">
                            Email <br> <input class="form-control vldemail" type="text" name="customersignatories[{{ $index }}][sign_email]"
          ...
          <div class="col-lg-5 spacing-left">
            <div class="row mb-2">
              <div class="col-lg-12 spacing-right">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" id="compliances" name="sales_dept" {{ $customers->sales_dept ? 'checked' : '' }} type="checkbox"
                    id="inlineCheckbox1" value="">
                  <label class="form-check-label" for="inlineCheckbox1">Sales Dept.</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" id="compliances" name="cmd" {{ $customers->cmd ? 'checked' : '' }} type="checkbox" id="inlineCheckbox2"
                    value="">
                  <label class="form-check-label" for="inlineCheckbox2">CMD</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" id="compliances" name="ops_dept" {{ $customers->ops_dept ? 'checked' : '' }} type="checkbox"
                    id="inlineCheckbox2" value="">
                  <label class="form-check-label" for="inlineCheckbox2">Ops Dept.</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" id="compliances" name="finance_dept" {{ $customers->finance_dept ? 'checked' : '' }} type="checkbox"
                    id="inlineCheckbox2" value="">
                  <label class="form-check-label" for="inlineCheckbox2">Finance Dept.</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" id="compliances" name="directors" {{ $customers->directors ? 'checked' : '' }} type="checkbox"
                    id="inlineCheckbox2" value="">
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" name="signed_ser" {{ $customers->approved_com ? 'checked' : '' }} type="checkbox" id="inlineCheckbox1"
                      value="">
                    <label class="form-check-label" for="inlineCheckbox1"></label>
                  </div>
                </div>
              ...
              <div class="col-lg-6 spacing-left spacing-right">
                Attachments <br> <input class="form-control" name="signed_ser_attach" value="{{ $customers->signed_ser_attach }}" type="file" placeholder="..."
                  style="width: 100%;">
                <div class="col-lg-5 spacing-right">
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    @if($customers->signed_ser_attach)
                    <img src="{{ asset($customers->signed_ser_attach) }}" alt="Signed Service Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->signed_ser_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                        data-customer-id="{{ $customers->id }}"
                    data-type="signed_ser_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" name="com_ins" {{ $customers->com_ins ? 'checked' : '' }} type="checkbox" id="inlineCheckbox1" value="">
                    <label class="form-check-label" for="inlineCheckbox1"></label>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 spacing-left spacing-right">
                Attachments <br> <input class="form-control" name="com_ins_attach" value="{{ $customers->com_ins_attach }}" type="file" placeholder="..."
                  style="width: 100%;">
                <div class="col-lg-5 spacing-right">
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    @if($customers->com_ins_attach)
                    <img src="{{ asset($customers->com_ins_attach) }}" alt="Commercial Insurance Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->com_ins_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                        data-customer-id="{{ $customers->id }}"
                    data-type="com_ins_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" name="testimonials" {{ $customers->testimonials ? 'checked' : '' }} type="checkbox" id="inlineCheckbox1"
                      value="">
                    <label class="form-check-label" for="inlineCheckbox1"></label>
                  </div>
                </div>
              ...
              <div class="col-lg-6 spacing-left spacing-right">
                Attachments <br> <input class="form-control" value="{{ $customers->testimonials_attach }}" name="testimonials_attach" type="file"
                  placeholder="..." style="width: 100%;">
                <div class="col-lg-5 spacing-right">
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    @if($customers->testimonials_attach)
                    <img src="{{ asset($customers->testimonials_attach) }}" alt="Testimonials Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->testimonials_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                        data-customer-id="{{ $customers->id }}"
                    data-type="testimonials_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
            ...
            <div class="row mb-2">
              <div class="col-lg-6 mt-2 spacing-right">
                <div class=" mb-2 d-flex align-items-center">
                  ...
                  <div class="form-check form-check-inline spacing-left">
                    <input class="form-check-input" name="sales_inc" {{ $customers->sales_inc ? 'checked' : '' }} type="checkbox" id="inlineCheckbox1" value="">
                    <label class="form-check-label" for="inlineCheckbox1"></label>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 spacing-left spacing-right">
                Attachments <br> <input class="form-control" name="sales_inc_attach" value="{{ $customers->sales_inc_attach }}" type="file" placeholder="..."
                  style="width: 100%;">
                <div class="col-lg-5 spacing-right">
                  <div class="image-preview42 mt-2" id="imagePreview42" style="position: relative;">
                    @if($customers->sales_inc_attach)
                    <img src="{{ asset($customers->sales_inc_attach) }}" alt="Sales Increment Attachment" class="image-preview__image42 preview-image"
                      style="height: 100%; width:100%; margin-left:-13px;" data-image="{{ asset($customers->sales_inc_attach) }}" data-bs-toggle="modal"
                      data-bs-target="#imagePreviewModal">

                    <!-- Delete Button -->
                    {{-- <button type="button" class="btn btn-danger btn-sm remove-image-btn"
                                        data-customer-id="{{ $customers->id }}"
                    data-type="sales_inc_attach"
                    style="position: absolute; top: -6px; right: 3px; z-index: 10;">
                    &times;
                    </button> --}}
                    @else
            ...
            <div id="sectionToHide">
              <div class="row mb-2">
                <div class="col-lg-6 spacing-right">
                  Insurance Company Name <br> <input class="form-control" value="{{ $customers->insc_name }}" name="insc_name" type="text" placeholder="..."
                    style="width: 100%;">
                </div>
                <div class="col-lg-6 spacing-right">
                  Date of issue <br> <input class="form-control" name="insc_date" value="{{ $customers->insc_date }}" type="date" placeholder="..."
                    style="width: 100%;">
                </div>
              </div>
              <div class="col-lg-12 spacing-right mb-3">
                Performance Guaranty issued via <br>
                <select id="staff_category" class="form-control" value="{{ $customers->per_guan }}" name="per_guan" style="width: 100%;">
          ...
          <div class="row mb-2">
            <div class="col-lg-6 spacing-left spacing-right mt-2">
              Attachements <br> <input class="form-control mb-2" name="perfom_attach" value="{{ $customers->perfom_attach }}" type="file" placeholder="..."
                style="width: 70%;" multiple>
              <div class="col-lg-5 spacing-right ">
                <div class="image-preview42" id="imagePreview42">
                  @if($customers->perfom_attach)
                  <img src="{{ asset($customers->perfom_attach) }}" alt="Image Preview42" class="image-preview__image42"
            ...
            <div class="col-lg-6 spacing-left spacing-right mt-2">
              Notes <br>
              <textarea id="w3review" oninput="trimSpaces()" onclick="moveCursorToStart()" class="form-control" name="perform_note" rows="2"
                cols="38">{{ $customers->perform_note }}
              </textarea>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="row mt-3" style="font-weight:600;">
            <div class="col-lg-6 spacing-right mb-3">
              Payment Terms <br>
              <select class="form-control" name="pay_terms" value="{{ $customers->pay_terms }}" style="width: 100%;">
                <option value="Cash">Cash</option>
                <option value="Cheque">Cheque</option>
              </select>
            </div>
            <div class="form-type col-lg-6 spacing-right">
              NTN from FBR Site <br> <input class="form-control" type="file" name="ntn_fbr" value="{{ $customers->ntn_fbr }}" placeholder="..."
                style="width: 100%;">
          ...
          <div class="row">
            <div class=" row main-content div">
              <div class="col-lg-6">
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    POC Name <br> <input class="form-control" id="" value="{{ $customers->poc_name }}" name="poc_name" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left spacing-right">
                    Designation <br> <input class="form-control" id="head_office_email" name="poc_desig" value="{{ $customers->poc_desig }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Cell Number <br> <input class="form-control vldphone" id="" name="poc_cell" value="{{ $customers->poc_cell }}" type="text" placeholder="..."
                      style="width: 100%;">
                    <div id="phoneError" class="phoneError" style="color: red"></div>
                  </div>
                  <div class="col-lg-5 spacing-left spacing-right">
                    Email <br> <input class="form-control vldemail" id="head_office_email" name="poc_email" value="{{ $customers->poc_email }}" type="email"
                      placeholder="..." style="width: 100%;">
                    <div id="emailError" class="emailError" style="color: red"></div>
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Billing Cycle Details <br> <input class="form-control" id="" value="{{ $customers->poc_bill_c }}" name="poc_bill_c" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left spacing-right">
                    Billing Portal Details <br> <input class="form-control" id="head_office_email" value="{{ $customers->poc_bill_d }}" name="poc_bill_d"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-11 spacing-right">
                    Billing Portal Link <br> <input class="form-control" id="" value="{{ $customers->poc_bill_l }}" name="poc_bill_l" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                </div>
              </div>
              <div class="col-lg-6 spacing-left">
                ...
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Office No <br> <input class="form-control" id="" name="poc_office" value="{{ $customers->poc_office }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left">
                    Floor <br> <input class="form-control" id="head_office_cell_no" name="poc_floor" value="{{ $customers->poc_floor }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Building <br> <input class="form-control" id="" name="poc_building" value="{{ $customers->poc_building }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left">
                    Block <br> <input class="form-control" id="" name="poc_block" value="{{ $customers->poc_block }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Area <br> <input class="form-control" id="" name="poc_area" value="{{ $customers->poc_area }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left">
                    City <br> <input class="form-control" id="" name="poc_city" value="{{ $customers->poc_city }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Photograph of Location <br> <input class="form-control" id="" name="poc_photo" value="{{ $customers->poc_photo }}" type="file"
                      placeholder="..." style="width: 100%;">
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42 mt-2 preview-container" style="position: relative;">
                        @if($customers->poc_photo)
                        <img src="{{ asset($customers->poc_photo) }}" alt="Photograph of Location" class="image-preview__image42 preview-image"
                          style="height: 100%; width: 100%; margin-left: -13px;">
                  ...
                  <div class="col-lg-6 spacing-left">
                    Pin location <br> <input class="form-control" id="location-input" name="poc_pin" value="{{ $customers->poc_pin }}" type="text"
                      placeholder="..." style="width: 100%;" onfocus="initAutocomplete()">
                  </div>
                </div>
                <div class="row ">
                  <div>
                    <br> <input class="form-control" id="" name="longitude" value="{{ $customers->longitude }}" type="hidden" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div>
                    <br> <input class="form-control" id="" name="latitude" value="{{ $customers->latitude }}" type="hidden" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Notes <br>
                    <textarea id="w3review1" oninput="trimSpaces1()" onclick="moveCursorToStart1()" class="form-control" name="poc_note" rows="2"
                      cols="38">{{ $customers->poc_note }}
                    </textarea>
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Attachements <br> <input class="form-control" name="poc_attach" value="{{ $customers->poc_attach }}" type="file" placeholder="..."
                      style="width: 70%;" multiple>
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($customers->poc_attach)
                        <img src="{{ asset($customers->poc_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
            ...
            <div class=" row main-content div">
              ...
              <div class="col-lg-6">
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Name <br> <input class="form-control" id="" name="cf_name" value="{{ $customers->cf_name }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right">
                    Designation <br> <input class="form-control" id="head_office_email" name="cf_desig" value="{{ $customers->cf_desig }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Cell Number <br> <input class="form-control vldphone" id="" name="cf_no" value="{{ $customers->cf_no }}" type="text" placeholder="..."
                      style="width: 100%;">
                    <div id="phoneError" class="phoneError" style="color: red"></div>
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right">
                    Email <br> <input class="form-control vldemail" id="head_office_name" name="cf_email" value="{{ $customers->cf_email }}" type="text"
              ...
              <div class="col-lg-6 spacing-left">
                ...
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Office No <br> <input class="form-control" id="" name="cf_office" value="{{ $customers->cf_office }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    Floor <br> <input class="form-control" id="head_office_cell_no" name="cf_floor" value="{{ $customers->cf_floor }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-right">
                    Building <br> <input class="form-control" id="" name="cf_building" value="{{ $customers->cf_building }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    Block <br> <input class="form-control" id="" name="cf_block" value="{{ $customers->cf_block }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-5 spacing-right">
                    Area <br> <input class="form-control" id="" name="cf_area" value="{{ $customers->cf_area }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    City <br> <input class="form-control" id="" name="cf_city" value="{{ $customers->cf_city }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-5 spacing-right">
                    Photograph of Location <br> <input class="form-control" id="" name="cf_photo" value="{{ $customers->cf_photo }}" type="file"
                      placeholder="..." style="width: 100%;">
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($customers->cf_photo)
                        <img src="{{ asset($customers->cf_photo) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
                  ...
                  <div class="col-lg-5 spacing-left">
                    Pin Location <br> <input class="form-control" id="location-input1" name="cf_pin" value="{{ $customers->cf_pin }}" type="text"
                      placeholder="..." style="width: 100%;" onfocus="initAutocomplete1()">
                  </div>
                </div>
                <div class="row ">
                  <div>
                    <br> <input class="form-control" id="" name="longitude1" value="{{ $customers->longitude1 }}" type="hidden" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div>
                    <br> <input class="form-control" id="" name="latitude1" value="{{ $customers->latitude1 }}" type="hidden" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Notes <br>
                    <textarea id="w3review2" class="form-control" name="cf_note" oninput="trimSpaces2()" onclick="moveCursorToStart2()" rows="2"
                      cols="38">{{ $customers->cf_note }}
                    </textarea>
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Attachements <br> <input class="form-control" name="cf_attach" value="{{ $customers->cf_attach }}" type="file" placeholder="..."
                      style="width: 70%;" multiple>
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($customers->cf_attach)
                        <img src="{{ asset($customers->cf_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
          ...
          <div class="row mb-2">
            <div class="col-lg-5 spacing-left spacing-right form-group">
              ...
              {{--
                        <div class="input-group" style="width: 100%;">
                           <input class="form-control" id="" name="list_curr" value="{{ $customers->list_curr }}" type="text" placeholder="..." style="width:
              100%;">
            </div>
            --}}
            <div class="input-group" style="width: 100%;">
              <select id="dropdown" class="form-control mt-1" name="list_curr" style="width: 70%; border-radius: 4px 0 0 4px; ">
                ...
                <option value="{{ $currency->currency_name }}" @if($currency->currency_name == $customers->list_curr) selected
          ...
          <div class="col-lg-6 spacing-right">
            Attachment <br> <input class="form-control" id="" name="currency_attach" value="{{ $customers->currency_attach }}" type="file" placeholder="..."
              style="width: 100%;">
            <div class="col-lg-5 spacing-right">
              <div class="image-preview42" id="imagePreview42">
                @if($customers->currency_attach)
                <img src="{{ asset($customers->currency_attach) }}" alt="Image Preview42" class="image-preview__image42"
                  style="height: 100%; width:100%; margin-left:-13px;">
                @else
                <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                @endif
          ...
          <div class="col-lg-6 spacing-right">
            Notes <br> <textarea class="form-control" id="w3review3" oninput="trimSpaces3()" onclick="moveCursorToStart3()" name="currency_note" type="text"
      ...
      <div id="salaryContainer">
        ...
        <div class="accordion-item">
          ...
          <div id="collapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="heading{{ $index }}" data-bs-parent="#salaryContainer">
            <div class="accordion-body">
              ...
              <div class="row mb-2">
                <div class="col-lg-4 spacing-right form-group">
                  Category <br>
                  <div class="input-group" style="width: 100%;">
                    <select id="dropdown" class="form-control mt-1" name="customersalary[{{ $index }}][cat_name]" value="{{ $salary->cat_name }}"
                      style="width: 70%; border-radius: 4px 0 0 4px; ">
                      <option value=""></option>
                      ...
                      --}}
                      <option value="{{ $saobcategory->saob_category_name }}" @if($saobcategory->saob_category_name == $salary->cat_name) selected
                        @endif>{{ $saobcategory->saob_category_name }}</option>
                      @endforeach
                    </select>
                    <div class="input-group-append" style="width: 30%;">
                ...
                <div class="col-lg-3 spacing-left spacing-right">
                  Salary <br> <input class="form-control" id="head_office_email" value="{{ $salary->sal_cat }}" name="customersalary[{{ $index }}][sal_cat]"
                    type="text" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-3 spacing-right">
                  Salary for No. of days <br> <input class="form-control" id="" value="{{ $salary->sal_days }}" name="customersalary[{{ $index }}][sal_days]"
                    type="text" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-3 spacing-right">
                  Leaves Allowed <br> <input class="form-control" id="" name="customersalary[{{ $index }}][leaves_a]" value="{{ $salary->leaves_a }}"
                    type="text" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-6 spacing-right">
                  Other Benefits <br>
                  <textarea class="form-control" id="w3review23" name="customersalary[{{ $index }}][other_ben]" type="notes" placeholder="..."
                    style="width: 100%;">{{ $salary->other_ben }}</textarea>
                </div>
                <div class="form-type col-lg-6 spacing-right">
                  Attachements <br>
                  <input class="form-control" name="customersalary[{{ $index }}][sal_attach]" value="{{ $salary->sal_attach }}" type="file" placeholder="..."
                    style="width: 100%;">
                  <div class="col-lg-5 spacing-right">
                    <div class="image-preview42" id="imagePreview42">
                      @if($salary->sal_attach)
                      <img src="{{ asset($salary->sal_attach) }}" alt="Image Preview42" class="image-preview__image42"
                        style="height: 100%; width:100%; margin-left:-13px;">
                      @else
                      <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                      @endif
                ...
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Notes <br>
                  <textarea class="form-control" id="w3review5" name="customersalary[{{ $index }}][sal_note]" type="notes" oninput="trimSpaces4()"
                    onclick="moveCursorToStart4()" placeholder="..." style="width: 100%;">{{ $salary->sal_note }}</textarea>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="tab-pane fade m-3" style="opacity: 90%;" id="education" role="tabpanel" aria-labelledby="nav-deployment-tab">
      <div class="row">
        ...
        <div class="row mb-3">
          <div class="form-type col-lg-6 spacing-right">
            Vehicle Name <br> <input class="form-control" name="pat_name" value="{{ $customers->pat_name }}" type="text" placeholder="..." style="width: 100%;">
          </div>
          <div class="form-type col-lg-6 spacing-right">
            Model <br> <input class="form-control" name="pat_model" value="{{ $customers->pat_model }}" type="text" placeholder="..." style="width: 100%;">
          </div>
        </div>
        <div class="row mb-3">
          <div class="form-type col-lg-6 spacing-right">
            Make <br> <input class="form-control" name="pat_make" value="{{ $customers->pat_make }}" type="text" placeholder="..." style="width: 100%;">
          </div>
          <div class="form-type col-lg-6 spacing-right">
            Registration No. <br> <input class="form-control" value="{{ $customers->pat_reg }}" name="pat_reg" type="text" placeholder="..."
              style="width: 100%;">
          </div>
        </div>
        <div class="row mb-3">
          <div class="form-type col-lg-6 spacing-right">
            Quantity. <br> <input class="form-control" name="pat_quan" value="{{ $customers->pat_quan }}" type="text" placeholder="..." style="width: 100%;">
          </div>
          <div class="form-type col-lg-6 spacing-right">
            Price Per Unit. <br> <input class="form-control" name="pat_price" value="{{ $customers->pat_price }}" type="text" placeholder="..."
              style="width: 100%;">
          </div>
        </div>
        <div class="row mb-3">
          <div class="form-type col-lg-6 spacing-right">
            Total Value. <br> <input class="form-control" name="pat_val" value="{{ $customers->pat_val }}" type="text" placeholder="..." style="width: 100%;">
          </div>
        </div>
      </div>
            ...
            <div class="accordion-body">
              ...
              <div class=" row main-content div">
                <div class="col-lg-6">
                  <div class="row mb-2">
                    <div class="col-lg-6 spacing-left spacing-right form-group">
                      ...
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customeremergencies[{{ $index }}][emer_ser]" value="{{ $emergencies->emer_ser }}"
                          style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($emerser as $emerse)
                          <option value="{{ $emerse->emerser_name }}" @if($emerse->emerser_name == $emergencies->emer_ser) selected
                            @endif>{{ $emerse->emerser_name }}</option>
                          @endforeach
                        </select>
                        <div class="input-group-append" style="width: 30%;">
                    ...
                    <div class="col-lg-6 spacing-right">
                      Picture of Police Station <br> <input class="form-control" name="customeremergencies[{{ $index }}][emer_pic]"
                    ...
                    <h5>POC</h5>
                    <div class="col-lg-6 spacing-right">
                      Name. <br> <input class="form-control" id="" name="customeremergencies[{{ $index }}][emer_poc_name]"
                        value="{{ $emergencies->emer_poc_name }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-6 spacing-right">
                      Designation. <br> <input class="form-control" id="" name="customeremergencies[{{ $index }}][emer_poc_desig]"
                        value="{{ $emergencies->emer_poc_desig }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-6 spacing-right">
                      Cell Number. <br> <input class="form-control vldphone" id="" name="customeremergencies[{{ $index }}][emer_poc_cell]"
                        value="{{ $emergencies->emer_poc_cell }}" type="text" placeholder="..." style="width: 100%;">
                      <div id="phoneError" class="phoneError" style="color: red"></div>
                    </div>
                    <div class="col-lg-6 spacing-right">
                      Email. <br> <input class="form-control vldemail" id="" name="customeremergencies[{{ $index }}][emer_poc_email]"
                        value="{{ $emergencies->emer_poc_email }}" type="email" placeholder="..." style="width: 100%;">
                      <div id="emailError" class="emailError" style="color: red"></div>
                    </div>
                    <div class="col-lg-6 spacing-right">
                      Notes. <br> <textarea class="form-control" id="w3review5" name="customeremergencies[{{ $index }}][emer_poc_notes]" type="notes"
                        oninput="trimSpaces5()" onclick="moveCursorToStart5()" placeholder="..."
                        style="width: 100%;">{{ $emergencies->emer_poc_notes }}</textarea>
                    </div>
                    <div class="col-lg-6 spacing-right">
                      Attachment <br> <input class="form-control" id="" name="customeremergencies[{{ $index }}][emer_poc_attach]"
                        value="{{ $emergencies->emer_poc_attach }}" type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                          @if($emergencies->emer_poc_attach)
                          <img src="{{ asset($emergencies->emer_poc_attach) }}" alt="Image Preview42" class="image-preview__image42"
                            style="height: 100%; width:100%; margin-left:-13px;">
                          @else
                          <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                          @endif
                ...
                <div class="col-lg-6 spacing-left">
                  ...
                  <div class="row mb-2">
                    <div class="col-lg-5 spacing-right">
                      Office No <br> <input class="form-control" id="" value="{{ $emergencies->emer_office }}"
                        name="customeremergencies[{{ $index }}][emer_office]" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-5 spacing-left">
                      Building <br> <input class="form-control" id="" value="{{ $emergencies->emer_building }}"
                        name="customeremergencies[{{ $index }}][emer_building]" type="text" placeholder="..." style="width: 100%;">
                    </div>
                  </div>
                  <div class="row mb-2">
                    <div class="col-lg-5 spacing-right">
                      Block <br> <input class="form-control" id="" value="{{ $emergencies->emer_block }}" name="customeremergencies[{{ $index }}][emer_block]"
                        type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-5 spacing-left">
                      Area <br> <input class="form-control" id="" value="{{ $emergencies->emer_area }}" name="customeremergencies[{{ $index }}][emer_area]"
                        type="text" placeholder="..." style="width: 100%;">
                    </div>
                  </div>
                  <div class="row mb-2">
                    <div class="col-lg-5 spacing-right">
                      City <br> <input class="form-control" id="" value="{{ $emergencies->emer_city }}" name="customeremergencies[{{ $index }}][emer_city]"
                        type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-5 spacing-left">
                      Photograph of Building <br> <input class="form-control" id="" value="{{ $emergencies->emer_loc }}"
                  ...
                  <div class="row mb-2">
                    <div class="col-lg-5 spacing-right">
                      Email <br> <input class="form-control vldemail" id="" name="customeremergencies[{{ $index }}][emer_email]"
                        value="{{ $emergencies->emer_email }}" type="text" placeholder="..." style="width: 100%;">
                      <div id="emailError" class="emailError" style="color: red"></div>
                    </div>
                    <div class="col-lg-5 spacing-left">
                      Website <br> <input class="form-control vldwebsite" id="" name="customeremergencies[{{ $index }}][emer_web]"
                        value="{{ $emergencies->emer_web }}" type="text" placeholder="..." style="width: 100%;">
                      <div id="websiteError" class="websiteError" style="color: red"></div>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="col-lg-5 spacing-right">
                      Pin location <br> <input class="form-control" id="location-input2" name="customeremergencies[{{ $index }}][emer_pin]"
                        value="{{ $emergencies->emer_pin }}" type="text" placeholder="..." style="width: 100%;" onfocus="initAutocomplete2()">
                    </div>
                    <div>
                      <br> <input class="form-control" id="" name="longitude2" value="{{ $customers->longitude2 }}" type="hidden" placeholder="..."
                        style="width: 100%;">
                    </div>
                    <div>
                      <br> <input class="form-control" id="" name="latitude2" value="{{ $customers->latitude2 }}" type="hidden" placeholder="..."
                        style="width: 100%;">
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-6 spacing-left mt-2">
                Applicable Rental Property Number <br> <input class="form-control" name="customeremergencies[{{ $index }}][emer_app_rental]"
                  value="{{ $emergencies->emer_app_rental }}" type="text" placeholder="..." style="width: 70%;" multiple>
              </div>
              <div class="row mb-2">
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Attachements <br> <input class="form-control" name="customeremergencies[{{ $index }}][emer_attach]" value="{{ $emergencies->emer_attach }}"
                    type="file" placeholder="..." style="width: 70%;" multiple>
                  <div class="col-lg-5 spacing-right">
                    <div class="image-preview42" id="imagePreview42">
                ...
                <div class="col-lg-6 spacing-left spacing-right my-3">
                  Notes <br>
                  <textarea id="w3review6" class="form-control" name="customeremergencies[{{ $index }}][emer_note]" oninput="trimSpaces6()"
      ...
      <div class="row accordion" id="departmentAccordion">
        ...
        <div class="accordion-item" id="departmentEntry{{ $index + 1 }}">
          <h2 class="accordion-header" id="departmentHeading{{ $index + 1 }}">
            <button class="accordion-button" type="button" data-toggle="collapse" data-target="#departmentCollapse{{ $index + 1 }}" aria-expanded="false"
              aria-controls="departmentCollapse{{ $index + 1 }}">
              Department Entry {{ $index + 1 }}
            </button>
          </h2>
          <div id="departmentCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="departmentHeading{{ $index + 1 }}">
            <div class="accordion-body">
              <input type="hidden" name="customerdepartments[{{ $index }}][d_id]" value="{{ $departmentss->id }}">
              <div class="spacing-right form-group">
                Department Type <br>
                <div class="input-group" style="width: 100%;">
                  <select id="dropdown" class="form-control mt-1" name="customerdepartments[{{ $index }}][dept_type]" value="{{ $departmentss->dept_type }}"
                    style="width: 70%; border-radius: 4px 0 0 4px; ">
                    <option value=""></option>
                    @foreach ($departments as $department)
                    <option value="{{ $department->department_name }}" @if($department->department_name == $departmentss->dept_type ) selected
              ...
              <div class="col-lg-6">
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    POC Name <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_name]" value="{{ $departmentss->dept_name }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right">
                    Email <br> <input class="form-control vldemail" name="customerdepartments[{{ $index }}][dept_email]" value="{{ $departmentss->dept_email }}"
                      type="text" placeholder="..." style="width: 100%;">
                    <div id="emailError" class="emailError" style="color: red"></div>
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Cell Number <br> <input class="form-control vldphone" name="customerdepartments[{{ $index }}][dept_cell]"
                      value="{{ $departmentss->dept_cell }}" type="text" placeholder="..." style="width: 100%;">
                    <div id="phoneError" class="phoneError" style="color: red"></div>
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right">
                    Address <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_address]" value="{{ $departmentss->dept_address }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6  spacing-right">
                    Designation <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_desig]" value="{{ $departmentss->dept_desig }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right">
                    Visiting Card (front) <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_front]"
                      value="{{ $departmentss->dept_front }}" type="file" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6  spacing-right">
                    Visiting Card (back) <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_back]"
                      value="{{ $departmentss->dept_back }}" type="file" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-left spacing-right">
                    Notes <br>
                    <textarea id="w3review7" class="form-control" name="customerdepartments[{{ $index }}][dept_notes]" oninput="trimSpaces7()"
                      onclick="moveCursorToStart7()" rows="2" cols="24">{{ $departmentss->dept_notes }}
                    </textarea>
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Attachments <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_attach]" value="{{ $departmentss->dept_attach }}"
              ...
              <div class="col-lg-6 spacing-left">
                ...
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Office No <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_office]" value="{{ $departmentss->dept_office }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    Building <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_build]" value="{{ $departmentss->dept_build }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-5 spacing-right">
                    Block <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_block]" value="{{ $departmentss->dept_block }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    Area <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_area]" value="{{ $departmentss->dept_area }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-5 spacing-right">
                    City <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_city]" value="{{ $departmentss->dept_city }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    Photograph of building <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_photo]"
                      value="{{ $departmentss->dept_photo }}" type="file" placeholder="..." style="width: 100%;">
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($departmentss->dept_photo)
                        <img src="{{ asset($departmentss->dept_photo) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
                ...
                <div class="row mb-2">
                  <div class="col-lg-5 spacing-right">
                    Pin Location <br> <input id="location-input3" class="form-control" name="customerdepartments[{{ $index }}][dept_pin]"
                      value="{{ $departmentss->dept_pin }}" type="text" placeholder="..." style="width: 100%;" onfocus="initAutocomplete3()">
                  </div>
                  <div>
                    <br> <input class="form-control" id="" name="longitude3" value="{{ $customers->longitude3 }}" type="hidden" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div>
                    <br> <input class="form-control" id="" name="latitude3" value="{{ $customers->latitude3 }}" type="hidden" placeholder="..."
                      style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right mt-2">
                    Attachments <br> <input class="form-control" name="customerdepartments[{{ $index }}][dept_ex_attach]"
                      value="{{ $departmentss->dept_ex_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($departmentss->dept_ex_attach)
                        <img src="{{ asset($departmentss->dept_ex_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
                  ...
                  <div class="col-lg-6 spacing-left mt-2">
                    Notes <br>
                    <textarea id="w3review8" class="form-control" name="customerdepartments[{{ $index }}][dept_ex_notes]" oninput="trimSpaces8()"
        ...
        <div class="col-lg-12">
          ...
          <div class="row mb-2 mt-3">
            <div class="col-lg-4 spacing-right">
              Visit Performed By: <br> <input class="form-control" type="text" value="{{ $customers->visit_perf_by }}" name="visit_perf_by" placeholder="..."
                style="width: 100%;">
            </div>
            <div class="col-lg-4 spacing-right">
              Location: <br> <input class="form-control" type="text" name="pat_super_loc" value="{{ $customers->pat_super_loc }}" placeholder="..."
                style="width: 100%;">
            </div>
            <div class="col-lg-4 spacing-right">
              Date: <br> <input class="form-control" name="pat_super_date" value="{{ $customers->pat_super_date }}" type="date" placeholder="..."
                style="width: 100%;">
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-lg-4 spacing-right">
              Day: <br> <input class="form-control" type="text" name="pat_super_day" value="{{ $customers->pat_super_day }}" placeholder="..."
                style="width: 100%;">
            </div>
            <div class="col-lg-4 spacing-right">
              Time: <br> <input class="form-control" type="time" name="pat_super_times" value="{{ $customers->pat_super_times }}" placeholder="..."
                style="width: 100%;">
            </div>
            <div class="col-lg-4 spacing-right ">
              <div class="">
                Photo Taken: <br> <input class="form-control " value="{{ $customers->pat_super_photo }}" name="pat_super_photo" type="file" placeholder="..."
                  style="width: 100%;">
              </div>
            </div>
          </div>
          <div class="row mb-4">
            <div class="col-lg-4 spacing-right">
              <div>
                Video Taken: <br>
                <input class="form-control" name="pat_super_video" value="{{ $customers->pat_super_videp }}" type="file" placeholder="..." style="width: 100%;">
              </div>
            </div>
            <div class="col-lg-4 mt-3 spacing-right">
              ...
              <div class="form-check form-check-inline">
                ...
                <input class="form-check-input ml-3 mr-2" type="radio" name="pat_super_inform_email" value="0" id="inactiveEmailRadio">
            ...
            <div id="customModal" class="modal"
              ...
              <div class="modal-content"
                ...
                <div style="width: 100%;">
                  ...
                  <input type="text" id="customEmailSubject" name="customEmailSubject" value="Post Visit Report by PIFFERS Security Services (Pvt.) Ltd."
          ...
          <div id="inspectionAccordion">
            ...
            <div class="accordion-item" id="inspectionEntry{{ $index + 1 }}">
              <h2 class="accordion-header" id="inspectionHeading{{ $index + 1 }}">
                <button class="accordion-button" type="button" data-toggle="collapse" data-target="#inspectionCollapse{{ $index + 1 }}" aria-expanded="false"
                  aria-controls="inspectionCollapse{{ $index + 1 }}">
                  Inspection Entry {{ $index + 1 }}
                </button>
              </h2>
              <div id="inspectionCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="inspectionHeading{{ $index + 1 }}">
                <div class="accordion-body">
                  <input type="hidden" name="customerinspections[{{ $index }}][i_id]" value="{{ $inspections->id }}">
                  <div class="row mb-2">
                    <div class="col-lg-4 spacing-right">
                      Inspection Number <br> <input class="form-control" type="text" name="customerinspections[{{ $index }}][inspection_no]"
                        value="{{ $inspections->inspection_no }}" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Employee id <br> <input class="form-control" type="text" name="customerinspections[{{ $index }}][inspection_emp_id]"
                        value="{{ $inspections->inspection_emp_id }}" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Name <br> <input class="form-control" type="text" name="customerinspections[{{ $index }}][inspection_emp_name]"
                        value="{{ $inspections->inspection_emp_name }}" placeholder="..." style="width: 100%;">
                    </div>
                  </div>
                  <div class="row mb-2">
                    <div class="col-lg-4 spacing-right">
                      Cell Number: <br> <input class="form-control vldphone" type="text" name="customerinspections[{{ $index }}][inspection_emp_cell]"
                        value="{{ $inspections->inspection_emp_cell }}" placeholder="" style="width: 100%;">
                      <div id="phoneError" class="phoneError" style="color: red"></div>
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Department <br> <input class="form-control" type="text" name="customerinspections[{{ $index }}][inspection_emp_dept]"
                        value="{{ $inspections->inspection_emp_dept }}" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-left" style="margin-left:8px;">
                      Date of inspection. <br> <input class="form-control" type="date" name="customerinspections[{{ $index }}][inspection_date]"
                        value="{{ $inspections->inspection_date }}" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-left">
                      Picture of Inspection <br> <input class="form-control basic-info-attachements" id="inpFile22" type="file"
                        name="customerinspections[{{ $index }}][inspection_pic]" value="{{ $inspections->inspection_pic }}" placeholder="..."
                        style="width: 100%;" multiple>
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                          @if($inspections->inspection_pic)
                          <img src="{{ asset($inspections->inspection_pic) }}" alt="Image Preview42" class="image-preview__image42"
                            style="height: 100%; width:100%; margin-left:-13px;">
                          @else
                          <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                          @endif
                    ...
                    <div class="col-lg-4 spacing-right">
                      Remarks of Petroling Officer <br> <textarea class="form-control basic-info-attachements" id="inpFile2" type="text"
                        name="customerinspections[{{ $index }}][inspection_rem_petr]" placeholder="..."
                        style="width: 100%;">{{ $inspections->inspection_rem_petr }}</textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3">
                      Notes <br> <textarea class="form-control basic-info-attachements" type="text" name="customerinspections[{{ $index }}][inspection_note]"
                        placeholder="..." style="width: 100%;">{{ $inspections->inspection_note }}</textarea>
                    </div>
                    <div class="col-lg-3 spacing-left">
                      Attachments <br> <input class="form-control basic-info-attachements" id="" type="file"
                        name="customerinspections[{{ $index }}][inspection_attach]" value="{{ $inspections->inspection_attach }}" placeholder="..."
                        style="width: 100%;" multiple>
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                          @if($inspections->inspection_attach)
                          <img src="{{ asset($inspections->inspection_attach) }}" alt="Image Preview42" class="image-preview__image42"
                            style="height: 100%; width:100%; margin-left:-13px;">
                          @else
                          <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                          @endif
      ...
      <div id="cleaningAccordion">
        ...
        <div class="accordion-item" id="cleaningEntry{{ $index + 1 }}">
          <h2 class="accordion-header" id="cleaningHeading{{ $index + 1 }}">
            <button class="accordion-button" type="button" data-toggle="collapse" data-target="#cleaningCollapse{{ $index + 1 }}" aria-expanded="false"
              aria-controls="cleaningCollapse{{ $index + 1 }}">
              Cleaning Entry {{ $index + 1 }}
            </button>
          </h2>
          <div id="cleaningCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="cleaningHeading{{ $index + 1 }}">
            <div class="accordion-body">
              <input type="hidden" name="customerarmourers[{{ $index }}][a_id]" value="{{ $armourers->id }}">
              <div class="row col-lg-12">
                <div class="col-lg-4 spacing-right">
                  Branch Name <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_branch_name]"
                    value="{{ $armourers->arm_branch_name }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Branch ID <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_branch_id]"
                    value="{{ $armourers->arm_branch_id }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Site ID <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_site_id]" value="{{ $armourers->arm_site_id }}"
                    placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Client Name <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_client_name]"
                    value="{{ $armourers->arm_client_name }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Weapon Number <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_weapon_no]"
                    value="{{ $armourers->arm_weapon_no }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Weapon Bore <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_weapon_bore]"
                    value="{{ $armourers->arm_weapon_bore }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Weapon Type <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_weapon_type]"
                    value="{{ $armourers->arm_weapon_type }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Working Details <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_work_detail]"
                    value="{{ $armourers->arm_work_detail }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-4 spacing-right">
                  Sign of Customer <br> <input class="form-control" type="text" name="customerarmourers[{{ $index }}][arm_sign_cus]"
                    value="{{ $armourers->arm_sign_cus }}" placeholder="..." style="width: 100%;">
                </div>
              </div>
              <div class="col-lg-12">
                <div class="row mb-2">
                  <div class="col-lg-4 spacing-right" style="margin-bottom: 10px;">
                    New Authority Letter Issue : <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_auth]"
                      value="{{ $armourers->arm_auth }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;">
                    New Authority Letter No <br> <input class="form-control" id="head_office_email" id="inpFile42"
                      name="customerarmourers[{{ $index }}][arm_auth_no]" value="{{ $armourers->arm_auth_no }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;">
                    New Authority Letter Validity <br> <input class="form-control" id="head_office_email" name="customerarmourers[{{ $index }}][arm_auth_date]"
                      value="{{ $armourers->arm_auth_date }}" type="date" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-right" style="margin-bottom: 10px;">
                    Date of issue <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_auth_issue]"
                      value="{{ $armourers->arm_auth_issue }}" type="date" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;">
                    Number of weapon cleaned <br> <input class="form-control" id="head_office_email" id="inpFile42"
                      name="customerarmourers[{{ $index }}][arm_weapon_cleaned]" value="{{ $armourers->arm_weapon_cleaned }}" type="text" placeholder="..."
                      style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;">
                    Type of weapon cleaned <br> <input class="form-control" id="head_office_email" name="customerarmourers[{{ $index }}][type_weapon_cleaned]"
                      value="{{ $armourers->type_weapon_cleaned }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-right">
                    Picture before cleaning <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_pic_b]" type="file"
                  ...
                  <div class="col-lg-4 spacing-right">
                    Picture after cleaning <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_pic_a]" type="file"
                  ...
                  <div class="col-lg-4 spacing-right">
                    Cost of the day <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_cost_day]"
                      value="{{ $armourers->arm_cost_day }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 spacing-right">
                    Cost Bill <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_cost_bill]"
                  ...
                  <div class="col-lg-4 spacing-right">
                    Next cleaning activity due on : <br> <input class="form-control" id="" name="customerarmourers[{{ $index }}][arm_next_clean]"
                      value="{{ $armourers->arm_next_clean }}" type="date" placeholder="..." style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4 spacing-right mt-2">
                    Notes <br>
                    <textarea id="w3review9" class="form-control" name="customerarmourers[{{ $index }}][arm_next_clean]" oninput="trimSpaces9()"
                      onclick="moveCursorToStart9()" rows="2" cols="38">{{ $armourers->arm_next_clean }}
                    </textarea>
                  </div>
                  <div class="col-lg-4 spacing-left spacing-right mt-2">
                    Attachments <br> <input class="form-control" name="customerarmourers[{{ $index }}][arm_auth_attach]"
                      value="{{ $armourers->arm_auth_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($armourers->arm_auth_attach)
                        <img src="{{ asset($armourers->arm_auth_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
        ...
        <div id="incidentAccordion">
          ...
          <div class="accordion-item" id="incidentEntry{{ $index + 1 }}">
            <h2 class="accordion-header" id="incidentHeading{{ $index + 1 }}">
              <button class="accordion-button" type="button" data-toggle="collapse" data-target="#incidentCollapse{{ $index + 1 }}" aria-expanded="false"
                aria-controls="incidentCollapse{{ $index + 1 }}">
                Incident Entry {{ $index + 1 }}
              </button>
            </h2>
            <div id="incidentCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="incidentHeading{{ $index + 1 }}">
              <div class="accordion-body">
                ...
                <div class="col-lg-12">
                  <div class="row mb-2">
                    <div class="col-lg-3">
                      Client Name <br>
                      <input class="form-control" type="text" name="customerincidents[{{ $index }}][client_name]" value="{{ $incidents->client_name }}"
                        placeholder="..." />
                    </div>
                    <div class="col-lg-3">
                      Client ID <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][client_id]"
                        value="{{ $incidents->client_id }}" placeholder="...">
                    </div>
                    <div class="col-lg-3">
                      Site ID <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][client_site_id]"
                        value="{{ $incidents->client_site_id }}" placeholder="...">
                    </div>
                    <div class="col-lg-3">
                      Client POC Name <br>
                      <input class="form-control" type="text" name="customerincidents[{{ $index }}][client_poc]" value="{{ $incidents->client_poc }}"
                        placeholder="...">
                    </div>
                    <div class="col-lg-3 mt-2">
                      Cell <br> <input class="form-control vldphone" type="text" name="customerincidents[{{ $index }}][client_cell]"
                        value="{{ $incidents->client_cell }}" placeholder="...">
                      <div id="phoneError" class="phoneError" style="color: red"></div>
                    </div>
                    <div class="col-lg-3  mt-2">
                      Email <br> <input class="form-control vldemail" type="text" name="customerincidents[{{ $index }}][client_email]"
                        value="{{ $incidents->client_email }}" placeholder="...">
                      <div id="emailError" class="emailError" style="color: red"></div>
                    </div>
                    <div class="col-lg-3  mt-2">
                      Site Address <br>
                      <input class="form-control" type="text" name="customerincidents[{{ $index }}][client_site_address]"
                        value="{{ $incidents->client_site_address }}" placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      Office/Floor <br> <input class="form-control" name="customerincidents[{{ $index }}][client_office]"
                        value="{{ $incidents->client_office }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      Building Name<br> <input class="form-control" name="customerincidents[{{ $index }}][client_build]" value="{{ $incidents->client_build }}"
                        type="text" placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      Street <br>
                      <input class="form-control" type="text" name="customerincidents[{{ $index }}][client_street]" value="{{ $incidents->client_street }}"
                        placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      Area <br> <input class="form-control" name="customerincidents[{{ $index }}][client_area]" value="{{ $incidents->client_area }}"
                        type="text" placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      City <br> <input class="form-control" name="customerincidents[{{ $index }}][client_city]" value="{{ $incidents->client_city }}"
                        type="text" placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      FIR # <br> <input class="form-control" name="customerincidents[{{ $index }}][client_fir]" value="{{ $incidents->client_fir }}" type="text"
                        placeholder="...">
                    </div>

                    <div class="col-lg-3  mt-2">
                      Arrest # <br> <input class="form-control" name="customerincidents[{{ $index }}][arrest]" value="{{ $incidents->arrest }}" type="text"
                        placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      Casualities <br> <input class="form-control" name="customerincidents[{{ $index }}][casual]" value="{{ $incidents->casual }}" type="text"
                        placeholder="...">
                    </div>
                    <div class="col-lg-3  mt-2">
                      Injuired <br> <input class="form-control" name="customerincidents[{{ $index }}][injuired]" value="{{ $incidents->injuired }}" type="text"
                        placeholder="...">
                    </div>
                  ...
                  <div class="row mb-2 mt-3">
                    <div class="col-lg-4  mt-2">
                      Incident Reported to <br> <input class="form-control" name="customerincidents[{{ $index }}][incident_rep]"
                        value="{{ $incidents->incident_rep }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Police Officer Name <br> <input class="form-control" name="customerincidents[{{ $index }}][police_officer_name]"
                        value="{{ $incidents->police_officer_name }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Station <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][station]" value="{{ $incidents->station }}"
                        placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Rank <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][rank]" value="{{ $incidents->rank }}"
                        placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Report Made by <br> <input class="form-control" name="customerincidents[{{ $index }}][report_made_by]"
                        value="{{ $incidents->report_made_by }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Date <br> <input class="form-control" name="customerincidents[{{ $index }}][report_date]" value="{{ $incidents->report_date }}"
                        type="date" placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Time <br> <input class="form-control" name="customerincidents[{{ $index }}][report_time]" value="{{ $incidents->report_time }}"
                        type="time" placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Approved By <br> <input class="form-control" name="customerincidents[{{ $index }}][report_apr_by]" value="{{ $incidents->report_apr_by }}"
                        type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4  mt-2">
                      Shared with <br> <input class="form-control" name="customerincidents[{{ $index }}][report_shared]" value="{{ $incidents->report_shared }}"
                        type="text" placeholder="...">
                    </div>
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="row mb-2">
                    <div class="col-lg-3 ">
                      Incident Type <br> <input class="form-control" name="customerincidents[{{ $index }}][incident_type]"
                        value="{{ $incidents->incident_type }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-3 ">
                      Shoes <br>
                      <input class="form-control" type="text" name="customerincidents[{{ $index }}][attacker_shoe]" value="{{ $incidents->attacker_shoe }}"
                        placeholder="...">
                    </div>
                    <div class="col-lg-3">
                      Beard/M <br> <input class="form-control" name="customerincidents[{{ $index }}][attacker_beard]" value="{{ $incidents->attacker_beard }}"
                        type="text" placeholder="...">
                    </div>
                    <div class="col-lg-3">
                      Language <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][attacker_lang]"
                        value="{{ $incidents->attacker_lang }}" placeholder="...">
                    </div>
                    <div class="col-lg-4">
                      Focused on <br>
                      <input class="form-control" type="text" name="customerincidents[{{ $index }}][focused]" value="{{ $incidents->focused }}"
                        placeholder="...">
                    </div>
                    <div class="col-lg-4">
                      Opening Phrase <br> <input class="form-control" name="customerincidents[{{ $index }}][opening_phrase]"
                        value="{{ $incidents->opening_phrase }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4">
                      Anything Unusual <br> <input class="form-control" name="customerincidents[{{ $index }}][any_usual]" value="{{ $incidents->any_usual }}"
                        type="text" placeholder="...">
                    </div>
                  </div>
                  <div class="row mb-2 ">
                    ...
                    <div class="col-lg-4 ">
                      Weapon used by Attacker <br> <input class="form-control" name="customerincidents[{{ $index }}][weapon_used]"
                        value="{{ $incidents->weapon_used }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4 ">
                      Details of Attacker <br> <input class="form-control" name="customerincidents[{{ $index }}][detail_of_attacker]"
                        value="{{ $incidents->detail_of_attacker }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4">
                      Attacker Description <br> <input class="form-control" name="customerincidents[{{ $index }}][attacker_desc]"
                  ...
                  <div class="row mb-2">
                    <div class="col-lg-4">
                      Estimated Loss in PKR <br> <input class="form-control" name="customerincidents[{{ $index }}][estimated_loss]"
                        value="{{ $incidents->estimated_loss }}" type="text" placeholder="...">
                    </div>
                    <div class="col-lg-4 ">
                      Description of Loss <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][desc_loss]"
                        value="{{ $incidents->desc_loss }}" placeholder="...">
                    </div>
                    <div class="col-lg-4">
                      Officers Response <br> <input class="form-control" type="text" name="customerincidents[{{ $index }}][officer_response]"
                ...
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Attachements <br> <input class="form-control" type="file" name="customerincidents[{{ $index }}][incident_attach]"
                  ...
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Notes <br>
                    <textarea id="w3review10" class="form-control" oninput="trimSpaces10()" onclick="moveCursorToStart10()"
                      name="customerincidents[{{ $index }}][incident_note]" rows="2" cols="38">{{ $incidents->incident_note }}
                    </textarea>
                  </div>
                </div>
              </div>
      ...
      <div id="assignmentAccordion">
        ...
        <div class="accordion-item" id="assignmentEntry{{ $index + 1 }}">
          <h2 class="accordion-header" id="assignmentHeading{{ $index + 1 }}">
            <button class="accordion-button" type="button" data-toggle="collapse" data-target="#assignmentCollapse{{ $index + 1 }}" aria-expanded="false"
              aria-controls="assignmentCollapse{{ $index + 1 }}">
              Assignment Entry {{ $index + 1 }}
            </button>
          </h2>
          <div id="assignmentCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="assignmentHeading{{ $index + 1 }}">
            <div class="accordion-body">
              ...
              <div class="col-lg-12">
                <div class="row mb-2">
                  <div class="col-lg-3 ">
                    Customer Name <br>
                    <input class="form-control" name="customerassigments[{{ $index }}][asig_customer_name]" value="{{ $assigments->asig_customer_name }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 ">
                    Task Assigning <br> <input class="form-control" name="customerassigments[{{ $index }}][task_assigning]"
                      value="{{ $assigments->task_assigning }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Designation <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][asig_desig]" value="{{ $assigments->asig_desig }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 ">
                    Office/Floor <br> <input class="form-control" name="customerassigments[{{ $index }}][asig_office]" value="{{ $assigments->asig_office }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 ">
                    Building Name<br> <input class="form-control" type="text" name="customerassigments[{{ $index }}][asig_building]"
                      value="{{ $assigments->asig_building }}" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Road/Street <br> <input class="form-control" type="text" name="customerassigments[{{ $index }}][asig_road]"
                      value="{{ $assigments->asig_road }}" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 ">
                    Area <br> <input class="form-control" type="text" name="customerassigments[{{ $index }}][asig_area]" value="{{ $assigments->asig_area }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 ">
                    City <br> <input class="form-control" type="text" name="customerassigments[{{ $index }}][task_assigning]"
                      value="{{ $assigments->task_assigning }}" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Country <br> <input class="form-control" type="text" name="customerassigments[{{ $index }}][asig_country]"
                      value="{{ $assigments->asig_country }}" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 ">
                    Security Incharge <br> <input class="form-control" name="customerassigments[{{ $index }}][asig_security]"
                      value="{{ $assigments->asig_security }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Contact Details <br> <input class="form-control" name="customerassigments[{{ $index }}][asig_contact]"
                      value="{{ $assigments->asig_contact }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <h5 class="mt-3">Site Incharge Details</h5>
                  <div class="col-lg-3">
                    Incharge Name <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][incharge_name]" value="{{ $assigments->incharge_name }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Designation <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][incharge_desig]" value="{{ $assigments->incharge_desig }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Contact Details <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_contact]"
                      value="{{ $assigments->incharge_contact }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    High Risk Areas <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][incharge_help]" value="{{ $assigments->incharge_help }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4">
                    Description of Risk <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][incharge_desc]" value="{{ $assigments->incharge_desc }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4">
                    History of Risk <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_risk]"
                      value="{{ $assigments->incharge_risk }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4">
                    Assigned Area Manager Of PIFFERS <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][incharge_asig]" value="{{ $assigments->incharge_asig }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6">
                    Signed By <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_signed_by]"
                      value="{{ $assigments->incharge_signed_by }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6">
                    Date <br> <input class="form-control" type="date" name="customerassigments[{{ $index }}][incharge_date]"
              ...
              <div class="col-lg-12">
                <div class="row mb-2">
                  ...
                  <div class="row mb-2">
                    <div class="col-lg-4">
                      Office No <br> <input class="form-control" id="" name="customerassigments[{{ $index }}][incharge_offc]"
                        value="{{ $assigments->incharge_offc }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4">
                      Building <br> <input class="form-control" id="" name="customerassigments[{{ $index }}][incharge_build]"
                        value="{{ $assigments->incharge_build }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 ">
                      Block <br> <input class="form-control" id="" name="customerassigments[{{ $index }}][incharge_block]"
                        value="{{ $assigments->incharge_block }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4">
                      Area <br> <input class="form-control" id="" name="customerassigments[{{ $index }}][incharge_area]"
                        value="{{ $assigments->incharge_area }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 ">
                      City <br> <input class="form-control" id="" name="customerassigments[{{ $index }}][incharge_city]"
                        value="{{ $assigments->incharge_city }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 ">
                      Pin Location <br> <input class="form-control" id="location-input4" name="customerassigments[{{ $index }}][incharge_pin]"
                        value="{{ $assigments->incharge_pin }}" type="text" placeholder="..." style="width: 100%;" onfocus="initAutocomplete4()">
                    </div>
                    <div class="col-lg-3">
                      <br> <input class="form-control" id="" name="longitude4" value="{{ $customers->longitude4 }}" type="hidden" placeholder="..."
                        style="width: 100%;">
                    </div>
                    <div class="col-lg-3">
                      <br> <input class="form-control" id="" name="latitude4" value="{{ $customers->latitude4 }}" type="hidden" placeholder="..."
                        style="width: 100%;">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    Country <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_country]"
                      value="{{ $assigments->incharge_country }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Site ID <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_site]" value="{{ $assigments->incharge_site }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    A-Guard <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_a_g]" value="{{ $assigments->incharge_a_g }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3">
                    Un-A-Guard <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_a_ung]"
                      value="{{ $assigments->incharge_a_ung }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 ">
                    Total Guard <br> <input class="form-control" name="customerassigments[{{ $index }}][incharge_t_g]" value="{{ $assigments->incharge_t_g }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 ">
                    Recent Security Related Incidents <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][rec_inc_rel]" value="{{ $assigments->rec_inc_rel }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4">
                    Frequency Of Occurence <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][feq_occ]" value="{{ $assigments->feq_occ }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4">
                    Expectations from PIFFERS <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][exp_piff]" value="{{ $assigments->exp_piff }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4">
                    Any Special Instructions <br> <input class="form-control" name="customerassigments[{{ $index }}][any_spec]"
                      value="{{ $assigments->any_spec }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-4 ">
                    Petrolling Instruction <br>
                    <input class="form-control" type="text" name="customerassigments[{{ $index }}][petr_instruc]" value="{{ $assigments->petr_instruc }}"
                      placeholder="..." style="width: 100%;">
                  </div>
                </div>
              </div>
              ...
              <div class="row mb-2">
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Attachments <br> <input class="form-control" type="file" name="customerassigments[{{ $index }}][asig_ex_attach]"
                ...
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Notes <br>
                  <textarea id="w3review11" class="form-control" name="customerassigments[{{ $index }}][asig_ex_notes]" oninput="trimSpaces11()"
      ...
      <div class="row" id="auditsAccordion">
        ...
        <div class="accordion-item" id="auditEntry{{ $index + 1 }}">
          <h2 class="accordion-header" id="auditHeading{{ $index + 1 }}">
            <button class="accordion-button" type="button" data-toggle="collapse" data-target="#auditCollapse{{ $index + 1 }}" aria-expanded="false"
              aria-controls="auditCollapse{{ $index + 1 }}">
              Audit {{ $index + 1 }}
            </button>
          </h2>
          <div id="auditCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="auditHeading{{ $index + 1 }}">
            <div class="accordion-body">
              <input type="hidden" name="customeraudits[{{ $index }}][au_id]" value="{{ $audits->id }}">
              <div class="col-lg-12">
                <div class="row mb-2">
                  <div class="col-lg-3 spacing-right">
                    File Audited By : <br> <input class="form-control" id="" name="customeraudits[{{ $index }}][audit_file]" value="{{ $audits->audit_file }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 spacing-left spacing-right">
                    Signature <br> <input class="form-control" id="head_office_email" name="customeraudits[{{ $index }}][audit_sign]"
                      value="{{ $audits->audit_sign }}" type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 spacing-right">
                    Date <br> <input class="form-control" id="" name="customeraudits[{{ $index }}][audit_date]" value="{{ $audits->audit_date }}" type="date"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-3 spacing-right">
                    Attachments <br> <input class="form-control" id="" name="customeraudits[{{ $index }}][audit_attach]" value="{{ $audits->audit_attach }}"
              ...
              <div class="row mb-2">
                <div class="col-lg-5 spacing-left spacing-right form-group">
                  Checked by: <br>
                  <div class="input-group" style="width: 100%;">
                    <select id="dropdown" class="form-control mt-1" name="customeraudits[{{ $index }}][audit_checked_by]"
                      value="{{ $audits->audit_checked_by }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                      <option value=""></option>
                      @foreach ($checkedby as $checked)
                      <option value="{{ $checked->checkedby_name }}" @if($checked->checkedby_name == $audits->audit_checked_by) selected
                        @endif>{{ $checked->checkedby_name}}</option>
                      @endforeach
                    </select>
                    <div class="input-group-append" style="width: 30%;">
              ...
              <div class="row mb-2">
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Attachements <br> <input class="form-control" name="customeraudits[{{ $index }}][audit_ex_attach]" type="file"
                ...
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Notes <br>
                  <textarea id="w3review12" class="form-control" name="customeraudits[{{ $index }}][audit_note]" oninput="trimSpaces12()"
                    onclick="moveCursorToStart12()" rows="2" cols="38">{{ $audits->audit_note }}
                  </textarea>
                </div>
              </div>
            </div>
    ...
    <div class="tab-pane fade m-3" style="opacity: 90%;" id="address-details" role="tabpanel" aria-labelledby="nav-profile-tab">
      ...
      <div class="row">
        <nav>
          <div class="nav nav-tabs mt-3" id="nav-tab" role="tablist">
            <a class="nav-item nav-link" id="nav-meeting-tab" data-toggle="tab" href="#meeting" role="tab" aria-controls="nav-meeting"
              aria-selected="false">Meetings
              with Customer
            </a>
            <a class="nav-item nav-link" id="nav-meeting-tab" data-toggle="tab" href="#score" role="tab" aria-controls="nav-meeting" aria-selected="false">Score
              Card
            </a>
          </div>
        </nav>
          ...
          <div class="tab-pane fade m-3" style="opacity: 90%;" id="meeting" role="tabpanel" aria-labelledby="nav-meeting-tab">
            <div class=" row main-content div">
              <div class="col-lg-6">
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-right">
                    Date of meeting <br> <input class="form-control" id="" name="meeting_date" value="{{ $customers->meeting_date }}" type="date"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left spacing-right">
                    Meeting Chaired By <br> <input class="form-control" id="head_office_email" name="meeting_chaired" value="{{ $customers->meeting_chaired }}"
                      type="text" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-6 spacing-right">
                    Minutes of Meeting <br> <input class="form-control" id="" name="meeting_minutes" value="{{ $customers->meeting_minutes }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left spacing-right">
                    Attachment <br> <input class="form-control" id="head_office_email" name="meeting_attach" value="{{ $customers->meeting_attach }}"
                      type="file" placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5  spacing-right">
                    Customer Comments <br> <textarea class="form-control" id="head_office_comp" name="meeting_comment" type="text" placeholder="..."
              ...
              <div class="col-lg-6 spacing-left">
                <div class="row mb-2">
                  <div class="col-lg-5 spacing-left spacing-right form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                      <select id="dropdown" class="form-control mt-1" name="meeting_main_point" value="{{ $customers->meeting_main_point }}"
                        style="width: 70%; border-radius: 4px 0 0 4px; ">
                        <option value=""></option>
                        @foreach ($mpoc as $mpoc)
                        <option value="{{  $mpoc->mpoc_name }}" @if( $mpoc->mpoc_name == $customers->meeting_main_point) selected @endif>{{ $mpoc->mpoc_name }}
                        </option>
                        @endforeach
                      </select>
                      <div class="input-group-append" style="width: 30%;">
                  ...
                  <div class="col-lg-5 spacing-left">
                    Attachment <br> <input class="form-control" id="" name="meeting_ex_attach" value="{{ $customers->meeting_ex_attach }}" type="file"
                      placeholder="..." style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-5 spacing-right">
                    Frequency of Meeting <br> <input class="form-control" id="" name="meeting_freq" value="{{ $customers->meeting_freq }}" type="text"
                      placeholder="..." style="width: 100%;">
                  </div>
                  <div class="col-lg-5 spacing-left">
                    Attachment <br> <input class="form-control" id="" name="meeting_freq_attach" value="{{ $customers->meeting_freq_attach }}" type="file"
                      placeholder="..." style="width: 100%;">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-5  spacing-right">
                    Note <br> <textarea class="form-control" id="w3review21" name="meeting_freq_note" oninput="trimSpaces21()" onclick="moveCursorToStart21()"
                      type="text" placeholder="..." style="width: 100%;">{{ $customers->meeting_freq_note }}</textarea>
                  </div>
                  <div class="col-lg-5 spacing-right" style="display: none">
                    Alert <br> <input class="form-control" id="" name="meeting_freq_alert" type="text" value="{{ $customers->meeting_freq_alert }}"
                      placeholder="meeting is pending" style="width: 100%;">
                  </div>
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Attachements <br> <input class="form-control" type="file" name="meeting_alert_attach" value="{{ $customers->meeting_alert_attach }}"
                    placeholder="..." style="width: 70%;" multiple>
                </div>
                <div class="col-lg-6 spacing-left spacing-right mt-2">
                  Notes <br>
                  <textarea id="w3review22" class="form-control" name="meeting_alert_notes" oninput="trimSpaces22()" onclick="moveCursorToStart22()" rows="2"
                    cols="38">{{ $customers->meeting_alert_notes }}
                  </textarea>
                </div>
              </div>
            </div>
              ...
              <div class="accordion" id="scoreCardAccordion">
                ...
                <div class="accordion-item" id="scoreCardEntry1">
                  <h2 class="accordion-header" id="scoreCardHeading1">
                    <button class="accordion-button" type="button" data-toggle="collapse" data-target="#scoreCardCollapse1" aria-expanded="true"
                      aria-controls="scoreCardCollapse1">
                      scoreCard 1
                    </button>
                  </h2>
                  <div id="scoreCardCollapse1" class="accordion-collapse collapse show" aria-labelledby="scoreCardHeading1">
                    <div class="accordion-body">
                      ...
                      <div class="row mb-1">
                        <div class="col-lg-4 spacing-left">
                          Customer Name <br> <input class="form-control form_boot" name="scr_cus_name" value="{{ $customers->scr_cus_name }}" type="text"
                            placeholder="..." style="width: 100%; ">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Region <br> <input class="form-control form_boot" name="scr_cus_region" value="{{ $customers->scr_cus_region }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Customer ID <br> <input class="form-control form_boot" name="scr_cus_id" value="{{ $customers->scr_cus_id }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-left mt-2">
                          Site ID <br> <input class="form-control form_boot" name="scr_cus_site_id" value="{{ $customers->scr_cus_site_id }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-left mt-2">
                          Report <br> <input class="form-control form_boot" name="scr_cus_report" value="{{ $customers->scr_cus_report }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-left mt-2">
                          Date <br> <input class="form-control form_boot" name="scr_cus_date" value="{{ $customers->scr_cus_date }}" type="date"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-left mt-2">
                          For Month of: <br> <input class="form-control form_boot" name="f_month" value="{{ $customers->f_month }}" type="date"
                            placeholder="..." style="width: 100%;">
                        </div>
                      </div>
                      <hr width="90%" />
                          ...
                          <table class="table table-bordered " style="border: 2px solid darkgray !important">
                            ...
                            <tbody>
                              ...
                              <tr width="100%" style="background-color: #32444f">
                                ...
                                <td width="15%" style="color: white"><input id="grandTotal" type="number" value="{{ $customers->marks_grand_total }}"
                      ...
                      <div class="row mb-1">
                        <div class="col-lg-4 spacing-left">
                          Customer POC Name <br> <input class="form-control form_boot" name="cus_poc_name" value="{{ $customers->cus_poc_name }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Signature <br> <input class="form-control form_boot" name="cus_poc_signature" value="{{ $customers->cus_poc_signature }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Cell <br> <input class="form-control vldphone form_boot" name="cus_poc_cell" value="{{ $customers->cus_poc_cell }}" type="text"
                            placeholder="..." style="width: 100%;">
                          <div id="phoneError" class="phoneError" style="color: red"></div>
                        </div>
                        <div class="col-lg-4 spacing-left">
                          CRO Name <br> <input class="form-control form_boot" name="cro_name" value="{{ $customers->cro_name }}" type="text" placeholder="..."
                            style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Signature <br> <input class="form-control form_boot" name="cro_signature form_boot" value="{{ $customers->cro_signature }}"
                            type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Cell <br> <input class="form-control vldphone form_boot" name="cro_cell" value="{{ $customers->cro_cell }}" type="text"
                            placeholder="..." style="width: 100%;">
                          <div id="phoneError" class="phoneError" style="color: red"></div>
                        </div>
                        <div class="col-lg-4 spacing-left">
                          GM/DGM Name <br> <input class="form-control form_boot" name="gm_name" value="{{ $customers->gm_name }}" type="text" placeholder="..."
                            style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Signature <br> <input class="form-control form_boot" name="gm_signature" value="{{ $customers->gm_signature }}" type="text"
                            placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-left">
                          Cell <br> <input class="form-control vldphone form_boot" name="gm_signature" value="{{ $customers->gm_signature }}" type="text"
                            placeholder="..." style="width: 100%;">
                          <div id="phoneError" class="phoneError" style="color: red"></div>
                        </div>
                      </div>
    ...
    <div class="tab-pane fade m-3" style="opacity: 90%;" id="intelligence" role="tabpanel" aria-labelledby="nav-loto-tab">
        ...
        <div id="businessAccordion">
          ...
          <div class="accordion-item" id="businessEntry{{ $index + 1 }}">
            <h2 class="accordion-header" id="businessHeading{{ $index + 1 }}">
              <button class="accordion-button" type="button" data-toggle="collapse" data-target="#businessCollapse{{ $index + 1 }}" aria-expanded="false"
                aria-controls="businessCollapse{{ $index + 1 }}">
                Business Entry {{ $index + 1 }}
              </button>
            </h2>
            <div id="businessCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="businessHeading{{ $index + 1 }}">
              <div class="accordion-body">
                ...
                <div class=" row main-content div">
                  ...
                  <div class="col-lg-12">
                    <div class="row mb-2">
                      <div class="col-lg-6 spacing-right">
                        Name of Business <br> <input class="form-control" value="{{ $bussinesses->bussiness_name }}"
                          name="customerbussinesses[{{ $index }}][bussiness_name]" type="text" placeholder="..." style="width: 100%;">
                      </div>
                      <div class="col-lg-6 spacing-right">
                        Nature of Business <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_nature }}"
                          name="customerbussinesses[{{ $index }}][bussiness_nature]" type="text" placeholder="..." style="width: 100%;">
                      </div>
                      <div class="col-lg-6 spacing-left">
                        <h5>Address</h5>
                        <div class="row mb-2">
                          <div class="col-lg-5 spacing-right">
                            Office No <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_office_no }}"
                              name="customerbussinesses[{{ $index }}][bussiness_office_no]" type="text" placeholder="..." style="width: 100%;">
                          </div>
                          <div class="col-lg-5 spacing-right">
                            Floor <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_floor }}"
                              name="customerbussinesses[{{ $index }}][bussiness_floor]" type="text" placeholder="..." style="width: 100%;">
                          </div>
                          <div class="col-lg-5">
                            Building <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_building }}"
                              name="customerbussinesses[{{ $index }}][bussiness_building]" type="text" placeholder="..." style="width: 100%;">
                          </div>
                        </div>
                        <div class="row mb-2">
                          <div class="col-lg-5 spacing-right">
                            Block <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_block }}"
                              name="customerbussinesses[{{ $index }}][bussiness_block]" type="text" placeholder="..." style="width: 100%;">
                          </div>
                          <div class="col-lg-5 spacing-left">
                            Area <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_area }}"
                              name="customerbussinesses[{{ $index }}][bussiness_area]" type="text" placeholder="..." style="width: 100%;">
                          </div>
                        </div>
                        <div class="row mb-2">
                          <div class="col-lg-5 spacing-right">
                            City <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_city }}"
                              name="customerbussinesses[{{ $index }}][bussiness_city]" type="text" placeholder="..." style="width: 100%;">
                          </div>
                          <div class="col-lg-5 spacing-left">
                            Photograph of Building <br> <input class="form-control" id="" value="{{ $bussinesses->bussiness_photo }}"
                              name="customerbussinesses[{{ $index }}][bussiness_photo]" type="file" placeholder="..." style="width: 100%;">
                            <div class="col-lg-5 spacing-right">
                              <div class="image-preview42" id="imagePreview42">
                                @if($bussinesses->bussiness_photo)
                                <img src="{{ asset($bussinesses->bussiness_photo) }}" alt="Image Preview42" class="image-preview__image42"
                                  style="height: 100%; width:100%; margin-left:-13px;">
                                @else
                                <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                                @endif
                        ...
                        <div class="row mb-2">
                          <div class="col-lg-5 spacing-right">
                            Email <br> <input class="form-control vldemail" id="" name="customerbussinesses[{{ $index }}][bussiness_email]"
                              value="{{ $bussinesses->bussiness_email }}" type="text" placeholder="..." style="width: 100%;">
                            <div id="emailError" class="emailError" style="color: red"></div>
                          </div>
                          <div class="col-lg-5 spacing-left">
                            Website <br> <input class="form-control vldwebsite" id="" name="customerbussinesses[{{ $index }}][bussiness_web]"
                              value="{{ $bussinesses->bussiness_web }}" type="text" placeholder="..." style="width: 100%;">
                            <div id="websiteError" class="websiteError" style="color: red"></div>
                          </div>
                        </div>
                        <div class="row mb-2">
                          <div class="col-lg-5 spacing-right">
                            Pin location <br> <input class="form-control" id="location-input5" name="customerbussinesses[{{ $index }}][bussiness_pin]"
                              value="{{ $bussinesses->bussiness_pin }}" type="text" placeholder="..." style="width: 100%;" onfocus="initAutocomplete5()">
                          </div>
                          <div>
                            <br> <input class="form-control" id="" name="longitude5" value="{{ $customers->longitude5 }}" type="hidden" placeholder="..."
                              style="width: 100%;">
                          </div>
                          <div>
                            <br> <input class="form-control" id="" name="latitude5" value="{{ $customers->latitude5 }}" type="hidden" placeholder="..."
                              style="width: 100%;">
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row mb-2">
                    <div class="col-lg-4 spacing-left spacing-right mt-2">
                      Notes <br>
                      <textarea id="w3review13" class="form-control" name="customerbussinesses[{{ $index }}][bussiness_notes]" oninput="trimSpaces13()"
                        onclick="moveCursorToStart13()" rows="2" cols="38">{{ $bussinesses->bussiness_notes }}
                      </textarea>
                    </div>
                    <div class="col-lg-4 spacing-left spacing-right mt-2">
                      Attachements <br> <input class="form-control" value="{{ $bussinesses->bussiness_attach }}" type="file"
                        name="customerbussinesses[{{ $index }}][bussiness_attach]" placeholder="..." style="width: 70%;" multiple>
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
      ...
      <div>
        <div id="giveawaysAccordion">
          ...
          <div class="accordion-item" id="giveawayEntry{{ $index + 1 }}">
            <h2 class="accordion-header" id="giveawayHeading{{ $index + 1 }}">
              <button class="accordion-button" type="button" data-toggle="collapse" data-target="#giveawayCollapse{{ $index + 1 }}" aria-expanded="false"
                aria-controls="giveawayCollapse{{ $index + 1 }}">
                Giveaway Entry {{ $index + 1 }}
              </button>
            </h2>
            <div id="giveawayCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="giveawayHeading{{ $index + 1 }}">
              <div class="accordion-body">
                <input type="hidden" name="customeractivities[{{ $index }}][act_id]" value="{{ $activitiess->id }}">
                <div class="col-lg-6 spacing-right form-group">
                  Customer Details Entered in all Promotional Activities <br>
                  <div class="input-group" style="width: 100%;">
                    <select id="dropdown" class="form-control mt-1" name="customeractivities[{{ $index }}][promotional_act]"
                      value="{{ $activitiess->promotional_act }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                      <option value=""></option>
                      @foreach ($activities as $activity)
                      <option value="{{ $activity->activity_name }}" @if($activity->activity_name == $activitiess->promotional_act ) selected
                        @endif>{{ $activity->activity_name }}</option>
                      @endforeach
                    </select>
                    <div class="input-group-append" style="width: 30%;">
                ...
                <div class="col-lg-6 mt-1">
                  <div class="spacing-left">
                    Quantity <br> <input class="form-control" type="text" name="customeractivities[{{ $index }}][promotional_quantity]"
                      value="{{ $activitiess->promotional_quantity }}" placeholder="..." style="width: 100%;">
                  </div>
                </div>
                <div class="form-type col-lg-6 spacing-right">
                  Estimated price<br> <input class="form-control" id="shift_start_date" name="customeractivities[{{ $index }}][prom_price]"
                    value="{{ $activitiess->prom_price }}" type="text" placeholder="..." style="width: 100%;">
                </div>
                <div class="form-type col-lg-6 spacing-right">
                  Date <br> <input class="form-control" id="shift_end_date" name="customeractivities[{{ $index }}][prom_date]" type="date"
                    value="{{ $activitiess->prom_date }}" placeholder="..." style="width: 100%;">
                </div>
                <div class="col-lg-6">
                  Notes <br> <textarea id="w3review14" class="form-control" name="customeractivities[{{ $index }}][promotional_notes]" oninput="trimSpaces14()"
                    onclick="moveCursorToStart14()" rows="2" cols="38">{{ $activitiess->promotional_notes }}
                  </textarea>
                </div>
                <div class="col-lg-6 mb-3">
                  Attachments <br> <input class="form-control" type="file" name="customeractivities[{{ $index }}][promotional_attach]"
                    value="{{ $activitiess->promotional_attach }}" placeholder="..." style="width: 100%;">
                  <div class="col-lg-5 spacing-right">
                    <div class="image-preview42" id="imagePreview42">
                      @if($activitiess->promotional_attach)
                      <img src="{{ asset($activitiess->promotional_attach) }}" alt="Image Preview42" class="image-preview__image42"
                        style="height: 100%; width:100%; margin-left:-13px;">
                      @else
                      <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                      @endif
        ...
        <div class="row">
          ...
          <div class="col-lg-10 spacing-left my-5"> <button type="submit" class="btn btn-primary float-end">Save </button></div>
        </div>
      </div>
    </div>
    <!--Notes Tab-->
    <div class="tab-pane fade  m-3" style="opacity: 90%;" id="notes-details" role="tabpanel" aria-labelledby="nav-notes-tab">
      <div class="row">
        <div class="col-lg-6 spacing-right">
          <div class="row mb-2">
            <div class="form-type col-lg-6 spacing-right">
              Notes <br> <textarea class="form-control" type="text" id="" name="" placeholder="" style="width: 100%;"></textarea>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="tab-pane fade m-3" style="opacity: 90%;" id="verifications" role="tabpanel" aria-labelledby="nav-contact-tab">
        ...
        <div id="feedbackAccordion">
          ...
          <div class="accordion-item" id="feedbackEntry{{ $index + 1 }}">
            <h2 class="accordion-header" id="feedbackHeading{{ $index + 1 }}">
              <button class="accordion-button" type="button" data-toggle="collapse" data-target="#feedbackCollapse{{ $index + 1 }}" aria-expanded="false"
                aria-controls="feedbackCollapse{{ $index + 1 }}">
                Feedback {{ $index + 1 }} Date: {{ $feedbacks->feed_date ?? now()->toDateString() }}

              </button>
            </h2>
            <div id="feedbackCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="feedbackHeading{{ $index + 1 }}">
              <div class="accordion-body">
                ...
                <div id="feedbackForm">
                  <div class="row">
                    <div class="col-lg-7">
                      <div class="row mb-2">
                        <div class="col-lg-11 spacing-right">
                          Client Name: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_client_name]"
                            value="{{ $feedbacks->feed_client_name }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-right">
                          Client POC Name: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_client_poc_name]"
                            value="{{ $feedbacks->feed_client_poc_name }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-right">
                          Email: <br> <input class="form-control vldemail" name="customerfeedbacks[{{ $index }}][feed_client_email]"
                            value="{{ $feedbacks->feed_client_email }}" type="email" placeholder="..." style="width: 100%;">
                          <div id="emailError" class="emailError" style="color: red"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="row mb-2">
                        <div class="col-lg-6 spacing-left spacing-right">
                          Client ID: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_client_id]"
                            value="{{ $feedbacks->feed_client_id }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-5 spacing-right">
                          Site ID: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_client_site_id]"
                            value="{{ $feedbacks->feed_client_site_id }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                      </div>
                      <div class="row mb-5">
                        <div class="col-lg-11 spacing-left spacing-right">
                          Designation: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_desig]" value="{{ $feedbacks->feed_desig }}"
                            type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-left spacing-right">
                          Cell: <br> <input class="form-control vldphone" type="text" name="customerfeedbacks[{{ $index }}][feed_cell]"
                      ...
                      <table class="table table-bordered" id="feedbackTable">
                        <thead>
                          <div class="row mb-5">
                            <div class="col-lg-4 spacing-left spacing-right">
                              ...
                              <input class="form-control" type="date" name="customerfeedbacks[{{ $index }}][feed_date]" value="{{ $feedbacks->feed_date }}"
                                placeholder="..." style="width: 100%;" />
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right">
                              <label class="form-lable">Feedback for the month:</label>
                              <input class="form-control" type="text" name="customerfeedbacks[{{ $index }}][feed_month]" value="{{ $feedbacks->feed_month }}"
                                placeholder="..." style="width: 100%;" />
                            </div>
                          </div>
                          <tr width="100%">
                            ...
                            <th width="5%">
                              <img src="{{asset('emogi/smili.png')}}" width="30px" height="30px" alt="Entirely Satisfied">
                              <!--Entirely Satisfied-->
                            </th>
                            <th width="5%">
                              <img src="{{asset('emogi/facemode.png')}}" width="30px" height="30px" alt="Satisfied">
                              <!--Satisfied-->
                            </th>
                            <th width="5%">
                            ...
                            <th width="5%">
                              <img src="{{asset('emogi/crying.png')}}" width="30px" height="30px" alt="Unsatisfied">
                              <!--Unsatisfied-->
                            </th>
                            <th width="5%">
                              <img src="{{asset('emogi/angry.png')}}" width="30px" height="30px" alt=" Entirely Unsatisfied">
                        ...
                        <tbody>
                          ...
                          <tr width="100%">
                            ...
                            <td width="5%"><input type="radio" name="q10[]" {{ $feedbacks->q10 == '0' ? 'checked' : '' }} value="5"></td>
                          </tr>
                        </tbody>
                      </table>
                      <div class="col-lg-4 spacing-right mb-3">
                        Total Score: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][total_score]" value="{{ $feedbacks->total_score}}"
                          id="totalScore" type="text" placeholder="..." style="width: 100%;">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-7">
                      <div class="row mb-2">
                        <div class="col-lg-11 spacing-right">
                          Company Name: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_company_name]"
                            value="{{ $feedbacks->feed_company_name }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-right">
                          POC Name: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_poc_name]"
                            value="{{ $feedbacks->feed_poc_name }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-right">
                          Suggestions / Comments:<br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_comment]"
                            value="{{ $feedbacks->feed_comment }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-right">
                          Feedback Form Filled By:<br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feedback_form]"
                            value="{{ $feedbacks->feedback_form }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="row mb-2">
                        <div class="col-lg-11 spacing-left spacing-right">
                          Email: <br> <input class="form-control vldemail" type="text" name="customerfeedbacks[{{ $index }}][feed_email]"
                            value="{{ $feedbacks->feed_email }}" placeholder="..." style="width: 100%;">
                          <div id="emailError" class="emailError" style="color: red"></div>
                        </div>
                        <div class="col-lg-11 spacing-left spacing-right">
                          Telephone: <br> <input class="form-control" type="text" name="customerfeedbacks[{{ $index }}][feed_telephone]"
                            value="{{ $feedbacks->feed_telephone }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-11 spacing-left spacing-right">
                          Signature & Date: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_signature]"
                            value="{{ $feedbacks->feed_signature }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-11 spacing-right">
                      Feedback Form Received By: <br> <input class="form-control" name="customerfeedbacks[{{ $index }}][feed_received]"
                        value="{{ $feedbacks->feed_received }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-11 spacing-right">
                      Remarks: <br> <input class="form-control" type="text" name="customerfeedbacks[{{ $index }}][feed_remarks]"
                        value="{{ $feedbacks->feed_remarks }}" placeholder="..." style="width: 100%;">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-11 spacing-right">
                      Attachments: <br> <input id="" class="form-control" name="customerfeedbacks[{{ $index }}][feed_attach]"
          ...
          <div class=" mt-2 d-flex justify-content-between align-items-center">
            <button type="button" class="add-more-btn" style="width:30%" onclick="feedback_add_more()">Add More</button>
        ...
        <div id="complaintAccordion">
          ...
          <div class="accordion-item" id="complaintEntry{{ $index + 1 }}">
            <h2 class="accordion-header" id="complaintHeading{{ $index + 1 }}">
              <button class="accordion-button" type="button" data-toggle="collapse" data-target="#complaintCollapse{{ $index + 1 }}" aria-expanded="false"
                aria-controls="complaintCollapse{{ $index + 1 }}">
                Complaint Entry {{ $index + 1 }} Date: {{ $complaints->complain_month ?? now()->toDateString() }}
              </button>
            </h2>
            <div id="complaintCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="complaintHeading{{ $index + 1 }}">
              <div class="accordion-body">
                <input type="hidden" name="customercomplaints[{{ $index }}][com_id]" value="{{ $complaints->id }}">
                <div class="col-lg-12">
                  <div class="row mb-2">
                    <div class="col-lg-4 spacing-left spacing-right">
                      Complaint Number <br> <input class="form-control" name="customercomplaints[{{ $index }}][complaint_no]"
                        value="{{ $complaints->complaint_no }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div>
                      <h5 class="mt-3" id="headingText" style="display: inline-block;">
                        {{ $duty->heading_title ?? 'Guards Duty' }}
                        <button class="btn btn-link" type="button" data-bs-toggle="modal" data-bs-target="#editHeadingModal" style="vertical-align: middle;">
                          <i class="bi bi-pencil" style="font-size: 1.2rem; position: relative; right: 10px;"></i>
                        </button>
                      </h5>
                    </div>
                    <div class="col-lg-5 spacing-left spacing-right form-group">
                      Guards Duty <br>
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customercomplaints[{{ $index }}][complaint_guards_duty]"
                          value="{{ $complaints->complaint_guards_duty }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($duties as $duty)
                          <option value="{{  $duty->duty_name }}" @if( $duty->duty_name == $complaints->complaint_guards_duty) selected
                            @endif>{{ $duty->duty_name }}</option>
                          @endforeach
                        </select>
                        <div class="input-group-append" style="width: 30%;">
                          <a href="{{ route('duties') }}">
                    ...
                    <div class="col-lg-5 spacing-left" style="margin-left: 12px">
                      Complain Of Month <br> <input type="date" id="w3complaint15" class="form-control" name="customercomplaints[{{ $index }}][complain_month]">

                    </div>
                    <div class="col-lg-5 spacing-left" style="margin-left: 12px">
                      Notes <br> <textarea id="w3review15" class="form-control" name="customercomplaints[{{ $index }}][complaint_gaurd_note]"
                        oninput="trimSpaces15()" onclick="moveCursorToStart15()" rows="2" cols="40">{{ $complaints->complaint_gaurd_note }}
                      </textarea>
                    </div>
                    <div class="col-lg-3 spacing-left spacing-right">
                      Attachments <br> <input class="form-control" name="customercomplaints[{{ $index }}][complaint_guard_attach]" type="file"
                        value="{{ $complaints->complaint_guard_attach }}" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                          @if($complaints->complaint_guard_attach)
                          <img src="{{ asset($complaints->complaint_guard_attach) }}" alt="Image Preview42" class="image-preview__image42"
                            style="height: 100%; width:100%; margin-left:-13px;">
                          @else
                          <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                          @endif
                  ...
                  <div class="row mb-2">
                    <div>
                      <h5 class="mt-3" id="=headingequipment" style="display: inline-block;">
                        ...
                        <button class="btn btn-link" type="button" data-bs-toggle="modal" data-bs-target="#editHeadingEquipmentModal"
                    ...
                    <div class="col-lg-5 spacing-left spacing-right form-group">
                      ...
                      <br>
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customercomplaints[{{ $index }}][wea_uni_equip]"
                          value="{{ $complaints->wea_uni_equip }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($equipments as $equipment)
                          <option value="{{ $equipment->equipment_name }}" @if($equipment->equipment_name == $complaints->wea_uni_equip) selected
                            @endif>{{ $equipment->equipment_name }}</option>
                          @endforeach
                        </select>
                        <div class="input-group-append" style="width: 30%;">
                    ...
                    <div class="col-lg-5 spacing-left" style="margin-left: 12px">
                      Notes <br> <textarea id="w3review16" oninput="trimSpaces16()" onclick="moveCursorToStart16()" class="form-control"
                        name="customercomplaints[{{ $index }}][wue_note]" rows="2" cols="40">{{ $complaints->wue_note }}
                      </textarea>
                    </div>
                    <div class="col-lg-3 spacing-left spacing-right">
                      Attachments <br> <input class="form-control" name="customercomplaints[{{ $index }}][wue_attach]" value="{{ $complaints->wue_attach }}"
                        type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                  ...
                  <div class="row mb-2">
                    <div>
                      <h5 class="mt-3" id="headingfinance" style="display: inline-block">
                        ...
                        <button class="btn btn-link" type="button" data-bs-toggle="modal" data-bs-target="#editHeadingFinanceModal"
                          style="vertical-align: middle"><i class="bi bi-pencil" style="font-size: 1.2rem; position: relative; right: 10px;"></i></button>
                      </h5>
                    </div>
                    <div class="col-lg-5 spacing-left spacing-right form-group">
                      ...
                      <br>
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customercomplaints[{{ $index }}][finance_dept]"
                          value="{{ $complaints->finance_dept }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($finances as $finance)
                          <option value="{{  $finance->finance_name }}" @if( $finance->finance_name == $complaints->finance_dept) selected
                            @endif>{{ $finance->finance_name }}</option>
                          @endforeach
                        </select>
                        <div class="input-group-append" style="width: 30%;">
                    ...
                    <div class="col-lg-5 spacing-left" style="margin-left: 12px">
                      Notes <br> <textarea id="w3review17" class="form-control" name="customercomplaints[{{ $index }}][fd_note]" oninput="trimSpaces17()"
                        onclick="moveCursorToStart17()" rows="2" cols="40">{{ $complaints->fd_note }}
                      </textarea>
                    </div>
                    <div class="col-lg-3 spacing-left spacing-right">
                      Attachments <br> <input class="form-control" name="customercomplaints[{{ $index }}][fd_attach]" value="{{ $complaints->fd_attach }}"
                        type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                ...
                <div class="col-lg-12">
                  <div class="row mb-2">
                    ...
                    <div class="col-lg-5 spacing-left spacing-right form-group">
                      ...
                      <br>
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customercomplaints[{{ $index }}][src_complaint]"
                          value="{{ $complaints->src_complaint }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($sources as $source)
                          <option value="{{ $source->source_name }}" @if($source->source_name == $complaints->src_complaint) selected
                            @endif>{{ $source->source_name }}</option>
                          @endforeach
                        </select>
                        <div class="input-group-append" style="width: 30%;">
                    ...
                    <div class="col-lg-5 spacing-left" style="margin-left: 12px">
                      Notes <br> <textarea id="w3review" class="form-control" name="customercomplaints[{{ $index }}][src_note]" rows="2"
                        cols="40">{{ $complaints->src_note }}
                      </textarea>
                    </div>
                    <div class="col-lg-3 spacing-left spacing-right">
                      Attachments <br> <input class="form-control" name="customercomplaints[{{ $index }}][src_attach]" value="{{ $complaints->src_attach }}"
                        type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                ...
                <div class="col-lg-12">
                  <div class="row mb-2">
                    ...
                    <div class="col-lg-3 spacing-right">
                      ...
                      <input class="form-control" name="customercomplaints[{{ $index }}][mng_feed]" value="{{ $complaints->mng_feed }}" type="text"
                        placeholder="..." style="width: 100%; margin-top: -7px;">
                    </div>
                    <div class="col-lg-3 spacing-left spacing-right">
                      Attachments <br> <input class="form-control" id="printing_date" name="customercomplaints[{{ $index }}][mng_attach]"
                        value="{{ $complaints->mng_attach }}" type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                    ...
                    <div class="col-lg-3 spacing-left" style="margin-left: 12px">
                      Notes <br> <textarea id="w3review18" class="form-control" name="customercomplaints[{{ $index }}][mng_note]" oninput="trimSpaces18()"
                ...
                <div class="col-lg-12">
                  <div class="row mb-2">
                    ...
                    <div class="col-lg-4 spacing-right">
                      Name <br> <input class="form-control" name="customercomplaints[{{ $index }}][complaint_poc_name]"
                        value="{{ $complaints->complaint_poc_name }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Designation <br> <input class="form-control" name="customercomplaints[{{ $index }}][complaint_poc_desig]"
                        value="{{ $complaints->complaint_poc_desig }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Department <br> <input class="form-control" name="customercomplaints[{{ $index }}][complaint_poc_dept]"
                        value="{{ $complaints->complaint_poc_dept }}" type="text" placeholder="..." style="width: 100%;">
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Email<br> <input class="form-control vldemail" name="customercomplaints[{{ $index }}][complaint_poc_email]"
                        value="{{ $complaints->complaint_poc_email }}" type="text" placeholder="..." style="width: 100%;">
                      <div id="emailError" class="emailError" style="color: red"></div>
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Contact Number<br> <input class="form-control vldphone" name="customercomplaints[{{ $index }}][complaint_poc_contact]"
                        value="{{ $complaints->complaint_poc_contact }}" type="text" placeholder="..." style="width: 100%;">
                      <div id="phoneError" class="phoneError" style="color: red"></div>
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Picture of Complaint <br> <input class="form-control" name="customercomplaints[{{ $index }}][complaint_picture]"
                        value="{{ $complaints->complaint_picture }}" type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                          @if($complaints->complaint_picture)
                          <img src="{{ asset($complaints->complaint_picture) }}" alt="Image Preview42" class="image-preview__image42"
                            style="height: 100%; width:100%; margin-left:-13px;">
                          @else
                          <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                          @endif
                    ...
                    <div class="col-lg-4 spacing-right">
                      Details of Complaint <br> <textarea class="form-control" name="customercomplaints[{{ $index }}][details_complaint]" type="text"
                        placeholder="..." style="width: 100%;">{{ $complaints->details_complaint }}</textarea>
                    </div>
                    <div class="col-lg-4 spacing-right">
                      Details Attachment<br> <input class="form-control" name="customercomplaints[{{ $index }}][details_attach]"
                        value="{{ $complaints->details_attach }}" type="file" placeholder="..." style="width: 100%;">
                      <div class="col-lg-5 spacing-right">
                        <div class="image-preview42" id="imagePreview42">
                          @if($complaints->details_attach)
                          <img src="{{ asset($complaints->details_attach) }}" alt="Image Preview42" class="image-preview__image42"
                            style="height: 100%; width:100%; margin-left:-13px;">
                          @else
                          <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                          @endif
                    ...
                    <div class="col-lg-5 spacing-left spacing-right form-group">
                      ...
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customercomplaints[{{ $index }}][complaint_tagged]"
                          value="{{ $complaints->complaint_tagged }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($complaintsto as $complaintto)
                          <option value="{{ $complaintto->tagged_to_name }}" @if($complaintto->tagged_to_name == $complaints->complaint_tagged) selected
                            @endif>{{ $complaintto->tagged_to_name }}</option>
                          @endforeach
                        </select>
                        <div class="input-group-append" style="width: 30%;">
                    ...
                    <div class="col-lg-5 spacing-left spacing-right form-group">
                      ...
                      <div class="input-group" style="width: 100%;">
                        <select id="dropdown" class="form-control mt-1" name="customercomplaints[{{ $index }}][complaint_arressed]"
                          value="{{ $complaints->complaint_arressed }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                          <option value=""></option>
                          @foreach ($complaintsby as $complaintby)
                          <option value="{{ $complaintby->addressed_by_name }}" @if($complaintby->addressed_by_name == $complaints->complaint_arressed) selected
                ...
                <div class="row mb-2">
                  <div class="col-lg-6 spacing-left spacing-right mt-2">
                    Attachements <br> <input class="form-control" type="file" name="customercomplaints[{{ $index }}][complaint_addressed_attach]"
                      value="{{ $complaints->complaint_addressed_attach }}" placeholder="..." style="width: 70%;" multiple>
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($complaints->complaint_addressed_attach)
                        <img src="{{ asset($complaints->complaint_addressed_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
                  ...
                  <div class="col-lg-6 spacing-left spacing-right my-3">
                    Notes <br>
                    <textarea id="w3review19" class="form-control" oninput="trimSpaces19()" onclick="moveCursorToStart19()"
      ...
      <div>
        <div id="notificationsAccordion">
          ...
          <div class="accordion-item" id="notificationEntry{{ $index + 1 }}">
            <h2 class="accordion-header" id="notificationHeading{{ $index + 1 }}">
              <button class="accordion-button" type="button" data-toggle="collapse" data-target="#notificationCollapse{{ $index + 1 }}" aria-expanded="false"
                aria-controls="notificationCollapse{{ $index + 1 }}">
                Notification {{ $index + 1 }} Date: {{ $notificationss->notification_of_month?? now()->toDateString() }}
              </button>
            </h2>
            <div id="notificationCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="notificationHeading{{ $index + 1 }}">
              <div class="accordion-body">
                <input type="hidden" name="customernotifications[{{ $index }}][n_id]" value="{{ $notificationss->id }}">
                <div class="row mb-2">
                  <input type="hidden" name="customernotifications[{{ $index }}][n_id]" value="{{ $notificationss->id }}">
                  <div class="col-lg-4 ">
                    Notification No. <br> <input class="form-control" type="text" name="customernotifications[{{ $index }}][notification_no]"
                  ...
                  <div class="col-lg-4  form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                      <select id="dropdown" class="form-control mt-1" name="customernotifications[{{ $index }}][notification_related]"
                        value="{{ $notificationss->notification_related }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                        <option value=""></option>
                        @foreach ($notifications as $notification)
                        <option value="{{ $notification->notification_name }}" @if($notification->notification_name == $notificationss->notification_related)
                          selected @endif>{{ $notification->notification_name }}</option>
                        @endforeach
                      </select>
                      <div class="input-group-append" style="width: 30%;">
                  ...
                  <div class="col-lg-4 form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                      <select id="dropdown" class="form-control mt-1" name="customernotifications[{{ $index }}][notification_shared]"
                        value="{{ $notificationss->notification_shared }}" style="width: 70%; border-radius: 4px 0 0 4px; ">
                        <option value=""></option>
                        @foreach ($notificationshared as $notificationshare)
                        <option value="{{ $notificationshare->notification_shared_name}}" @if($notificationshare->notification_shared_name ==
                          $notificationss->notification_shared) selected @endif>{{ $notificationshare->notification_shared_name }}</option>
                        @endforeach
                      </select>
                      <div class="input-group-append" style="width: 30%;">
                  ...
                  <div class="col-lg-4 ">
                    Attachment. <br> <input class="form-control" type="file" name="customernotifications[{{ $index }}][notification_attach]"
                      value="{{ $notificationss->notification_attach }}" placeholder="..." style="width: 100%;">
                    <div class="col-lg-5 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($notificationss->notification_attach)
                        <img src="{{ asset($notificationss->notification_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
                  ...
                  <div class="col-lg-4 ">
                    Attachements <br> <input class="form-control" type="file" name="customernotifications[{{ $index }}][notification_ex_attach]"
                      value="{{ $notificationss->notification_ex_attach }}" placeholder="..." multiple>
                    <div class="col-lg-6 spacing-right">
                      <div class="image-preview42" id="imagePreview42">
                        @if($notificationss->notification_ex_attach)
                        <img src="{{ asset($notificationss->notification_ex_attach) }}" alt="Image Preview42" class="image-preview__image42"
                          style="height: 100%; width:100%; margin-left:-13px;">
                        @else
                        <img src="{{asset('noimage.jpg')}}" alt="no image" width="70px" height="70px">
                        @endif
                  ...
                  <div class="col-lg-4 ">
                    Notification of Month <br> <input type="date" class="form-control" name="customernotifications[{{ $index }}][notification_of_month]"
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-lg-6 my-3">
                    Notes. <br> <textarea class="form-control" id="w3review20" type="text" oninput="trimSpaces20()" onclick="moveCursorToStart20()"
                      name="customernotifications[{{ $index }}][notification_note]" placeholder="..."
                      style="width: 100%;">{{ $notificationss->notification_note }}</textarea>
                  </div>
                  <div class="col-lg-6 my-3">
                    Notes <br>
                    <textarea id="w3review" class="form-control" name="customernotifications[{{ $index }}][notification_ex_note]" rows="2"
                      cols="38">{{ $notificationss->notification_ex_note }}
                    </textarea>
                  </div>
                </div>
                <hr>
        ...
        <div class=" mt-2 mb-2 d-flex justify-content-between align-items-center">
          <button style="width:30%" type="button" class="add-more-btn" onclick="notifications_add_more()">Add More</button>
          {{-- <button type="button" style="width:30%"  class="add-more-btn" >Save</button> --}}
        </div>
      </div>
    </div>
