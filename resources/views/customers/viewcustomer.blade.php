...
<div class="customer_form">
 ...
 <div id="mySidebar" class="sidebar admin-setting"> <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a> <a href="#"> <i
    class="bi bi-person-check-fill mr-2"></i> Update
 ...
 <div class="modal-header border-0">
  <div style="display:flex; column-gap:10px; align-items:center"> <button type="button" class="btn btn-link" onclick="history.back()"> <i
 ...
 @endphp <section> <button id="download-pdf">Download PDF</button> <button id="send-email">Send PDF via
   Email</button> <a href="https://web.whatsapp.com/send?text=Check%20out%20this%20link%3A%20" target="_blank"><button>Send via Whatsapp</button></a>
  <div id="emailModal" class="modal"
   ...
   <div class="modal-content"
    ...
    <label for="ccInput">CC Recipient:</label> <input type="email" id="ccInput" placeholder=" Enter CC Recipient"> <label for="bccInput">BCC Recipient:</label>
    <input type="email" id="bccInput" placeholder="Enter BCC Recipient"> <label for="subjectInput">Subject:</label> <input type="text" id="subjectInput"
     placeholder="Subject" autocomplete="off"> <label for="bodyInput">Body:</label>
    <textarea id="bodyInput" rows="8" placeholder="Body" autocomplete="off"></textarea> <button id="sendEmailBtn" class="mt-2"
     style="width: 20%; display: block; margin: 0 auto;">Send</button>
   </div>
  </div>
  <div id="hiddenBootstrapAlert" class="alert alert-danger alert-dismissible fade" role="alert" style="display: hidden;"> <span id="hiddenAlertContent"></span>
   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button> </div>
  <div id="hiddenRenewalAlert" class="alert alert-success alert-dismissible fade" role="alert"> <span id="hiddenRenewalAlertContent"></span> <button
  ...
  <div class="row mb-2" style="margin-left: 20px;">
   <div class="col d-flex flex-column align-items-end" style="margin-right: 53px;">
    <div>
     ...
     <div class="form-check form-check-inline" style="margin-right: 90px;"> <input class="form-check-input mr-2" type="radio" name="customers_activation_check"
       {{ $customers->customers_activation_check == '1' ? 'checked' : '' }} value="1" id="activeRadio"> <label class="form-check-label"
       for="activeRadio">Active</label> <input class="form-check-input ml-3 mr-2" type="radio" name="customers_activation_check"
       {{ $customers->customers_activation_check == '0' ? 'checked' : '' }} value="0" id="inactiveRadio"> <label class="form-check-label"
       for="inactiveRadio">Inactive</label>
     </div>
     <div class="col-12">
      <div> <label class="form-label" for="entryofdate">Date Of Entry</label> <input class="form-control" type="date" name="date_of_entry"
   ...
   <div class="row" style="font-weight:600;">
    ...
    <div class="col-lg-6 spacing-right">
     <div class="row mb-2 mt-3">
      <div class="col-lg-5 spacing-right"> Customer ID <br> <input class="form-control" readonly id="c_id" name="customers_id"
        value="{{ $customers->customers_id }}" type="text" placeholder="..." style="width: 100%;" readonly> </div>
      <div class="col-lg-6 spacing-left"> Customer Legal Name (As per NTN) <br> <input class="form-control" readonly id="customers_name" type="text"
        name="customers_name" value="{{ $customers->customers_name }}" placeholder="" style="width: 100%;"> </div>
     </div>
     <div class="row mb-2 mt-3">
      <div class="col-lg-5 spacing-right"> Suffix <br> <input class="form-control" readonly id="customers_suffix" name="customers_suffix"
        value="{{ $customers->customers_suffix }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-left input-group"> City of Deployment <br> <input class="form-control" readonly id="city_of_deployment" type="text"
        name="city_of_deployment" value="{{ $customers->city_of_deployment }}" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2 mt-3">
      <div class="col-lg-10 spacing-right"> Display Name as <br> <input class="form-control" readonly id="d_name" name="display_name_as"
        value="{{ $customers->display_name_as }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
    <div class="col-lg-6 spacing-left">
     <div class="row mb-2 mt-3">
      <div class="col-lg-5 spacing-right"> Nature of Business <br> <input class="form-control" readonly id="nature" value="{{ $customers->nature_of_business }}"
        name="nature_of_business" type="text" placeholder="..." style="width: 100%;">
      </div>
      <div class="col-lg-6 spacing-left"> Website <br> <input class="form-control" readonly type="text" id="web" value="{{ $customers->website }}"
        name="website" placeholder="" style="width: 100%;"> </div>
     </div>
     <div class="row mb-2 mt-3">
      <div class="col-lg-5 spacing-right"> Phone/Cell No <br> <input class="form-control" readonly type="text" id="phone" value="{{ $customers->phone }}"
        name="phone" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-left input-group"> Email <br> <input class="form-control" name="email" id="email" type="email"
        value="{{ $customers->email }}" placeholder="..." style="width: 100%;"> </div>
    ...
    <div class="col-lg-11 spacing-right">
     <div class="form-group form-check"> Sub Customer <br> <input class="form-control vldemail" name="sub_customer" id="" type="text"
       value="{{ $customers->sub_customer }}" placeholder="..." style="width: 100%;"> </div>
    </div>
   </div>
</div>
</div>
<div class="col-lg-6">
 ...
 <div class="row mb-2 mt-3" style="margin-left:20px;">
  <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="approved_com" type="checkbox"
    {{ $customers->approved_com ? 'checked' : '' }} id="approved_commercials"> <label class="form-check-label" for="inlineCheckbox1">Approved
    Commercials</label> </div>
 </div>
 <div class="row mb-2 mt-5" style="margin-left:20px;">
  <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" type="checkbox" {{ $customers->quick_box ? 'checked' : '' }}
    name="quick_box" id="quick_box"> <label class="form-check-label" for="inlineCheckbox1">QuickBooks</label> </div>
 </div>
 <div class="row d-flex flex-row align-items-center justify-content-center mt-5 mb-3">
  <div class="col-4">
   <div class="row" style="margin-left:10px;">
    <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="eobi" type="checkbox" {{ $customers->eobi ? 'checked' : '' }}
      id="eobi"> <label class="form-check-label" for="inlineCheckbox1">EOBI</label> </div>
   </div>
  </div>
  <div class="col-4">
   <div class="row" style="margin-left:10px;">
    <div class="form-check form-check-inline spacing-left "> <input class="form-check-input" name="social_security" type="checkbox"
      {{ $customers->social_security ? 'checked' : '' }} id="social_security">
  ...
  <div class="col-4">
   <div class="row" style="margin-left:10px;">
    <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="grp_life_ins" type="checkbox"
      {{ $customers->grp_life_ins ? 'checked' : '' }} id="grp_life_ins"> <label class="form-check-label" for="inlineCheckbox1">Group Life Insurance</label>
    </div>
   </div>
  </div>
 </div>
...
<div class="col-lg-6">
 <div class="row mb-2 mt-3">
  <div class="col-lg-12 "> Approved Commercial Attachments <br> <input class="form-control" readonly name="approved_attach"
    value="{{ $customers->approved_attach }}" type="file" style="width: 100%;">
   @if ($customers->approved_attach)
   <div class="col-lg-12 mt-3" style="display: flex; gap:3px">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->approved_attach) }}"
     data-extension="{{ pathinfo($customers->approved_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
     getFilePreview($customers->approved_attach) !!}

    </div>
    <!-- Delete Button -->
    <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'approved_attach']) }}"
 ...
 <div class="row mb-2 mt-3">
  <div class="col-lg-12 spacing-left"> QuickBooks Screenshot <br> <input class="form-control" readonly value="{{ $customers->quickbooks_attach }}"
    name="quickbooks_attach" type="file" style="width: 100%;">
   @if ($customers->quickbooks_attach)
   <div class="col-lg-12 mt-3" style="position: relative; display: flex; gap:3px">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->quickbooks_attach) }}"
     data-extension="{{ pathinfo($customers->quickbooks_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
     getFilePreview($customers->quickbooks_attach) !!} </div>
    <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'quickbooks_attach']) }}"
     onclick="return confirm('Are you sure you want to delete this file?')">x</a>
   </div>
   @else
   <p class="text-center text-secondary">Attachment not found</p>
...
<div class="col-lg-4 spacing-right form-group"> Applicable Compliances <br> <input class="form-control" readonly id="c_id" name="applicable_compliances"
  value="{{ $customers->applicable_compliances }}" type="text" placeholder="..." style="width: 100%;"> </div>
</div>
<hr>
<!--Tabs forDetails-->
<!--    <nav>
...
<div class="tab-pane fade show active m-3" style="opacity: 90%;" id="work-experience" role="tabpanel" aria-labelledby="nav-contact-tab">
 <div class="row">
  ...
  <div class="row col-lg-12 mb-4">
   <div class="col-lg-3 spacing-right"> Summary of Approved Strength: <br> <input class="form-control" readonly value="{{ $customers->sum_apr }}" name="sum_apr"
     type="file" placeholder="..." style="width: 100%;">
    @if ($customers->sum_apr)
    <div class="col-lg-12 mt-3" style="display: flex; gap:3px">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->sum_apr) }}"
      data-extension="{{ pathinfo($customers->sum_apr, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->sum_apr) !!} </div>
     <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'sum_apr']) }}"
      onclick="return confirm('Are you sure you want to delete this file?')" class="deletestyle">x</a>
    </div>
    @else
    <p class="text-center text-secondary">Attachment not found</p>
    @endif
   ...
   <div class="col-lg-3 spacing-right">
    Accomodation Status: <br> <input class="form-control" readonly value="{{ $customers->acm_status }}" name="acm_status" type="text" placeholder="..."
     style="width: 100%;">
   </div>
   <div class="col-lg-3 spacing-right"> Meal Details: <br> <input class="form-control" readonly name="meal_detail" value="{{ $customers->meal_detail }}"
     type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-3  mt-2">
    <lable for="apr_kpi" class="form-check-label spacing-right">Any approved KPIs or SOW:: </label>
      <input class="form-control" readonly value="{{ $customers->apr_kpi }}" name="apr_kpi" id="apr_kpi" type="file"
     placeholder="..." >
    @if ($customers->apr_kpi)
    <div class="col-lg-12 mt-3" style="display: flex; gap:3px">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->apr_kpi) }}"
      data-extension="{{ pathinfo($customers->apr_kpi, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->apr_kpi) !!} </div>
     <!-- Delete Button -->
      <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'apr_kpi']) }}"
      onclick="return confirm('Are you sure you want to delete this file?')">x</a>
    </div>
    @else
    <p class="text-center text-secondary">Attachment not found</p>
  ...
  <div class="col-lg-6">
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Approved Quotation Vetted by Sales
       Department :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="approv_q_s" {{ $customers->approv_q_s ? 'checked' : '' }}
        type="checkbox" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="approv_q_s_attach" type="file"
      placeholder="..." style="width: 100%;">
     @if ($customers->approv_q_s_attach)
     <div class="col-lg-12 mt-2" style="position: relative; display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->approv_q_s_attach) }}"
       data-extension="{{ pathinfo($customers->approv_q_s_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->approv_q_s_attach) !!} </div>
      <!-- Delete Button -->
      <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'approv_q_s_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
     <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Approved Quotation Vetted by Contract
       Management Department :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" type="checkbox" {{ $customers->approv_q_c ? 'checked' : '' }}
        name="approv_q_c" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly id="printing_date" name="approv_q_c_attach"
      type="file" placeholder="..." style="width: 100%;">
     @if ($customers->approv_q_c_attach)
     <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->approv_q_c_attach) }}"
       data-extension="{{ pathinfo($customers->approv_q_c_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->approv_q_c_attach) !!} </div>
      <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'approv_q_c_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
     <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Approved Quotation Vetted by CFO
       :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" type="checkbox" {{ $customers->approv_q_cfo ? 'checked' : '' }}
        name="approv_q_cfo" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly id="printing_date" name="approv_q_cfo_attach"
      type="file" placeholder="..." style="width: 100%;">
     @if ($customers->approv_q_cfo_attach)
     <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->approv_q_cfo_attach) }}"
       data-extension="{{ pathinfo($customers->approv_q_cfo_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->approv_q_cfo_attach) !!} </div>
      <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'approv_q_cfo_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
     <p class="text-center text-secondary">Attachment not found</p>
    ...
    <div class="row mb-2 mt-4">
     <div class="col-lg-5 spacing-right"> Contract Execution Date: <br> <input class="form-control" readonly name="c_e_date" value="{{ $customers->c_e_date }}"
       type="date" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-right"> Contract end Date: <br> <input class="form-control" readonly name="c_end_date" value="{{ $customers->c_end_date }}"
       type="date" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-right"> Contract Renewal Date <br> <input class="form-control" readonly name="c_r_date" id="c_r_date"
       value="{{ $customers->c_r_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-right"> Renewal Reminder <br>
      {{-- <input class="form-control" readonly name="c_r_rem" id="c_r_rem" value="{{ $customers->c_r_rem }}" type="text" placeholder="..." style="width:
      100%;"> --}}
      <textarea id="c_r_rem" oninput="trimSpaces()" onclick="moveCursorToStart()" class="form-control" readonly name="c_r_rem" rows="2"
    ...
    <div class="row mb-2" id="signatoryDetailsContainer">
     ...
     <div class="col-lg-5 spacing-right"> Name <br> <input class="form-control" readonly name="customersignatories[{{ $index }}][sign_name]"
       value="{{ $signatories->sign_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-right"> Designation <br> <input class="form-control" readonly name="customersignatories[{{ $index }}][sign_desig]"
       value="{{ $signatories->sign_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-right"> Cell No <br> <input class="form-control" readonly type="text" name="customersignatories[{{ $index }}][sign_cell]"
       value="{{ $signatories->sign_cell }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-right"> Email <br> <input class="form-control" readonly type="text" name="customersignatories[{{ $index }}][sign_email]"
       value="{{ $signatories->sign_email }}" placeholder="..." style="width: 100%;"> </div>
  ...
  <div class="col-lg-5 spacing-left">
   <div class="row mb-2">
    <div class="col-lg-12 spacing-right"> Draft Contract and Signed Agreement Read by<br>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="sales_dept" {{ $customers->sales_dept ? 'checked' : '' }}
       type="checkbox" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1">Sales Dept.</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="cmd" {{ $customers->cmd ? 'checked' : '' }}
       type="checkbox" id="inlineCheckbox2" value=""> <label class="form-check-label" for="inlineCheckbox2">CMD</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="ops_dept" {{ $customers->ops_dept ? 'checked' : '' }}
       type="checkbox" id="inlineCheckbox2" value=""> <label class="form-check-label" for="inlineCheckbox2">Ops Dept.</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="finance_dept"
       {{ $customers->finance_dept ? 'checked' : '' }} type="checkbox" id="inlineCheckbox2" value=""> <label class="form-check-label"
       for="inlineCheckbox2">Finance Dept.</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="directors" {{ $customers->directors ? 'checked' : '' }}
       type="checkbox" id="inlineCheckbox2" value=""> <label class="form-check-label" for="inlineCheckbox2">Directors.</label> </div>
    </div>
   </div>
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Signed Service Contract Agreement
       Attached :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="signed_ser" {{ $customers->approved_com ? 'checked' : '' }}
        type="checkbox" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="signed_ser_attach"
      value="{{ $customers->signed_ser_attach }}" type="file" placeholder="..." style="width: 100%;">
     @if ($customers->signed_ser_attach)
     <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->signed_ser_attach) }}"
       data-extension="{{ pathinfo($customers->signed_ser_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->signed_ser_attach) !!} </div>
      <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'signed_ser_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
     <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Communication Instructions Attached
       :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="com_ins" {{ $customers->com_ins ? 'checked' : '' }}
        type="checkbox" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="com_ins_attach"
      value="{{ $customers->com_ins_attach }}" type="file" placeholder="..." style="width: 100%;">
     @if ($customers->com_ins_attach)
     <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->com_ins_attach) }}"
       data-extension="{{ pathinfo($customers->com_ins_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->com_ins_attach) !!} </div>
      <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'com_ins_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
   ...
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Testimonials (Reference Letters)
       Attached :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="testimonials"
        {{ $customers->testimonials ? 'checked' : '' }} type="checkbox" id="inlineCheckbox1" value=""> <label class="form-check-label"
        for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly value="{{ $customers->testimonials_attach }}"
      name="testimonials_attach" type="file" placeholder="..." style="width: 100%;">
     @if ($customers->testimonials_attach)
     <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->testimonials_attach) }}"
       data-extension="{{ pathinfo($customers->testimonials_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->testimonials_attach) !!} </div>
      <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'testimonials_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
     <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="row mb-2">
    <div class="col-lg-6 mt-2 spacing-right">
     <div class=" mb-2 d-flex align-items-center"> <label for="Type Of Training:" class="form-check-label spacing-right">Details of Sales Incentives :</label>
      <div class="form-check form-check-inline spacing-left"> <input class="form-check-input" name="sales_inc" {{ $customers->sales_inc ? 'checked' : '' }}
        type="checkbox" id="inlineCheckbox1" value=""> <label class="form-check-label" for="inlineCheckbox1"></label> </div>
     </div>
    </div>
    <div class="col-lg-5 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="sales_inc_attach"
      value="{{ $customers->sales_inc_attach }}" type="file" placeholder="..." style="width: 100%;">
     @if ($customers->sales_inc_attach)
     <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->sales_inc_attach) }}"
       data-extension="{{ pathinfo($customers->sales_inc_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       getFilePreview($customers->sales_inc_attach) !!} </div>
      <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'sales_inc_attach']) }}"
       onclick="return confirm('Are you sure you want to delete this file?')">x</a>
     </div>
     @else
     <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="form-check form-check-inline"> <input class="form-check-input" name="pay_order" id="compliances-na" type="checkbox" value=""> <label
     class="form-check-label" for="compliances-na">N/A.</label> </div>
   <div id="sectionToHide">
    <div class="row mb-2">
     <div class="col-lg-5 spacing-right"> Insurance Company Name <br> <input class="form-control" readonly value="{{ $customers->insc_name }}" name="insc_name"
       type="text" placeholder="..." style="width: 100%;">
     </div>
     <div class="col-lg-5 spacing-right"> Date of issue <br> <input class="form-control" readonly name="insc_date" value="{{ $customers->insc_date }}"
       type="date" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="col-lg-12 spacing-right mb-3"> Performance Guaranty issued via <br> <select id="staff_category" class="form-control" readonly
      value="{{ $customers->per_guan }}" name="per_guan" style="width: 100%;">
  ...
  <div class="row mb-2">
   <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly name="perfom_attach"
     value="{{ $customers->perfom_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
    @if ($customers->perfom_attach)
    <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->perfom_attach) }}"
      data-extension="{{ pathinfo($customers->perfom_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
      getFilePreview($customers->perfom_attach) !!} </div>
     <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'perfom_attach']) }}"
      onclick="return confirm('Are you sure you want to delete this file?')">x</a>
    </div>
    @else
    <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
    <textarea id="w3review" oninput="trimSpaces()" onclick="moveCursorToStart()" class="form-control" readonly name="perform_note" rows="2"
 ...
 <div class="row">
  <div class="row mt-3" style="font-weight:600;">
   <div class="col-lg-6 spacing-right mb-3"> Payment Terms <br> <select class="form-control" readonly name="pay_terms" value="{{ $customers->pay_terms }}"
     style="width: 100%;">
     <option value="Cash">Cash</option>
     <option value="Cheque">Cheque</option>
    </select>
  </div>
    <div class="form-type col-lg-6 spacing-right"> NTN from FBR Site <br> <input class="form-control" readonly type="file" name="ntn_fbr"
    value="{{ $customers->ntn_fbr }}" placeholder="..." style="width: 100%;">
   @if ($customers->ntn_fbr)
   <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->ntn_fbr) }}"
     data-extension="{{ pathinfo($customers->ntn_fbr, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->ntn_fbr) !!} </div>
    <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'ntn_fbr']) }}"
     onclick="return confirm('Are you sure you want to delete this file?')">x</a>
   </div>
   @else
   <p class="text-center text-secondary">Attachment not found</p>
  ...
  <div class="row">
   <div class=" row main-content div">
    <div class="col-lg-6">
     <div class="row mb-2">
      <div class="col-lg-6 spacing-right"> POC Name <br> <input class="form-control" readonly id="" value="{{ $customers->poc_name }}" name="poc_name"
        type="text" placeholder="..." style="width: 100%;">
      </div>
      <div class="col-lg-5 spacing-left spacing-right"> Designation <br> <input class="form-control" readonly id="head_office_email" name="poc_desig"
        value="{{ $customers->poc_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-right"> Cell Number <br> <input class="form-control" readonly id="" name="poc_cell" value="{{ $customers->poc_cell }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left spacing-right"> Email <br> <input class="form-control" readonly id="head_office_email" name="poc_email"
        value="{{ $customers->poc_email }}" type="email" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-right"> Billing Cycle Details <br> <input class="form-control" readonly id="" value="{{ $customers->poc_bill_c }}"
      ...
      <div class="col-lg-5 spacing-left spacing-right"> Billing Portal Details <br>
       <input class="form-control" readonly id="head_office_email" value="{{ $customers->poc_bill_d }}" name="poc_bill_d" type="text" placeholder="..."
        style="width: 100%;">
      </div>
      <div class="col-lg-6 spacing-right"> Billing Portal Link <br> <input class="form-control" readonly id="" value="{{ $customers->poc_bill_l }}"
    ...
    <div class="col-lg-6 spacing-left">
     <h5>Address</h5>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Office No <br> <input class="form-control" readonly id="" name="poc_office" value="{{ $customers->poc_office }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Floor <br> <input class="form-control" readonly id="head_office_cell_no" name="poc_floor"
        value="{{ $customers->poc_floor }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5"> Building <br> <input class="form-control" readonly id="" name="poc_building" value="{{ $customers->poc_building }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Block <br> <input class="form-control" readonly id="" name="poc_block" value="{{ $customers->poc_block }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Area <br> <input class="form-control" readonly id="" name="poc_area" value="{{ $customers->poc_area }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> City <br> <input class="form-control" readonly id="" name="poc_city" value="{{ $customers->poc_city }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Photograph of Location <br> <input class="form-control" readonly id="" name="poc_photo"
        value="{{ $customers->poc_photo }}" type="file" placeholder="..." style="width: 100%;">
       @if ($customers->poc_photo)
       <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->poc_photo) }}"
         data-extension="{{ pathinfo($customers->poc_photo, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->poc_photo) !!}
        </div>
        <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'poc_photo']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')">x</a>
       </div>
       @else
       <p class="text-center text-secondary">Attachment not found</p>
     ...
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Pin location <br> <input class="form-control" readonly id="" name="poc_pin" value="{{ $customers->poc_pin }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
       <textarea id="w3review1" oninput="trimSpaces1()" onclick="moveCursorToStart1()" class="form-control" readonly name="poc_note" rows="2"
        cols="38">{{ $customers->poc_note }} </textarea>
      </div>
      <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly name="poc_attach"
        value="{{ $customers->poc_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
       @if ($customers->poc_attach)
       <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->poc_attach) }}"
         data-extension="{{ pathinfo($customers->poc_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->poc_attach)
         !!} </div>
        <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'poc_attach']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')">x</a>
       </div>
       @else
       <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class=" row main-content div">
    ...
    <div class="col-lg-6">
     <div class="row mb-2">
      <div class="col-lg-6 spacing-right"> Name <br> <input class="form-control" readonly id="" name="cf_name" value="{{ $customers->cf_name }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left spacing-right"> Designation <br> <input class="form-control" readonly id="head_office_email" name="cf_desig"
        value="{{ $customers->cf_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-right"> Cell Number <br> <input class="form-control" readonly id="" name="cf_no" value="{{ $customers->cf_no }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-right"> Email <br> <input class="form-control" readonly id="head_office_name" name="cf_email"
        value="{{ $customers->cf_email }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
    <div class="col-lg-6 spacing-left">
     <h5>Address</h5>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Office No <br> <input class="form-control" readonly id="" name="cf_office" value="{{ $customers->cf_office }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Floor <br> <input class="form-control" readonly id="head_office_cell_no" name="cf_floor"
        value="{{ $customers->cf_floor }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Building <br> <input class="form-control" readonly id="" name="cf_building" value="{{ $customers->cf_building }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Block <br> <input class="form-control" readonly id="" name="cf_block" value="{{ $customers->cf_block }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Area <br> <input class="form-control" readonly id="" name="cf_area" value="{{ $customers->cf_area }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> City <br> <input class="form-control" readonly id="" name="cf_city" value="{{ $customers->cf_city }}" type="text"
        placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Photograph of Location <br> <input class="form-control" readonly id="" name="cf_photo"
        value="{{ $customers->cf_photo }}" type="file" placeholder="..." style="width: 100%;">
       @if ($customers->cf_photo)
       <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->cf_photo) }}"
         data-extension="{{ pathinfo($customers->cf_photo, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->cf_photo) !!}
        </div>
        <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'cf_photo']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')">x</a>
       </div>
       @else
       <p class="text-center text-secondary">Attachment not found</p>
     ...
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Pin Location <br> <input class="form-control" readonly id="" name="cf_pin" value="{{ $customers->cf_pin }}"
        type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
       <textarea id="w3review2" class="form-control" readonly name="cf_note" oninput="trimSpaces2()" onclick="moveCursorToStart2()" rows="2"
        cols="38">{{ $customers->cf_note }} </textarea>
      </div>
      <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly name="cf_attach"
        value="{{ $customers->cf_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
       @if ($customers->cf_attach)
       <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->cf_attach) }}"
         data-extension="{{ pathinfo($customers->cf_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($customers->cf_attach) !!}
        </div>
        <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'cf_attach']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')">x</a>
       </div>
       @else
       <p class="text-center text-secondary">Attachment not found</p>
  ...
  <div class="row mb-2">
   <div class="col-lg-5 spacing-left spacing-right form-group"> List Of Currency <br>
    <div class="input-group" style="width: 100%;"> <input class="form-control" readonly id="" name="list_curr" value="{{ $customers->list_curr }}" type="text"
      placeholder="..." style="width: 100%;"> </div>
   </div>
   <div class="row mb-2">
    <div class="col-lg-12 spacing-right"> List Of Provinces<br>
     <div class="form-check form-check-inline"> <input class="form-check-input" name="fbr" type="checkbox" id="inlineCheckbox1"
       {{ $customers->fbr ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox1">FBR.</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="pra" type="checkbox" id="inlineCheckbox2"
       {{ $customers->pra ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox2">PRA</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="kpra" type="checkbox" id="inlineCheckbox2"
       {{ $customers->kpra ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox2">KPRA</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="srb" type="checkbox" id="inlineCheckbox2"
       {{ $customers->srb ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox2">SRB</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="bra" type="checkbox" id="inlineCheckbox2"
       {{ $customers->bra ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox2">BRA</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="ajk" type="checkbox" id="inlineCheckbox2"
       {{ $customers->ajk ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox2">AJK</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="gb" type="checkbox" id="inlineCheckbox2"
       {{ $customers->gb ? 'checked' : '' }}> <label class="form-check-label" for="inlineCheckbox2">GB</label> </div>
     <div class="form-check form-check-inline"> <input class="form-check-input" id="compliances" name="all" type="checkbox" id="inlineCheckbox2" value="">
      <label class="form-check-label" for="inlineCheckbox2">ALL</label> </div>
    </div>
   </div>
   <div class="col-lg-6 spacing-right"> Attachment <br> <input class="form-control" readonly id="" name="currency_attach"
     value="{{ $customers->currency_attach }}" type="file" placeholder="..." style="width: 100%;">
    @if ($customers->currency_attach)
    <div class="col-lg-12 mt-2" style="display: flex; gap:3px">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->currency_attach) }}"
      data-extension="{{ pathinfo($customers->currency_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
      getFilePreview($customers->currency_attach) !!} </div>
     <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'currency_attach']) }}"
      onclick="return confirm('Are you sure you want to delete this file?')">x</a>
    </div>
    @else
    <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="col-lg-6 spacing-right"> Notes <br>
    <textarea class="form-control" readonly id="w3review3" oninput="trimSpaces3()" onclick="moveCursorToStart3()" name="currency_note" type="text"
     placeholder="..." style="width: 100%;">{{ $customers->currency_note }}</textarea>
   </div>
  </div>
 </div>
 ...
 <div class=" row main-content div">
  <div class="col-lg-12">
   <div class="row mb-2">
    <div class="col-lg-3 spacing-right"> Category : <br> <input class="form-control" readonly id="" name="cat_name" value="{{ $customers->cat_name }}"
      type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-left spacing-right"> Salary of [Category] <br> <input class="form-control" readonly id="head_office_email"
      value="{{ $customers->sal_cat }}" name="sal_cat" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Salary for No. of days <br> <input class="form-control" readonly id="" value="{{ $customers->sal_days }}"
      name="sal_days" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Leaves Allowed <br> <input class="form-control" readonly id="" name="leaves_a" value="{{ $customers->leaves_a }}"
      type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Other Benefits <br> <input class="form-control" readonly id="" name="other_ben" value="{{ $customers->other_ben }}"
      type="text" placeholder="..." style="width: 100%;"> </div>
   </div>
  </div>
  <div class="row mb-2">
   <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly type="file" name="sal_attach"
     value="{{ $customers->sal_attach }}" placeholder="..." style="width: 70%;" multiple> </div>
   <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
    <textarea id="w3review4" oninput="trimSpaces4()" onclick="moveCursorToStart4()" class="form-control" readonly name="sal_note" rows="2"
...
<div class="tab-pane fade m-3" style="opacity: 90%;" id="education" role="tabpanel" aria-labelledby="nav-deployment-tab">
 <div class="row">
  ...
  <div class="row col-lg-12 manpower">
   <div class="col-lg-6 spacing-right">
    <div class="row mb-2">
     <div class="form-type col-lg-5 spacing-left"> Guard Post No <br> <input class="form-control" readonly type="text"
       name="customermanpowers[{{ $index }}][man_post]" value="{{ $manpowers->man_post }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left spacing-right form-group"> Category <br>
      <div class="input-group" style="width: 100%;"> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_cat]"
        value="{{ $manpowers->man_cat }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="col-lg-5 spacing-left spacing-right form-group"> Uniform Type <br>
      <div class="input-group" style="width: 100%;"> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_uni]"
        value="{{ $manpowers->man_uni }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="col-lg-5 spacing-left spacing-right form-group"> Uniform Number <br>
      <div class="input-group" style="width: 100%;"> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_uni_no]"
        value="{{ $manpowers->man_uni_no }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="col-lg-5 spacing-left spacing-right form-group"> Weapon Type <br>
      <div class="input-group" style="width: 100%;"> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_weapon]"
        value="{{ $manpowers->man_weapon }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="col-lg-5 spacing-left spacing-right form-group"> Ammunition Type <br>
      <div class="input-group" style="width: 100%;"> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_ammu]"
        value="{{ $manpowers->man_ammu }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="col-lg-5 spacing-left spacing-right form-group"> Equipment <br>
      <div class="input-group" style="width: 100%;"> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_equip]"
        value="{{ $manpowers->man_equip }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="form-type col-lg-5 spacing-right"> Picture of Equipment <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][man_equip_attach]" value="{{ $manpowers->man_equip_attach }}" type="file" placeholder="..." style="width: 100%;">
      @if ($customers->man_equip_attach)
      <div class="col-lg-5 mt-2" style="display: flex; gap:3px">
       <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->man_equip_attach) }}"
        data-extension="{{ pathinfo($customers->man_equip_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
        getFilePreview($customers->man_equip_attach) !!} </div>
       <!-- Delete Button --> <a class="deltebutton" href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'man_equip_attach']) }}"
        onclick="return confirm('Are you sure you want to delete this file?')">x</a>
      </div>
      @else
      <p class="text-center text-secondary">Attachment not found</p>
   ...
   <div class="col-lg-6 spacing-left">
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Shift Start date. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][s_start_date]" value="{{ $manpowers->s_start_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
     <div class="form-type col-lg-6 spacing-right"> Shift End date. <br> <input class="form-control" readonly name="customermanpowers[{{ $index }}][s_end_date]"
       value="{{ $manpowers->s_end_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Shift Start time. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][s_start_time]" value="{{ $manpowers->s_start_time }}" type="time" placeholder="..." style="width: 100%;"> </div>
     <div class="form-type col-lg-6 spacing-right"> Shift End time. <br> <input class="form-control" readonly name="customermanpowers[{{ $index }}][s_end_time]"
       value="{{ $manpowers->s_end_time }}" type="time" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Deployment Start date. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][man_start_date]" value="{{ $manpowers->man_start_date }}" type="date" placeholder="..." style="width: 100%;">
     </div>
     <div class="form-type col-lg-6 spacing-right"> Deployment End date. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][man_end_date]" value="{{ $manpowers->man_end_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Deployment Start time. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][man_start_time]" value="{{ $manpowers->man_start_time }}" type="time" placeholder="..." style="width: 100%;">
     </div>
     <div class="form-type col-lg-6 spacing-right"> Deployment End time. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][man_end_time]" value="{{ $manpowers->man_end_time }}" type="time" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Quantity. <br> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_quan]"
       value="{{ $manpowers->man_quan }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="form-type col-lg-6 spacing-right"> Duty Hours. <br> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_hours]"
       value="{{ $manpowers->man_hours }}" type="text" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Post Orders / JD of Guard Post.
      <br> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_jd]" value="{{ $manpowers->man_jd }}" type="text" placeholder="..."
       style="width: 100%;">
     </div>
     <div class="form-type col-lg-6 spacing-right"> Any Special Instructions. <br>
      <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_any_sp]" value="{{ $manpowers->man_any_sp }}" type="text" placeholder="..."
       style="width: 100%;">
     </div>
    </div>
    <div class="row mb-3">
     <div class="form-type col-lg-6 spacing-right"> Approved Leaves. <br> <input class="form-control" readonly name="customermanpowers[{{ $index }}][man_apr_l]"
       value="{{ $manpowers->man_apr_l }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="form-type col-lg-6 spacing-right"> Salary of total days. <br> <input class="form-control" readonly
       name="customermanpowers[{{ $index }}][man_salary]" value="{{ $manpowers->man_salary }}" type="text" placeholder="..." style="width: 100%;"> </div>
    </div>
   </div>
  </div>
  @endforeach
  ...
  <div class="row mb-3">
   <div class="form-type col-lg-6 spacing-right"> Name <br> <input class="form-control" readonly name="pat_name" value="{{ $customers->pat_name }}" type="text"
     placeholder="..." style="width: 100%;"> </div>
   <div class="form-type col-lg-6 spacing-right"> Model <br> <input class="form-control" readonly name="pat_model" value="{{ $customers->pat_model }}"
     type="text" placeholder="..." style="width: 100%;"> </div>
  </div>
  <div class="row mb-3">
   <div class="form-type col-lg-6 spacing-right"> Make <br> <input class="form-control" readonly name="pat_make" value="{{ $customers->pat_make }}" type="text"
     placeholder="..." style="width: 100%;"> </div>
   <div class="form-type col-lg-6 spacing-right"> Registration No. <br> <input class="form-control" readonly value="{{ $customers->pat_reg }}" name="pat_reg"
     type="text" placeholder="..." style="width: 100%;"> </div>
  </div>
  <div class="row mb-3">
   <div class="form-type col-lg-6 spacing-right"> Quantity. <br> <input class="form-control" readonly name="pat_quan" value="{{ $customers->pat_quan }}"
     type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="form-type col-lg-6 spacing-right"> Price Per Unit. <br> <input class="form-control" readonly name="pat_price" value="{{ $customers->pat_price }}"
     type="text" placeholder="..." style="width: 100%;"> </div>
  </div>
  <div class="row mb-3">
   <div class="form-type col-lg-6 spacing-right"> Total Value. <br> <input class="form-control" readonly name="pat_val" value="{{ $customers->pat_val }}"
     type="text" placeholder="..." style="width: 100%;"> </div>
  </div>
 </div>
   ...
   <div class="col-lg-6">
    <div class="row mb-2">
     <div class="col-lg-6 spacing-left spacing-right form-group"> Emergency Services
      <br> <input class="form-control" readonly name="customeremergencies[{{ $index }}][emer_ser]" value="{{ $emergencies->emer_ser }}" type="text"
       placeholder="..." style="width: 100%;">
     </div>
     <div class="col-lg-6 spacing-right"> Picture of Police Station <br> <input class="form-control" readonly name="customeremergencies[{{ $index }}][emer_pic]"
       value="{{ $emergencies->emer_pic }}" type="file" placeholder="..." style="width: 100%;">
      <div class="col-lg-5 spacing-right">
       <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($emergencies->emer_pic) }}"
        data-extension="{{ pathinfo($emergencies->emer_pic, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($emergencies->emer_pic)
        !!} </div>
       {{-- <div class="image-preview42" id="imagePreview42">
                                                            @if ($customers->emer_pic)
                                                            <img src="{{ asset($customers->emer_pic) }}" alt="Image Preview42" class="image-preview__image42"
       style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
      </div> --}}
     </div>
    </div>
    <h5>POC</h5>
    <div class="col-lg-6 spacing-right"> Name. <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_poc_name]"
      value="{{ $emergencies->emer_poc_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-6 spacing-right"> Designation. <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_poc_desig]"
      value="{{ $emergencies->emer_poc_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-6 spacing-right"> Cell Number. <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_poc_cell]"
      value="{{ $emergencies->emer_poc_cell }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-6 spacing-right"> Email. <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_poc_email]"
      value="{{ $emergencies->emer_poc_email }}" type="email" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-6 spacing-right"> Notes. <br>
     <textarea class="form-control" readonly id="w3review5" name="customeremergencies[{{ $index }}][emer_poc_notes]" type="notes" oninput="trimSpaces5()"
      onclick="moveCursorToStart5()" placeholder="..." style="width: 100%;">{{ $emergencies->emer_poc_notes }}</textarea>
    </div>
    <div class="col-lg-6 spacing-right"> Attachment <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_poc_attach]"
      value="{{ $emergencies->emer_poc_attach }}" type="file" placeholder="..." style="width: 100%;">
     <div class="col-lg-5 spacing-right">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($emergencies->emer_poc_attach) }}"
       data-extension="{{ pathinfo($emergencies->emer_poc_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
 ...
 <div class="col-lg-6 spacing-left">
  <h5>Address :</h5>
  <div class="row mb-2">
   <div class="col-lg-5 spacing-right"> Office No <br> <input class="form-control" readonly id="" value="{{ $emergencies->emer_office }}"
     name="customeremergencies[{{ $index }}][emer_office]" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left"> Building <br> <input class="form-control" readonly id="" value="{{ $emergencies->emer_building }}"
     name="customeremergencies[{{ $index }}][emer_building]" type="text" placeholder="..." style="width: 100%;"> </div>
  </div>
  <div class="row mb-2">
   <div class="col-lg-5 spacing-right"> Block <br> <input class="form-control" readonly id="" value="{{ $emergencies->emer_block }}"
     name="customeremergencies[{{ $index }}][emer_block]" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left"> Area <br> <input class="form-control" readonly id="" value="{{ $emergencies->emer_area }}"
     name="customeremergencies[{{ $index }}][emer_area]" type="text" placeholder="..." style="width: 100%;"> </div>
  </div>
  <div class="row mb-2">
   <div class="col-lg-5 spacing-right"> City <br> <input class="form-control" readonly id="" value="{{ $emergencies->emer_city }}"
     name="customeremergencies[{{ $index }}][emer_city]" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left"> Photograph of Building <br> <input class="form-control" readonly id="" value="{{ $emergencies->emer_loc }}"
     name="customeremergencies[{{ $index }}][emer_loc]" type="file" placeholder="..." style="width: 100%;">
    <div class="col-lg-5 spacing-right">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($emergencies->emer_loc) }}"
      data-extension="{{ pathinfo($emergencies->emer_loc, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($emergencies->emer_loc) !!}
     </div>
     {{-- <div class="image-preview42" id="imagePreview42">
                                                            @if ($emergencies->emer_loc)
                                                            <img src="{{ asset($emergencies->emer_loc) }}" alt="Image Preview42" class="image-preview__image42"
     style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
    </div> --}}
   </div>
  </div>
 ...
 <div class="row mb-2">
  <div class="col-lg-5 spacing-right"> Email <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_email]"
    value="{{ $emergencies->emer_email }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-5 spacing-left"> Website <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_web]"
    value="{{ $emergencies->emer_web }}" type="text" placeholder="..." style="width: 100%;"> </div>
 </div>
 <div class="row mb-2">
  <div class="col-lg-5 spacing-right"> Pin location <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_pin]"
    value="{{ $emergencies->emer_pin }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-5 spacing-left"> GPS <br> <input class="form-control" readonly id="" name="customeremergencies[{{ $index }}][emer_gps]"
    value="{{ $emergencies->emer_gps }}" type="text" placeholder="..." style="width: 100%;"> </div>
 </div>
</div>
</div>
<div class="col-lg-6 spacing-left mt-2"> Applicable Rental Property Number <br> <input class="form-control" readonly
  name="customeremergencies[{{ $index }}][emer_app_rental]" value="{{ $emergencies->emer_app_rental }}" type="text" placeholder="..." style="width: 70%;"
  multiple> </div>
<div class="row mb-2">
 <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly
   name="customeremergencies[{{ $index }}][emer_attach]" value="{{ $emergencies->emer_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
  <div class="col-lg-5 spacing-right">
   <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($emergencies->emer_attach) }}"
    data-extension="{{ pathinfo($emergencies->emer_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($emergencies->emer_attach)
    !!} </div>
   {{-- <div class="image-preview42" id="imagePreview42">
                                                    @if ($emergencies->emer_attach)
                                                    <img src="{{ asset($emergencies->emer_attach) }}" alt="Image Preview42" class="image-preview__image42"
   style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
  </div> --}}
 </div>
</div>
<div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
 <textarea id="w3review6" class="form-control" readonly name="customeremergencies[{{ $index }}][emer_note]" oninput="trimSpaces6()"
  onclick="moveCursorToStart6()" rows="2" cols="38">{{ $emergencies->emer_note }} </textarea>
</div>
</div>
@endforeach
...
<div class="tab-pane fade  m-3" style="opacity: 90%;" id="guaranter-details" role="tabpanel" aria-labelledby="nav-contact-tab">
 <div class="row add-more">
  ...
  <div class=" row main-content div" id="department_add_fields">
   <div class="spacing-right form-group"> Department Type <br> <input class="form-control" readonly id="" name="customerdepartments[{{ $index }}][dept_type]"
     value="{{ $departments->dept_type }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-6">
    <div class="row mb-2">
     <div class="col-lg-6 spacing-right"> POC Name <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_name]"
       value="{{ $departments->dept_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left spacing-right"> Email <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_email]"
       value="{{ $departments->dept_email }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-right"> Cell Number <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_cell]"
       value="{{ $departments->dept_cell }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left spacing-right"> Address <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_address]"
       value="{{ $departments->dept_address }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6  spacing-right"> Designation <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_desig]"
       value="{{ $departments->dept_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left spacing-right"> Visiting Card (front) <br>
      <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_front]" value="{{ $departments->dept_front }}" type="file"
       placeholder="..." style="width: 100%;">
     </div>
     <div class="col-lg-6  spacing-right"> Visiting Card (back) <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_back]"
       value="{{ $departments->dept_back }}" type="file" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Notes <br>
      <textarea id="w3review7" class="form-control" readonly name="customerdepartments[{{ $index }}][dept_notes]" oninput="trimSpaces7()"
       onclick="moveCursorToStart7()" rows="2" cols="24">{{ $departments->dept_notes }} </textarea>
     </div>
     <div class="col-lg-6 spacing-right"> Attachments <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_attach]"
       value="{{ $departments->dept_attach }}" type="file" placeholder="..." style="width: 100%;" multiple>
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($departments->dept_attach) }}"
       data-extension="{{ pathinfo($departments->dept_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
   ...
   <div class="col-lg-6 spacing-left">
    <h5>Address</h5>
    <div class="row mb-2">
     <div class="col-lg-5 spacing-right"> Office No <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_office]"
       value="{{ $departments->dept_office }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left"> Building <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_build]"
       value="{{ $departments->dept_build }}" type="text" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-2">
     <div class="col-lg-5 spacing-right"> Block <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_block]"
       value="{{ $departments->dept_block }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left"> Area <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_area]"
       value="{{ $departments->dept_area }}" type="text" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-2">
     <div class="col-lg-5 spacing-right"> City <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_city]"
       value="{{ $departments->dept_city }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left"> Photograph of building <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_photo]"
       value="{{ $departments->dept_photo }}" type="file" placeholder="..." style="width: 100%;">
      <div class="col-lg-5 spacing-right">
       <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($departments->dept_photo) }}"
        data-extension="{{ pathinfo($departments->dept_photo, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
        getFilePreview($departments->dept_photo) !!} </div>
       {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($departments->dept_photo)
                                                        <img src="{{ asset($departments->dept_photo) }}" alt="Image Preview42" class="image-preview__image42"
       style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
      </div> --}}
     </div>
    </div>
   ...
   <div class="row mb-2">
    <div class="col-lg-5 spacing-right"> Pin Location <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_pin]"
      value="{{ $departments->dept_pin }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left"> GPS <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_gps]"
      value="{{ $departments->dept_gps }}" type="text" placeholder="..." style="width: 100%;"> </div>
   </div>
   <div class="row mb-2">
    <div class="col-lg-6 spacing-right mt-2"> Attachments <br> <input class="form-control" readonly name="customerdepartments[{{ $index }}][dept_ex_attach]"
      value="{{ $departments->dept_ex_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
     <div class="col-lg-5 spacing-right">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($departments->dept_ex_attach) }}"
       data-extension="{{ pathinfo($departments->dept_ex_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
   ...
   <div class="col-lg-6 spacing-left mt-2"> Notes <br>
    <textarea id="w3review8" class="form-control" readonly name="customerdepartments[{{ $index }}][dept_ex_notes]" oninput="trimSpaces8()"
     onclick="moveCursorToStart8()" rows="2" cols="38">{{ $departments->dept_ex_notes }} </textarea>
   </div>
  </div>
 </div>
</div>
 ...
 <div class="row d-flex justify-content-end align-items-center">
  <div class="row d-flex justify-content-end align-items-center">
   <div class="col-lg-12">
    ...
    <div class="row mb-2 mt-3">
     <div class="col-lg-4 spacing-right"> Visit Performed By: <br> <input class="form-control" readonly type="text" value="{{ $customers->visit_perf_by }}"
       name="visit_perf_by" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-4 spacing-right"> Location: <br> <input class="form-control" readonly type="text" name="pat_super_loc"
       value="{{ $customers->pat_super_loc }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-4 spacing-right"> Date: <br> <input class="form-control" readonly name="pat_super_date" value="{{ $customers->pat_super_date }}"
       type="date" placeholder="..." style="width: 100%;"> </div>
    </div>
    <div class="row mb-2">
     <div class="col-lg-4 spacing-right"> Day: <br> <input class="form-control" readonly type="text" name="pat_super_day"
       value="{{ $customers->pat_super_day }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-4 spacing-right"> Time: <br> <input class="form-control" readonly type="time" name="pat_super_times"
       value="{{ $customers->pat_super_times }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-4 spacing-right ">
      <div class=""> Photo Taken: <br> <input class="form-control" readonly value="{{ $customers->pat_super_photo }}" name="pat_super_photo" type="file"
        placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
    <div class="row mb-4">
     <div class="col-lg-4 spacing-right ">
      <div class=""> Video Taken: <br> <input class="form-control " readonly name="pat_super_video" value="{{ $customers->pat_super_videp }}" type="file"
        placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="col-lg-4 mt-3 spacing-right "> Inform Client about the visit via email:
      <br>
      <div class="form-check form-check-inline"> <input class="form-check-input mr-2" type="radio" name="pat_super_inform_email" value="1"
        id="activeEmailRadio"> <label class="form-check-label" for="activeEmailRadio">Yes</label> <input class="form-check-input ml-3 mr-2" type="radio"
...
<div class="tab-pane fade m-3" style="opacity: 90%;" id="arm" role="tabpanel" aria-labelledby="nav-loto-tab">
 <div id="cleaningInfo">
  ...
  <div class="row col-lg-12">
   <div class="col-lg-4 spacing-right"> Branch Name <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_branch_name]" value="{{ $armourers->arm_branch_name }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Branch ID <br> <input class="form-control" readonly type="text" name="customerarmourers[{{ $index }}][arm_branch_id]"
     value="{{ $armourers->arm_branch_id }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Site ID <br> <input class="form-control" readonly type="text" name="customerarmourers[{{ $index }}][arm_site_id]"
     value="{{ $armourers->arm_site_id }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Client Name <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_client_name]" value="{{ $armourers->arm_client_name }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Weapon Number <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_weapon_no]" value="{{ $armourers->arm_weapon_no }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Weapon Bore <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_weapon_bore]" value="{{ $armourers->arm_weapon_bore }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Weapon Type <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_weapon_type]" value="{{ $armourers->arm_weapon_type }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Working Details <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_work_detail]" value="{{ $armourers->arm_work_detail }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-4 spacing-right"> Sign of Customer <br> <input class="form-control" readonly type="text"
     name="customerarmourers[{{ $index }}][arm_sign_cus]" value="{{ $armourers->arm_sign_cus }}" placeholder="..." style="width: 100%;"> </div>
  </div>
  <div class="col-lg-12">
   <div class="row mb-2">
    <div class="col-lg-4 spacing-right" style="margin-bottom: 10px;"> New Authority
     Letter Issue : <br> <input class="form-control" readonly id="" name="customerarmourers[{{ $index }}][arm_auth]" value="{{ $armourers->arm_auth }}"
      type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;"> New
     Authority Letter No <br> <input class="form-control" readonly id="head_office_email" id="inpFile42" name="customerarmourers[{{ $index }}][arm_auth_no]"
      value="{{ $armourers->arm_auth_no }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;"> New
     Authority Letter Validity <br> <input class="form-control" readonly id="head_office_email" name="customerarmourers[{{ $index }}][arm_auth_date]"
      value="{{ $armourers->arm_auth_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-right" style="margin-bottom: 10px;"> Date of issue <br>
     <input class="form-control" readonly id="" name="customerarmourers[{{ $index }}][arm_auth_issue]" value="{{ $armourers->arm_auth_issue }}" type="date"
      placeholder="..." style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;">
     Number of weapon cleaned <br> <input class="form-control" readonly id="head_office_email" id="inpFile42"
      name="customerarmourers[{{ $index }}][arm_weapon_cleaned]" value="{{ $armourers->arm_weapon_cleaned }}" type="text" placeholder="..."
      style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left spacing-right" style="margin-bottom: 10px;"> Type
     of weapon cleaned <br> <input class="form-control" readonly id="head_office_email" name="customerarmourers[{{ $index }}][type_weapon_cleaned]"
      value="{{ $armourers->type_weapon_cleaned }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-right"> Picture before cleaning <br> <input class="form-control" readonly id=""
      name="customerarmourers[{{ $index }}][arm_pic_b]" type="file" value="{{ $armourers->arm_pic_b }}" placeholder="..." style="width: 100%;">
     <div class="col-lg-5 spacing-right">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($armourers->arm_pic_b) }}"
       data-extension="{{ pathinfo($armourers->arm_pic_b, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($armourers->arm_pic_b) !!}
      </div>
      {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($armourers->arm_pic_b)
                                                        <img src="{{ asset($armourers->arm_pic_b) }}" alt="Image Preview42" class="image-preview__image42"
      style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
     </div> --}}
    </div>
   </div>
   <div class="col-lg-4 spacing-right"> Picture after cleaning <br> <input class="form-control" readonly id="" name="customerarmourers[{{ $index }}][arm_pic_a]"
     type="file" value="{{ $armourers->arm_pic_a }}" placeholder="..." style="width: 100%;">
    <div class="col-lg-5 spacing-right">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($armourers->arm_pic_a) }}"
      data-extension="{{ pathinfo($armourers->arm_pic_a, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($armourers->arm_pic_a) !!}
     </div>
     {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($armourers->arm_pic_a)
                                                        <img src="{{ asset($armourers->arm_pic_a) }}" alt="Image Preview42" class="image-preview__image42"
     style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
    </div> --}}
   </div>
  </div>
  <div class="col-lg-4 spacing-right"> Cost of the day <br> <input class="form-control" readonly id="" name="customerarmourers[{{ $index }}][arm_cost_day]"
    value="{{ $armourers->arm_cost_day }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-right"> Cost Bill <br> <input class="form-control" readonly id="" name="customerarmourers[{{ $index }}][arm_cost_bill]"
    value="{{ $armourers->arm_cost_bill }}" type="file" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($armourers->arm_cost_bill) }}"
     data-extension="{{ pathinfo($armourers->arm_cost_bill, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($armourers->arm_cost_bill)
     !!} </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($armourers->arm_cost_bill)
                                                        <img src="{{ asset($armourers->arm_cost_bill) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
 <div class="col-lg-4 spacing-right"> Next cleaning activity due on : <br> <input class="form-control" readonly id=""
   name="customerarmourers[{{ $index }}][arm_next_clean]" value="{{ $armourers->arm_next_clean }}" type="date" placeholder="..." style="width: 100%;"> </div>
</div>
<div class="row mb-2">
 <div class="col-lg-4 spacing-right mt-2"> Notes <br>
  <textarea id="w3review9" class="form-control" readonly name="customerarmourers[{{ $index }}][arm_next_clean]" oninput="trimSpaces9()"
   onclick="moveCursorToStart9()" rows="2" cols="38">{{ $armourers->arm_next_clean }} </textarea>
 </div>
 <div class="col-lg-4 spacing-left spacing-right mt-2"> Attachments <br> <input class="form-control" readonly
   name="customerarmourers[{{ $index }}][arm_auth_attach]" value="{{ $armourers->arm_auth_attach }}" type="file" placeholder="..." style="width: 70%;" multiple>
  <div class="col-lg-5 spacing-right">
   <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($armourers->arm_auth_attach) }}"
    data-extension="{{ pathinfo($armourers->arm_auth_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
   ...
   class="image-preview__image42" style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span>
   @endif
  </div> --}}
 </div>
</div>
...
<div class="tab-pane fade m-3" style="opacity: 90%;" id="incident_report" role="tabpanel" aria-labelledby="nav-incident-tab">
 ...
 <div class="row client-info">
  ...
  <div class="col-lg-6">
   <div class="row mb-2">
    <div class="col-lg-3 spacing-right"> Client Name <br> <input class="form-control" readonly type="text" name="customerincidents[{{ $index }}][client_name]"
      value="{{ $incidents->client_name }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-left spacing-right"> Client ID <br> <input class="form-control" readonly type="text"
      name="customerincidents[{{ $index }}][client_id]" value="{{ $incidents->client_id }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right"> Site ID <br> <input class="form-control" readonly type="text"
      name="customerincidents[{{ $index }}][client_site_id]" value="{{ $incidents->client_site_id }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Client POC Name <br> <input class="form-control" readonly type="text"
      name="customerincidents[{{ $index }}][client_poc]" value="{{ $incidents->client_poc }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-left spacing-right"> Cell <br> <input class="form-control" readonly type="text"
      name="customerincidents[{{ $index }}][client_cell]" value="{{ $incidents->client_cell }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right"> Email <br> <input class="form-control" readonly type="text"
      name="customerincidents[{{ $index }}][client_email]" value="{{ $incidents->client_email }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Site Address <br> <input class="form-control" readonly type="text"
      name="customerincidents[{{ $index }}][client_site_address]" value="{{ $incidents->client_site_address }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-left spacing-right"> Office/Floor <br> <input class="form-control" readonly
      name="customerincidents[{{ $index }}][client_office]" value="{{ $incidents->client_office }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right"> Building Name<br> <input class="form-control" readonly
      name="customerincidents[{{ $index }}][client_build]" value="{{ $incidents->client_build }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Street <br> <input class="form-control" readonly type="text" name="customerincidents[{{ $index }}][client_street]"
      value="{{ $incidents->client_street }}" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-left spacing-right"> Area <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][client_area]"
      value="{{ $incidents->client_area }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right"> City <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][client_city]"
      value="{{ $incidents->client_city }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right" style="margin-left: 12px;"> FIR #
     <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][client_fir]" value="{{ $incidents->client_fir }}" type="text"
      placeholder="..." style="width: 115%;">
    </div>
    <div class="col-lg-5 spacing-left spacing-right" style="margin-left: 30px;"> Arrest
     # <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][arrest]" value="{{ $incidents->arrest }}" type="text" placeholder="..."
      style="width: 101%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right" style="margin-left: 12px;">
     Casualities <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][casual]" value="{{ $incidents->casual }}" type="text"
      placeholder="..." style="width: 115%;"">
                                </div>

                                <div class=" col-lg-5 spacing-left spacing-right" style="margin-left: 30px;">
     Injuired <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][injuired]" value="{{ $incidents->injuired }}" type="text"
      placeholder="..." style="width: 101%;"> </div>
    <div class="row mb-2" style="margin-left:2px;">
     <div class="col-lg-6 spacing-left spacing-right"> Incident Reported to <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][incident_rep]" value="{{ $incidents->incident_rep }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Police Officer Name <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][police_officer_name]" value="{{ $incidents->police_officer_name }}" type="text" placeholder="..."
       style="width: 87%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Station <br> <input class="form-control" readonly type="text"
       name="customerincidents[{{ $index }}][station]" value="{{ $incidents->station }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Rank <br> <input class="form-control" readonly type="text" name="customerincidents[{{ $index }}][rank]"
       value="{{ $incidents->rank }}" placeholder="..." style="width: 87%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Report Made by <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][report_made_by]" value="{{ $incidents->report_made_by }}" type="text" placeholder="..." style="width: 100%;">
     </div>
     <div class="col-lg-6 spacing-left spacing-right"> Date <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][report_date]"
       value="{{ $incidents->report_date }}" type="date" placeholder="..." style="width: 87%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Time <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][report_time]"
       value="{{ $incidents->report_time }}" type="time" placeholder="..." style="width: 87%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Approved By <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][report_apr_by]" value="{{ $incidents->report_apr_by }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-left spacing-right"> Shared with <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][report_shared]" value="{{ $incidents->report_shared }}" type="text" placeholder="..." style="width: 87%;"> </div>
    </div>
   </div>
  </div>
  <div class="col-lg-6">
   <div class="row mb-2">
    <div class="col-lg-5 spacing-left spacing-right"> Incident Type <br> <input class="form-control" readonly
      name="customerincidents[{{ $index }}][incident_type]" value="{{ $incidents->incident_type }}" type="text" placeholder="..." style="width: 87%;"> </div>
    <div class="col-lg-6 spacing-left spacing-right"> Weapon used by Attacker <br> <input class="form-control" readonly
      name="customerincidents[{{ $index }}][weapon_used]" value="{{ $incidents->weapon_used }}" type="text" placeholder="..." style="width: 87%;"> </div>
    <div class="col-lg-6 spacing-left spacing-right"> Details of Attacker <br> <input class="form-control" readonly
      name="customerincidents[{{ $index }}][detail_of_attacker]" value="{{ $incidents->detail_of_attacker }}" type="text" placeholder="..." style="width: 87%;">
    </div>
    <div class="col-lg-6 spacing-left spacing-right" style="margin-left: -42px;">
     Attacker Description <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][attacker_desc]"
      value="{{ $incidents->attacker_desc }}" type="text" placeholder="..." style="width: 87%;"> </div>
    <div class="row mb-2" style="margin-left: -24px;">
     <div class="col-lg-3 spacing-right"> Shoes <br> <input class="form-control" readonly type="text" name="customerincidents[{{ $index }}][attacker_shoe]"
       value="{{ $incidents->attacker_shoe }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-3 spacing-left spacing-right"> Beard/M <br> <input class="form-control" readonly name="customerincidents[{{ $index }}][attacker_beard]"
       value="{{ $incidents->attacker_beard }}" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-5 spacing-left spacing-right"> Language <br> <input class="form-control" readonly type="text"
       name="customerincidents[{{ $index }}][attacker_lang]" value="{{ $incidents->attacker_lang }}" placeholder="..." style="width: 117%;"> </div>
     <div class="col-lg-3 spacing-right"> Focused on <br> <input class="form-control" readonly type="text" name="customerincidents[{{ $index }}][focused]"
       value="{{ $incidents->focused }}" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-3 spacing-left spacing-right"> Opening Phrase <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][opening_phrase]" value="{{ $incidents->opening_phrase }}" type="text" placeholder="..." style="width: 100%;">
     </div>
     <div class="col-lg-5 spacing-left spacing-right"> Anything Unusual <br> <input class="form-control" readonly
       name="customerincidents[{{ $index }}][any_usual]" value="{{ $incidents->any_usual }}" type="text" placeholder="..." style="width: 117%;"> </div>
    </div>
   </div>
   <div class="row mb-2" style="margin-top: -10px ;">
    <div class="col-lg-6 spacing-left spacing-right"> Estimated Loss in PKR <br> <input class="form-control" readonly
      name="customerincidents[{{ $index }}][estimated_loss]" value="{{ $incidents->estimated_loss }}" type="text" placeholder="..." style="width: 91%;"> </div>
    <div class="col-lg-5 spacing-left spacing-right" style="margin-left: -20px;">
     Description of Loss <br> <input class="form-control" readonly type="text" name="customerincidents[{{ $index }}][desc_loss]"
      value="{{ $incidents->desc_loss }}" placeholder="..." style="width: 110%;"> </div>
   </div>
   <div class="col-lg-6 spacing-left spacing-right" style="margin-top:-6px; margin-left:-15px;"> Officers Response <br> <input class="form-control" readonly
     type="text" name="customerincidents[{{ $index }}][officer_response]" value="{{ $incidents->officer_response }}" placeholder="..." style="width: 110%;">
   </div>
  </div>
  <div class="row mb-2">
   <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly type="file"
     name="customerincidents[{{ $index }}][incident_attach]" value="{{ $incidents->incident_attach }}" placeholder="..." style="width: 70%;" multiple>
    <div class="col-lg-5 spacing-right">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($incidents->incident_attach) }}"
      data-extension="{{ pathinfo($incidents->incident_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
      getFilePreview($incidents->incident_attach) !!} </div>
     {{-- <div class="image-preview42" id="imagePreview42">
                                                    @if ($incidents->incident_attach)
                                                    <img src="{{ asset($incidents->incident_attach) }}" alt="Image Preview42" class="image-preview__image42"
     style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
    </div> --}}
   </div>
  </div>
  <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
   <textarea id="w3review10" class="form-control" readonly oninput="trimSpaces10()" onclick="moveCursorToStart10()"
    name="customerincidents[{{ $index }}][incident_note]" rows="2" cols="38">{{ $incidents->incident_note }} </textarea>
  </div>
...
<div class="row" id="assignmentInfo">
 ...
 <div class="col-lg-6">
  <div class="row mb-2">
   <div class="col-lg-3 spacing-right"> Customer Name <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][asig_customer_name]"
     value="{{ $assigments->asig_customer_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-3 spacing-left spacing-right"> Task Assigning <br> <input class="form-control" readonly
     name="customerassigments[{{ $index }}][task_assigning]" value="{{ $assigments->task_assigning }}" type="text" placeholder="..." style="width: 100%;">
   </div>
   <div class="col-lg-3 spacing-right"> Designation <br> <input class="form-control" readonly type="text" name="customerassigments[{{ $index }}][asig_desig]"
     value="{{ $assigments->asig_desig }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-3 spacing-right"> Office/Floor <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][asig_office]"
     value="{{ $assigments->asig_office }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-3 spacing-left spacing-right"> Building Name<br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][asig_building]" value="{{ $assigments->asig_building }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left spacing-right"> Road/Street <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][asig_road]" value="{{ $assigments->asig_road }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-right"> Area <br> <input class="form-control" readonly type="text" name="customerassigments[{{ $index }}][asig_area]"
     value="{{ $assigments->asig_area }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left spacing-right"> City <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][task_assigning]" value="{{ $assigments->task_assigning }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-right"> Country <br> <input class="form-control" readonly type="text" name="customerassigments[{{ $index }}][asig_country]"
     value="{{ $assigments->asig_country }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left spacing-right"> Security Incharge <br> <input class="form-control" readonly
     name="customerassigments[{{ $index }}][asig_security]" value="{{ $assigments->asig_security }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-right"> Contact Details <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][asig_contact]"
     value="{{ $assigments->asig_contact }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <h5>Site Incharge Details</h5>
   <div class="col-lg-3 spacing-right"> Incharge Name <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][incharge_name]" value="{{ $assigments->incharge_name }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-3 spacing-right"> Designation <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][incharge_desig]" value="{{ $assigments->incharge_desig }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-3 spacing-left spacing-right"> Contact Details <br> <input class="form-control" readonly
     name="customerassigments[{{ $index }}][incharge_contact]" value="{{ $assigments->incharge_contact }}" type="text" placeholder="..." style="width: 100%;">
   </div>
   <div class="col-lg-8 spacing-right"> High Risk Areas <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][incharge_help]" value="{{ $assigments->incharge_help }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Description of Risk <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][incharge_desc]" value="{{ $assigments->incharge_desc }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> History of Risk <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][incharge_risk]"
     value="{{ $assigments->incharge_risk }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right" style="margin-top: 40px"> Assigned Area Manager
    Of PIFFERS <br> <input class="form-control" readonly type="text" name="customerassigments[{{ $index }}][incharge_asig]"
     value="{{ $assigments->incharge_asig }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Signed By <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][incharge_signed_by]"
     value="{{ $assigments->incharge_signed_by }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Date <br> <input class="form-control" readonly type="date" name="customerassigments[{{ $index }}][incharge_date]"
     value="{{ $assigments->incharge_date }}" placeholder="..." style="width: 100%;"> </div>
  </div>
 </div>
 <div class="col-lg-6">
  <div class="row mb-2">
   <h5>Address</h5>
   <div class="row mb-2">
    <div class="col-lg-5 spacing-right"> Office No <br> <input class="form-control" readonly id="" name="customerassigments[{{ $index }}][incharge_offc]"
      value="{{ $assigments->incharge_offc }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left"> Building <br> <input class="form-control" readonly id="" name="customerassigments[{{ $index }}][incharge_build]"
      value="{{ $assigments->incharge_build }}" type="text" placeholder="..." style="width: 100%;"> </div>
   </div>
   <div class="row mb-2">
    <div class="col-lg-5 spacing-right"> Block <br> <input class="form-control" readonly id="" name="customerassigments[{{ $index }}][incharge_block]"
      value="{{ $assigments->incharge_block }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left"> Area <br> <input class="form-control" readonly id="" name="customerassigments[{{ $index }}][incharge_area]"
      value="{{ $assigments->incharge_area }}" type="text" placeholder="..." style="width: 100%;"> </div>
   </div>
   <div class="row mb-2">
    <div class="col-lg-5 spacing-right"> City <br> <input class="form-control" readonly id="" name="customerassigments[{{ $index }}][incharge_city]"
      value="{{ $assigments->incharge_city }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-5 spacing-left"> Pin Location <br> <input class="form-control" readonly id="" name="customerassigments[{{ $index }}][incharge_pin]"
      value="{{ $assigments->incharge_pin }}" type="text" placeholder="..." style="width: 100%;"> </div>
   </div>
   <div class="col-lg-5 spacing-left spacing-right"> Country <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][incharge_country]"
     value="{{ $assigments->incharge_country }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left spacing-right"> Site ID <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][incharge_site]"
     value="{{ $assigments->incharge_site }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left spacing-right"> A-Guard <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][incharge_a_g]"
     value="{{ $assigments->incharge_a_g }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left spacing-right"> Un-A-Guard <br> <input class="form-control" readonly
     name="customerassigments[{{ $index }}][incharge_a_ung]" value="{{ $assigments->incharge_a_ung }}" type="text" placeholder="..." style="width: 100%;">
   </div>
   <div class="col-lg-5 spacing-left spacing-right"> Total Guard <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][incharge_t_g]"
     value="{{ $assigments->incharge_t_g }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right" style="margin-top:80px"> Recent Security Related
    Incidents <br> <input class="form-control" readonly type="text" name="customerassigments[{{ $index }}][rec_inc_rel]" value="{{ $assigments->rec_inc_rel }}"
     placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Frequency Of Occurence <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][feq_occ]" value="{{ $assigments->feq_occ }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Expectations from PIFFERS <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][exp_piff]" value="{{ $assigments->exp_piff }}" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Any Special Instructions <br> <input class="form-control" readonly name="customerassigments[{{ $index }}][any_spec]"
     value="{{ $assigments->any_spec }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <div class="col-lg-8 spacing-right"> Petrolling Instruction <br> <input class="form-control" readonly type="text"
     name="customerassigments[{{ $index }}][petr_instruc]" value="{{ $assigments->petr_instruc }}" placeholder="..." style="width: 100%;"> </div>
  </div>
 </div>
 <h3></h3>
 <div class="row mb-2">
  <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachments <br> <input class="form-control" readonly type="file"
    name="customerassigments[{{ $index }}][asig_ex_attach]" value="{{ $assigments->asig_ex_attach }}" placeholder="..." style="width: 70%;" multiple>
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($assigments->asig_ex_attach) }}"
     data-extension="{{ pathinfo($assigments->asig_ex_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
     getFilePreview($assigments->asig_ex_attach) !!} </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                    @if ($armourers->asig_ex_attach)
                                                    <img src="{{ asset($armourers->asig_ex_attach) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
 <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
  <textarea id="w3review11" class="form-control" readonly name="customerassigments[{{ $index }}][asig_ex_notes]" oninput="trimSpaces11()"
   onclick="moveCursorToStart11()" rows="2" cols="38">{{ $assigments->asig_ex_notes }} </textarea>
 </div>
</div>
@endforeach {{-- <div class="new_branch mt-2">
...
<div class="tab-pane fade m-3" style="opacity: 90%;" id="audit" role="tabpanel" aria-labelledby="nav-loto-tab">
 <div class=" row main-content div" id="auditsInfo">
  ...
  <div class="col-lg-12">
   <div class="row mb-2">
    <div class="col-lg-3 spacing-right"> File Audited By : <br> <input class="form-control" readonly id="" name="customeraudits[{{ $index }}][audit_file]"
      value="{{ $audits->audit_file }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-left spacing-right"> Signature <br> <input class="form-control" readonly id="head_office_email"
      name="customeraudits[{{ $index }}][audit_sign]" value="{{ $audits->audit_sign }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Date <br> <input class="form-control" readonly id="" name="customeraudits[{{ $index }}][audit_date]"
      value="{{ $audits->audit_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-3 spacing-right"> Attachments <br> <input class="form-control" readonly id="" name="customeraudits[{{ $index }}][audit_attach]"
      value="{{ $audits->audit_attach }}" type="file" placeholder="..." style="width: 100%;">
     <div class="col-lg-5 spacing-right">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($audits->audit_attach) }}"
       data-extension="{{ pathinfo($audits->audit_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($audits->audit_attach) !!}
      </div>
      {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($audits->audit_attach)
                                                        <img src="{{ asset($audits->audit_attach) }}" alt="Image Preview42" class="image-preview__image42"
      style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
     </div> --}}
    </div>
   </div>
 ...
 <div class="row mb-2">
  <div class="col-lg-5 spacing-right form-group"> Checked by: <br> <input class="form-control" readonly id=""
    name="customeraudits[{{ $index }}][audit_checked_by]" value="{{ $audits->audit_checked_by }}" type="text" placeholder="..." style="width: 100%;"> </div>
 </div>
 <div class="row mb-2">
  <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly
    name="customeraudits[{{ $index }}][audit_ex_attach]" type="file" value="{{ $audits->audit_ex_attach }}" placeholder="..." style="width: 70%;" multiple>
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($audits->audit_ex_attach) }}"
     data-extension="{{ pathinfo($audits->audit_ex_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($audits->audit_ex_attach)
     !!} </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                    @if ($audits->audit_ex_attach)
                                                    <img src="{{ asset($audits->audit_ex_attach) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
 <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
  <textarea id="w3review12" class="form-control" readonly name="customeraudits[{{ $index }}][audit_note]" oninput="trimSpaces12()"
...
<div class="tab-pane fade m-3" style="opacity: 90%;" id="intelligence" role="tabpanel" aria-labelledby="nav-loto-tab">
 <div id="businessInfo">
  ...
  <div class=" row main-content div">
   ...
   <div class="col-lg-12">
    <div class="row mb-2">
     <div class="col-lg-6 spacing-right"> Name of Business <br> <input class="form-control" readonly value="{{ $bussinesses->bussiness_name }}"
       name="customerbussinesses[{{ $index }}][bussiness_name]" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-right"> Nature of Business <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_nature }}"
       name="customerbussinesses[{{ $index }}][bussiness_nature]" type="text" placeholder="..." style="width: 100%;"> </div>
     <div class="col-lg-6 spacing-left">
      <h5>Address</h5>
      <div class="row mb-2">
       <div class="col-lg-5 spacing-right"> Office No <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_office_no }}"
         name="customerbussinesses[{{ $index }}][bussiness_office_no]" type="text" placeholder="..." style="width: 100%;"> </div>
       <div class="col-lg-5 spacing-right"> Floor <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_floor }}"
         name="customerbussinesses[{{ $index }}][bussiness_floor]" type="text" placeholder="..." style="width: 100%;"> </div>
       <div class="col-lg-5"> Building <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_building }}"
         name="customerbussinesses[{{ $index }}][bussiness_building]" type="text" placeholder="..." style="width: 100%;"> </div>
      </div>
      <div class="row mb-2">
       <div class="col-lg-5 spacing-right"> Block <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_block }}"
         name="customerbussinesses[{{ $index }}][bussiness_block]" type="text" placeholder="..." style="width: 100%;"> </div>
       <div class="col-lg-5 spacing-left"> Area <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_area }}"
         name="customerbussinesses[{{ $index }}][bussiness_area]" type="text" placeholder="..." style="width: 100%;"> </div>
      </div>
      <div class="row mb-2">
       <div class="col-lg-5 spacing-right"> City <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_city }}"
         name="customerbussinesses[{{ $index }}][bussiness_city]" type="text" placeholder="..." style="width: 100%;"> </div>
       <div class="col-lg-5 spacing-left"> Photograph of Building <br> <input class="form-control" readonly id="" value="{{ $bussinesses->bussiness_photo }}"
         name="customerbussinesses[{{ $index }}][bussiness_photo]" type="file" placeholder="..." style="width: 100%;">
        <div class="col-lg-5 spacing-right">
         <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($bussinesses->bussiness_photo) }}"
          data-extension="{{ pathinfo($bussinesses->bussiness_photo, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
     ...
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Email <br> <input class="form-control" readonly id="" name="customerbussinesses[{{ $index }}][bussiness_email]"
        value="{{ $bussinesses->bussiness_email }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Website <br> <input class="form-control" readonly id="" name="customerbussinesses[{{ $index }}][bussiness_web]"
        value="{{ $bussinesses->bussiness_web }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Pin location <br> <input class="form-control" readonly id="" name="customerbussinesses[{{ $index }}][bussiness_pin]"
        value="{{ $bussinesses->bussiness_pin }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> GPS <br> <input class="form-control" readonly id="" name="customerbussinesses[{{ $index }}][bussiness_gps]"
        value="{{ $bussinesses->bussiness_gps }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
   </div>
  </div>
  <div class="row mb-2">
   <div class="col-lg-4 spacing-left spacing-right mt-2"> Notes <br>
    <textarea id="w3review13" class="form-control" readonly name="customerbussinesses[{{ $index }}][bussiness_notes]" oninput="trimSpaces13()"
     onclick="moveCursorToStart13()" rows="2" cols="38">{{ $bussinesses->bussiness_notes }} </textarea>
   </div>
   <div class="col-lg-4 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly value="{{ $bussinesses->bussiness_attach }}"
     type="file" name="customerbussinesses[{{ $index }}][bussiness_attach]" placeholder="..." style="width: 70%;" multiple>
    <div class="col-lg-5 spacing-right">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($bussinesses->bussiness_attach) }}"
      data-extension="{{ pathinfo($bussinesses->bussiness_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
      getFilePreview($bussinesses->bussiness_attach) !!} </div>
     {{-- <div class="image-preview42" id="imagePreview42">
                                                    @if ($bussinesses->bussiness_attach)
                                                    <img src="{{ asset($bussinesses->bussiness_attach) }}" alt="Image Preview42" class="image-preview__image42"
     style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
    </div> --}}
   </div>
  </div>
...
<div class="row" id="give_a_ways">
 ...
 <div class="col-lg-6 spacing-right form-group"> Customer Details Entered in all Promotional
  Activities <br> <input class="form-control" readonly type="text" name="customeractivities[{{ $index }}][promotional_act]"
   value="{{ $activities->promotional_act }}" placeholder="..." style="width: 100%;"> </div>
 <div class="col-lg-6 mt-1">
  <div class="spacing-left"> Quantity <br> <input class="form-control" readonly type="text" name="customeractivities[{{ $index }}][promotional_quantity]"
    value="{{ $activities->promotional_quantity }}" placeholder="..." style="width: 100%;"> </div>
 </div>
 <div class="form-type col-lg-6 spacing-right"> Estimated price<br> <input class="form-control" readonly id="shift_start_date"
   name="customeractivities[{{ $index }}][prom_price]" value="{{ $activities->prom_price }}" type="text" placeholder="..." style="width: 100%;"> </div>
 <div class="form-type col-lg-6 spacing-right"> Date <br> <input class="form-control" readonly id="shift_end_date"
   name="customeractivities[{{ $index }}][prom_date]" type="date" value="{{ $activities->prom_date }}" placeholder="..." style="width: 100%;">
 </div>
 <div class="col-lg-6"> Notes <br>
  <textarea id="w3review14" class="form-control" readonly name="customeractivities[{{ $index }}][promotional_notes]" oninput="trimSpaces14()"
   onclick="moveCursorToStart14()" rows="2" cols="38">{{ $activities->promotional_notes }} </textarea>
 </div>
 <div class="col-lg-6"> Attachments <br> <input class="form-control" readonly type="file" name="customeractivities[{{ $index }}][promotional_attach]"
   value="{{ $activities->promotional_attach }}" placeholder="..." style="width: 100%;">
  <div class="col-lg-5 spacing-right">
   <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($activities->promotional_attach) }}"
    data-extension="{{ pathinfo($activities->promotional_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
    getFilePreview($activities->promotional_attach) !!} </div>
   {{-- <div class="image-preview42" id="imagePreview42">
                                                @if ($activities->promotional_attach)
                                                <img src="{{ asset($activities->promotional_attach) }}" alt="Image Preview42" class="image-preview__image42"
   style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
  </div> --}}
 </div>
</div>
 ...
 <div class="feedback"> {{-- <div class="mt-2">
  ...
  <div id="feedbackForm">
   <div class="row">
    <div class="col-lg-7">
     <div class="row mb-2">
      <div class="col-lg-11 spacing-right"> Client Name: <br> <input class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_client_name]"
        value="{{ $feedbacks->feed_client_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-right"> Client POC Name: <br> <input class="form-control" readonly
        name="customerfeedbacks[{{ $index }}][feed_client_poc_name]" value="{{ $feedbacks->feed_client_poc_name }}" type="text" placeholder="..."
        style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-right"> Email: <br> <input class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_client_email]"
        value="{{ $feedbacks->feed_client_email }}" type="date" placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
    <div class="col-lg-5">
     <div class="row mb-2">
      <div class="col-lg-6 spacing-left spacing-right"> Client ID: <br> <input class="form-control" readonly
        name="customerfeedbacks[{{ $index }}][feed_client_id]" value="{{ $feedbacks->feed_client_id }}" type="text" placeholder="..." style="width: 100%;">
      </div>
      <div class="col-lg-5 spacing-right"> Site ID: <br> <input class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_client_site_id]"
        value="{{ $feedbacks->feed_client_site_id }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
     <div class="row mb-5">
      <div class="col-lg-11 spacing-left spacing-right"> Designation: <br> <input class="form-control" readonly
        name="customerfeedbacks[{{ $index }}][feed_desig]" value="{{ $feedbacks->feed_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-left spacing-right"> Cell: <br> <input class="form-control" readonly type="text"
        name="customerfeedbacks[{{ $index }}][feed_cell]" value="{{ $feedbacks->feed_cell }}" placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
    <div class="col-lg-11">
     <table class="table table-bordered">
      <thead>
       <div class="row mb-5">
        ...
        <div class="col-lg-4 spacing-left spacing-right"> <input class="form-control" readonly type="text" name="customerfeedbacks[{{ $index }}][feed_month]"
          value="{{ $feedbacks->feed_month }}" placeholder="..." style="width: 100%;"> </div>
       </div>
       <tr width="100%">
        <th width="75%">
   ...
   <div class="row">
    ...
    <div class="col-lg-7">
     <div class="row mb-2">
      <div class="col-lg-11 spacing-right"> Company Name: <br> <input class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_company_name]"
        value="{{ $feedbacks->feed_company_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-right"> POC Name: <br> <input class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_poc_name]"
        value="{{ $feedbacks->feed_poc_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-right"> Suggestions / Comments:<br> <input class="form-control" readonly
        name="customerfeedbacks[{{ $index }}][feed_comment]" value="{{ $feedbacks->feed_comment }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-right"> Feedback Form Filled By:<br> <input class="form-control" readonly
        name="customerfeedbacks[{{ $index }}][feedback_form]" value="{{ $feedbacks->feedback_form }}" type="text" placeholder="..." style="width: 100%;"> </div>
     </div>
    </div>
    <div class="col-lg-5">
     <div class="row mb-2">
      <div class="col-lg-11 spacing-left spacing-right"> Email: <br> <input class="form-control" readonly type="text"
        name="customerfeedbacks[{{ $index }}][feed_email]" value="{{ $feedbacks->feed_email }}" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-left spacing-right"> Telephone: <br> <input class="form-control" readonly type="text"
        name="customerfeedbacks[{{ $index }}][feed_telephone]" value="{{ $feedbacks->feed_telephone }}" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-11 spacing-left spacing-right"> Signature & Date: <br>
       <input class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_signature]" value="{{ $feedbacks->feed_signature }}" type="text"
        placeholder="..." style="width: 100%;">
      </div>
     </div>
    </div>
   ...
   <div class="row">
    ...
    <div class="col-lg-11 spacing-right"> Feedback Form Received By: <br> <input class="form-control" readonly
      name="customerfeedbacks[{{ $index }}][feed_received]" value="{{ $feedbacks->feed_received }}" type="text" placeholder="..." style="width: 100%;"> </div>
    <div class="col-lg-11 spacing-right"> Remarks: <br> <input class="form-control" readonly type="text" name="customerfeedbacks[{{ $index }}][feed_remarks]"
      value="{{ $feedbacks->feed_remarks }}" placeholder="..." style="width: 100%;"> </div>
   </div>
   <div class="row">
    <div class="col-lg-11 spacing-right"> Attachments: <br> <input id="" class="form-control" readonly name="customerfeedbacks[{{ $index }}][feed_attach]"
      value="{{ $feedbacks->feed_attach }}" type="file" placeholder="..." style="width: 100%;">
     <div class="col-lg-5 spacing-right">
      <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($feedbacks->feed_attach) }}"
       data-extension="{{ pathinfo($feedbacks->feed_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($feedbacks->feed_attach)
       !!} </div>
      {{-- <div class="image-preview42" id="imagePreview42">
                                                    @if ($feedbacks->feed_attach)
                                                    <img src="{{ asset($feedbacks->feed_attach) }}" alt="Image Preview42" class="image-preview__image42"
      style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
     </div> --}}
    </div>
   </div>
...
<div class="row" id="complaintForm">
 ...
 <div class="col-lg-12">
  <div class="row mb-2">
   <div class="col-lg-4 spacing-left spacing-right"> Complaint Number <br> <input class="form-control" readonly
     name="customercomplaints[{{ $index }}][complaint_no]" value="{{ $complaints->complaint_no }}" type="text" placeholder="..." style="width: 100%;"> </div>
   <h5 class="mt-3">Guards Duty</h5>
   <div class="col-lg-5 spacing-left spacing-right form-group"> Guards Duty <br> <input class="form-control" readonly
     name="customercomplaints[{{ $index }}][complaint_guards_duty]" value="{{ $complaints->complaint_guards_duty }}" type="text" placeholder="..."
     style="width: 100%;"> </div>
   <div class="col-lg-5 spacing-left" style="margin-left: 12px"> Notes <br>
    <textarea id="w3review15" class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_gaurd_note]" oninput="trimSpaces15()"
     onclick="moveCursorToStart15()" rows="2" cols="40">{{ $complaints->complaint_gaurd_note }} </textarea>
   </div>
   <div class="col-lg-3 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly
     name="customercomplaints[{{ $index }}][complaint_guard_attach]" type="file" value="{{ $complaints->complaint_guard_attach }}" placeholder="..."
     style="width: 100%;">
    <div class="col-lg-5 spacing-right">
     <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->complaint_guard_attach) }}"
      data-extension="{{ pathinfo($complaints->complaint_guard_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
...
<div class="col-lg-12">
 <div class="row mb-2">
  ...
  <div class="col-lg-5 spacing-left spacing-right form-group"> Weapons, Uniform and
   Equipment <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][wea_uni_equip]" value="{{ $complaints->wea_uni_equip }}"
    type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-5 spacing-left" style="margin-left: 12px"> Notes <br>
   <textarea id="w3review16" oninput="trimSpaces16()" onclick="moveCursorToStart16()" class="form-control" readonly
    name="customercomplaints[{{ $index }}][wue_note]" rows="2" cols="40">{{ $complaints->wue_note }} </textarea>
  </div>
  <div class="col-lg-3 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][wue_attach]"
    value="{{ $complaints->wue_attach }}" type="file" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->wue_attach) }}"
     data-extension="{{ pathinfo($complaints->wue_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($complaints->wue_attach) !!}
    </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($complaints->wue_attach)
                                                        <img src="{{ asset($complaints->wue_attach) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
...
<div class="col-lg-12">
 <div class="row mb-2">
  ...
  <div class="col-lg-5 spacing-left spacing-right form-group"> Finance Department <br>
   <input class="form-control" readonly name="customercomplaints[{{ $index }}][finance_dept]" value="{{ $complaints->finance_dept }}" type="text"
    placeholder="..." style="width: 100%;">
  </div>
  <div class="col-lg-5 spacing-left" style="margin-left: 12px"> Notes <br>
   <textarea id="w3review17" class="form-control" readonly name="customercomplaints[{{ $index }}][fd_note]" oninput="trimSpaces17()"
    onclick="moveCursorToStart17()" rows="2" cols="40">{{ $complaints->fd_note }} </textarea>
  </div>
  <div class="col-lg-3 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][fd_attach]"
    value="{{ $complaints->fd_attach }}" type="file" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->fd_attach) }}"
     data-extension="{{ pathinfo($complaints->fd_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($complaints->fd_attach) !!}
    </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($complaints->fd_attach)
                                                        <img src="{{ asset($complaints->fd_attach) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
...
<div class="col-lg-12">
 <div class="row mb-2">
  ...
  <div class="col-lg-5 spacing-left spacing-right form-group"> Source of Complaint
   <br><input class="form-control" readonly name="customercomplaints[{{ $index }}][src_complaint]" value="{{ $complaints->src_complaint }}" type="text"
    placeholder="..." style="width: 100%;">
  </div>
  <div class="col-lg-5 spacing-left" style="margin-left: 12px"> Notes <br>
   <textarea id="w3review" class="form-control" readonly name="customercomplaints[{{ $index }}][src_note]" rows="2" cols="40">{{ $complaints->src_note }}
   </textarea>
  </div>
  <div class="col-lg-3 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][src_attach]"
    value="{{ $complaints->src_attach }}" type="file" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->src_attach) }}"
     data-extension="{{ pathinfo($complaints->src_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($complaints->src_attach) !!}
    </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($complaints->src_attach)
                                                        <img src="{{ asset($complaints->src_attach) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
...
<div class="col-lg-12">
 <div class="row mb-2">
  ...
  <div class="col-lg-3 spacing-right"> <label for="mng_feedback">Feedback:</label>
   <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][mng_feed]" value="{{ $complaints->mng_feed }}" type="text" placeholder="..."
    style="width: 100%; margin-top: -7px;">
  </div>
  <div class="col-lg-3 spacing-left spacing-right"> Attachments <br> <input class="form-control" readonly id="printing_date"
    name="customercomplaints[{{ $index }}][mng_attach]" value="{{ $complaints->mng_attach }}" type="file" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->mng_attach) }}"
     data-extension="{{ pathinfo($complaints->mng_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!! getFilePreview($complaints->mng_attach) !!}
    </div>
    {{-- <div class="image-preview42" id="imagePreview42">
                                                        @if ($complaints->mng_attach)
                                                        <img src="{{ asset($complaints->mng_attach) }}" alt="Image Preview42" class="image-preview__image42"
    style="height: 100%; width:100%; margin-left:-13px;"> @else <span class="image-preview__default-text42">Image Preview</span> @endif
   </div> --}}
  </div>
 </div>
 <div class="col-lg-3 spacing-left" style="margin-left: 12px"> Notes <br>
  <textarea id="w3review18" class="form-control" readonly name="customercomplaints[{{ $index }}][mng_note]" oninput="trimSpaces18()"
   onclick="moveCursorToStart18()" rows="2" cols="40">{{ $complaints->mng_note }} </textarea>
 </div>
</div>
</div>
<div class="col-lg-12">
 <div class="row mb-2">
  ...
  <div class="col-lg-4 spacing-right"> Name <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_poc_name]"
    value="{{ $complaints->complaint_poc_name }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-right"> Designation <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_poc_desig]"
    value="{{ $complaints->complaint_poc_desig }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-right"> Department <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_poc_dept]"
    value="{{ $complaints->complaint_poc_dept }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-right"> Email<br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_poc_email]"
    value="{{ $complaints->complaint_poc_email }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-right"> Contact Number<br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_poc_contact]"
    value="{{ $complaints->complaint_poc_contact }}" type="text" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-right"> Picture of Complaint <br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_picture]"
    value="{{ $complaints->complaint_picture }}" type="file" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->complaint_picture) }}"
     data-extension="{{ pathinfo($complaints->complaint_picture, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
 ...
 <div class="col-lg-4 spacing-right"> Details of Complaint <br>
  <textarea class="form-control" readonly name="customercomplaints[{{ $index }}][details_complaint]" type="text" placeholder="..."
   style="width: 100%;">{{ $complaints->details_complaint }}</textarea>
 </div>
 <div class="col-lg-4 spacing-right"> Details Attachment<br> <input class="form-control" readonly name="customercomplaints[{{ $index }}][details_attach]"
   value="{{ $complaints->details_attach }}" type="file" placeholder="..." style="width: 100%;">
  <div class="col-lg-5 spacing-right">
   <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->details_attach) }}"
    data-extension="{{ pathinfo($complaints->details_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
...
<div class="col-lg-5 spacing-left spacing-right form-group"> Complaint Tagged To :
 <br><input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_tagged]" value="{{ $complaints->complaint_tagged }}" type="text"
  placeholder="..." style="width: 100%;">
</div>
<div class="col-lg-5 spacing-left spacing-right form-group"> Complaint Addressed By :
 <br><input class="form-control" readonly name="customercomplaints[{{ $index }}][complaint_arressed]" value="{{ $complaints->complaint_arressed }}" type="text"
  placeholder="..." style="width: 100%;">
</div>
</div>
</div>
<div class="row mb-2">
 <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly type="file"
   name="customercomplaints[{{ $index }}][complaint_addressed_attach]" value="{{ $complaints->complaint_addressed_attach }}" placeholder="..."
   style="width: 70%;" multiple>
  <div class="col-lg-5 spacing-right">
   <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($complaints->complaint_addressed_attach) }}"
    data-extension="{{ pathinfo($complaints->complaint_addressed_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
...
<div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
 <textarea id="w3review19" class="form-control" readonly oninput="trimSpaces19()" onclick="moveCursorToStart19()"
  name="customercomplaints[{{ $index }}][complaint_addressed_note]" rows="2" cols="38">{{ $complaints->complaint_addressed_note }} </textarea>
</div>
</div>
...
<div class="col-lg-12 spacing-right" id="notificationForm">
 <div class="row mb-2">
  ...
  <div class="col-lg-3 spacing-right"> Notification No. <br> <input class="form-control" readonly type="text"
    name="customernotifications[{{ $index }}][notification_no]" value="{{ $notifications->notification_no }}" placeholder="..." style="width: 100%;"> </div>
  <div class="col-lg-4 spacing-left spacing-right form-group"> Notification Related to :
   <br> <input class="form-control" readonly type="text" name="customernotifications[{{ $index }}][notification_related]"
    value="{{ $notifications->notification_related }}" placeholder="..." style="width: 100%;">
  </div>
  <div class="col-lg-4 spacing-left"> Attachment. <br> <input class="form-control" readonly type="file"
    name="customernotifications[{{ $index }}][notification_attach]" value="{{ $notifications->notification_attach }}" placeholder="..." style="width: 100%;">
   <div class="col-lg-5 spacing-right">
    <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($notifications->notification_attach) }}"
     data-extension="{{ pathinfo($notifications->notification_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
 ...
 <div class="col-lg-3"> Notes. <br>
  <textarea class="form-control" readonly id="w3review20" type="text" oninput="trimSpaces20()" onclick="moveCursorToStart20()"
   name="customernotifications[{{ $index }}][notification_note]" placeholder="..." style="width: 100%;">{{ $notifications->notification_note }}</textarea>
 </div>
</div>
<div class="row">
 <div class="col-lg-5 spacing-left spacing-right form-group"> Notification Shared With : <br>
  <input class="form-control" readonly type="text" name="customernotifications[{{ $index }}][notification_shared]"
   value="{{ $notifications->notification_shared }}" placeholder="..." style="width: 100%;">
 </div>
</div>
<div class="row mb-2">
 <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly type="file"
   name="customernotifications[{{ $index }}][notification_ex_attach]" value="{{ $notifications->notification_ex_attach }}" placeholder="..." style="width: 70%;"
   multiple>
  <div class="col-lg-5 spacing-right">
   <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($notifications->notification_ex_attach) }}"
    data-extension="{{ pathinfo($notifications->notification_ex_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
...
<div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
 <textarea id="w3review" class="form-control" readonly name="customernotifications[{{ $index }}][notification_ex_note]" rows="2"
...
<div class="container m-auto">
    <!--monthly performance-->
<div class="tab-pane fade" style="opacity: 90%;" id="address-details" role="tabpanel" aria-labelledby="nav-profile-tab">
 <!--Tabs forDetails-->
 <div class="row">
  ...
  <div class="tab-pane fade m-3" style="opacity: 90%;" id="meeting" role="tabpanel" aria-labelledby="nav-meeting-tab">
   <div class=" row main-content div">
    ...
    <div class="col-lg-6">
     <div class="row mb-2">
      <div class="col-lg-6 spacing-right"> Date of meeting <br> <input class="form-control" readonly id="meeting_date" name="meeting_date"
        value="{{ $customers->meeting_date }}" type="date" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left spacing-right"> Meeting Chaired By <br> <input class="form-control" readonly id="head_office_email"
        name="meeting_chaired" value="{{ $customers->meeting_chaired }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-6 spacing-right"> Minutes of Meeting <br> <input class="form-control" readonly id="" name="meeting_minutes"
        value="{{ $customers->meeting_minutes }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left spacing-right"> Attachment <br> <input class="form-control" readonly id="head_office_email" name="meeting_attach"
        value="{{ $customers->meeting_attach }}" type="file" placeholder="..." style="width: 100%;">
       @if ($customers->meeting_attach)
       <div class="col-lg-5 spacing-right">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->meeting_attach) }}"
         data-extension="{{ pathinfo($customers->meeting_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
         getFilePreview($customers->meeting_attach) !!} </div>
        <!-- Delete Button --> <a href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'meeting_attach']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')" style="position: absolute; top: 5px; right: 5px; background: red; color: white;
      ...
      <div class="col-lg-5  spacing-right"> Customer Comments <br>
       <textarea class="form-control" readonly id="head_office_comp" name="meeting_comment" type="text" placeholder="..."
    ...
    <div class="col-lg-6 spacing-left">
     <div class="row mb-2">
      <div class="col-lg-5 spacing-left spacing-right form-group"> Main Point of Concern
       <br> <input class="form-control" readonly id="" name="meeting_main_point" value="{{ $customers->meeting_main_point }}" type="file" placeholder="..."
        style="width: 100%;">
      </div>
      <div class="col-lg-5 spacing-left"> Attachment <br> <input class="form-control" readonly id="" name="meeting_ex_attach"
        value="{{ $customers->meeting_ex_attach }}" type="file" placeholder="..." style="width: 100%;">
       @if ($customers->meeting_ex_attach)
       <div class="col-lg-5 spacing-right">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->meeting_ex_attach) }}"
         data-extension="{{ pathinfo($customers->meeting_ex_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
         getFilePreview($customers->meeting_ex_attach) !!} </div>
        <!-- Delete Button --> <a href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'meeting_ex_attach']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')">x</a>
       </div>
       @else
       <p class="text-center text-secondary">Attachment not found</p>
     ...
     <div class="row mb-2">
      <div class="col-lg-5 spacing-right"> Frequency of Meeting <br> <input class="form-control" readonly id="meeting_freq" name="meeting_freq"
        value="{{ $customers->meeting_freq }}" type="text" placeholder="..." style="width: 100%;"> </div>
      <div class="col-lg-5 spacing-left"> Attachment <br> <input class="form-control" readonly id="" name="meeting_freq_attach"
        value="{{ $customers->meeting_freq_attach }}" type="file" placeholder="..." style="width: 100%;">
       @if ($customers->meeting_freq_attach)
       <div class="col-lg-5 spacing-right">
        <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->meeting_freq_attach) }}"
         data-extension="{{ pathinfo($customers->meeting_freq_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
         getFilePreview($customers->meeting_freq_attach) !!} </div>
        <!-- Delete Button --> <a href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'meeting_freq_attach']) }}"
         onclick="return confirm('Are you sure you want to delete this file?')">x</a>
       </div>
       @else
     ...
     <div class="row mb-2">
      <div class="col-lg-5  spacing-right"> Note <br>
       <textarea class="form-control" readonly id="w3review21" name="meeting_freq_note" oninput="trimSpaces21()" onclick="moveCursorToStart21()" type="text"
        placeholder="..." style="width: 100%;">{{ $customers->meeting_freq_note }}</textarea>
      </div>
      <div class="col-lg-5 spacing-right"> Alert <br>
       <textarea class="form-control" readonly style="color: red; border:1px solid red;" id="meeting_freq_alert" name="meeting_freq_alert"
    ...
    <div class="row mb-2">
     <div class="col-lg-6 spacing-left spacing-right mt-2"> Attachements <br> <input class="form-control" readonly type="file" name="meeting_alert_attach"
       value="{{ $customers->meeting_alert_attach }}" placeholder="..." style="width: 70%;" multiple>
      @if ($customers->meeting_alert_attach)
      <div class="col-lg-5 d-flex">
       <div class="file-preview" style="cursor: pointer;" data-file="{{ asset($customers->meeting_alert_attach) }}"
        data-extension="{{ pathinfo($customers->meeting_alert_attach, PATHINFO_EXTENSION) }}" onclick="openFileModal(this)"> {!!
       ...
       <a href="{{ route('admin.deleteCustomerImage', ['id' => $customers->id, 'column' => 'meeting_alert_attach']) }}"
        onclick="return confirm('Are you sure you want to delete this file?')" style="width: 20px;
            height: 20px;
            border-radius: 50%;
            background-color: red;
            display: flex;
     ...
     <div class="col-lg-6 spacing-left spacing-right mt-2"> Notes <br>
      <textarea id="w3review22" class="form-control" readonly name="meeting_alert_notes" oninput="trimSpaces22()" onclick="moveCursorToStart22()" rows="2"
  ...
  <!--Score Card-->
  <div class="tab-pane fade m-3" style="opacity: 90%;" id="score" role="tabpanel" aria-labelledby="nav-meeting-tab"> <img src="/smart.png" alt="smart-turnout"
    style="position:relative; left:22%;" />
   <div class="row mb-1">
    <div class="col-lg-4 spacing-left"> Customer Name <br> <input class="form-control" readonly name="scr_cus_name" type="text" placeholder="..."
      style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left"> Region <br> <input class="form-control" readonly name="scr_cus_region" type="text" placeholder="..."
      style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> Customer ID <br> <input class="form-control" readonly name="scr_cus_id" type="text" placeholder="..."
      style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left"> Site ID <br> <input class="form-control" readonly name="scr_cus_site_id" type="text" placeholder="..."
      style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left"> Report <br> <input class="form-control" readonly name="scr_cus_report" type="text" placeholder="..."
      style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> Date <br> <input class="form-control" readonly name="scr_cus_date" type="date" placeholder="..." style="width: 100%;">
    </div>
   </div>
   <hr width="90%" />
     ...
     <table class="table table-bordered">
      ...
      <tbody> {{-- Row 1 --}}
       <tr width="100%">
        ...
        <td width="20%" rowspan="4" style="background: rgb(24, 211, 24); color:white;">Screening & Hiring
        </td>
        <td width="45%" style="background: rgb(24, 211, 24); color:white;">
         Shared Complete Hiring Form</td>
        <td width="15%" style="background: rgb(24, 211, 24); color:white;">5
        </td>
        <td width="15%"><input class="mark-input1" type="number" value="{{ $customers->marks1_schf }}" name="marks1_schf" />
        </td>
       ...
       <tr width="100%">
        ...
        <td width="15%"><input class="mark-input1" type="number" value="{{ $customers->marks1_rsgc }}" name="marks1_rsgc" />
        </td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: rgb(24, 211, 24); color:white;">
       ...
       <tr width="100%">
        ...
        <td width="15%"><input class="mark-input3" type="number" value="{{ $customers->marks3_wfds }}" name="marks3_wfds" />
        </td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: red; color:white;">Amour Visited
        </td>
        <td width="15%" style="background: red; color:white;">5</td>
       ...
       <tr width="100%">
        ...
        <td width="45%" style="background: orange; color:white;">Execution of
         Live Fire Arms Trainings</td>
        <td width="15%" style="background: orange; color:white;">8</td>
        <td width="15%"><input class="mark-input4" type="number" value="{{ $customers->marks4_elfat }}" name="marks4_elfat" />
        </td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: orange; color:white;">Availability
       ...
       <tr width="100%">
        ...
        <td width="45%" style="background: skyblue; color:white;">Attendance
         Percentage as per Contract</td>
        <td width="15%" style="background: skyblue; color:white;">5</td>
        <td width="15%"><input class="mark-input5" type="number" value="{{ $customers->marks5_apapc }}" name="marks5_apapc" />
        </td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: skyblue; color:white;">Guarding
         Service</td>
        <td width="15%" style="background: skyblue; color:white;">5</td>
        <td width="15%"><input class="mark-input5" type="number" value="{{ $customers->marks5_gs }}" name="marks5_gs" /></td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: skyblue; color:white;">Finance
         (Invoices,Payroll,EOBI,Social Security,Sales Tax,Recovery Ledger)</td>
        <td width="15%" style="background: skyblue; color:white;">5</td>
       ...
       <tr width="100%">
        ...
        <td width="20%" style="background: blue; color:white;">Customer Care
        </td>
        <td width="45%" style="background: blue; color:white;">Shared
         Feedback Form (Soft via Email, Hard Copy Sent with Invoices)</td>
       ...
       <tr width="100%">
        ...
        <td width="20%" rowspan="6" style="background: blue; color:white;">PIFFERS Hedonistic Approach
        </td>
        <td width="45%" style="background: blue; color:white;">Monthly Visit
         of Top Management(GM/DGM/RM)</td>
        <td width="15%" style="background: blue; color:white;">7</td>
        <td width="15%"><input class="mark-input7" type="number" value="{{ $customers->marks7_mvtm }}" name="marks7_mvtm" />
        </td>
       </tr>
       <tr width="100%">
        ...
        <td width="15%" style="background: blue; color:white;">5</td>
        <td width="15%"><input class="mark-input7" type="number" value="{{ $customers->marks7_mprs }}" name="marks7_mprs" />
        </td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: blue; color:white;">Shared Record
         of Learning Management Systems (LMS)</td>
        <td width="15%" style="background: blue; color:white;">2.5</td>
        <td width="15%"><input class="mark-input7" type="number" value="{{ $customers->marks7_srlms }}" name="marks7_srlms" />
        </td>
       </tr>
       <tr width="100%">
        <td width="45%" style="background: blue; color:white;">Reporting of
       ...
       <tr width="100%">
        <td width="45%" style="background: blue; color:white;">Shared Details
         of Nearby LEAs</td>
        <td width="15%" style="background: blue; color:white;">2.5</td>
        <td width="15%"><input class="mark-input7" type="number" value="{{ $customers->marks7_sdn1 }}" name="marks7_sdnl" />
        </td>
       </tr>
       <tr width="100%" style="background-color: white">
        <td width="5%"></td>
   ...
   <div class="row mb-1">
    <div class="col-lg-4 spacing-left"> Customer POC Name <br> <input class="form-control" readonly name="cus_poc_name" type="text" placeholder="..."
      style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left"> Signature <br> <input class="form-control" readonly name="cus_poc_signature" type="text" placeholder="..."
      style="width: 100%;"> </div>
    <div class="col-lg-4 spacing-left"> Cell <br> <input class="form-control" readonly name="cus_poc_cell" type="text" placeholder="..." style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> CRO Name <br> <input class="form-control" readonly name="cro_name" type="text" placeholder="..." style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> Signature <br> <input class="form-control" readonly name="cro_signature" type="text" placeholder="..."
      style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> Cell <br> <input class="form-control" readonly name="cro_cell" type="text" placeholder="..." style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> GM/DGM Name <br> <input class="form-control" readonly name="gm_name" type="text" placeholder="..." style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> Signature <br> <input class="form-control" readonly name="gm_signature" type="text" placeholder="..."
      style="width: 100%;">
    </div>
    <div class="col-lg-4 spacing-left"> Cell <br> <input class="form-control" readonly name="gm_signature" type="text" placeholder="..." style="width: 100%;">
    </div>
   </div>
  </div>
 </div>
...
<div class="modal fade" id="fileModal" tabindex="-1" role="dialog" aria-labelledby="fileModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
   ...
   <div class="modal-footer"> <a href="#" id="downloadLink" download class="btn btn-primary">Download File</a> </div>
  </div>
 </div>
</div>
<script>
